...
void 0===globalThis.Snice&&console.warn("[snice] snice-runtime.min.js must be loaded before snice-table.min.js");var SniceTable=function(e,t){"use strict";function a(e,t,a,i,s,n){function l(e){if(void 0!==e&&"function"!=typeof e)throw new TypeError("Function expected");return e}for(var r,o=i.kind,c="getter"===o?"get":"setter"===o?"set":"value",h=!t&&e?i.static?e:e.prototype:null,d=t||(h?Object.getOwnPropertyDescriptor(h,i.name):{}),u=!1,p=a.length-1;p>=0;p--){var m={};for(var g in i)m[g]="access"===g?{}:i[g];for(var g in i.access)m.access[g]=i.access[g];m.addInitializer=function(e){if(u)throw new TypeError("Cannot add initializers after decoration has completed");n.push(l(e||null))};var b=(0,a[p])("accessor"===o?{get:d.get,set:d.set}:d[c],m);if("accessor"===o){if(void 0===b)continue;if(null===b||"object"!=typeof b)throw new TypeError("Object expected");(r=l(b.get))&&(d.get=r),(r=l(b.set))&&(d.set=r),(r=l(b.init))&&s.unshift(r)}else(r=l(b))&&("field"===o?s.unshift(r):d[c]=r)}h&&Object.defineProperty(h,i.name,d),u=!0}function i(e,t,a){for(var i=arguments.length>2,s=0;s<t.length;s++)a=i?t[s].call(e,a):t[s].call(e);return i?a:void 0}"function"==typeof SuppressedError&&SuppressedError;var s=":host{display:flex;align-items:center;padding:0 var(--snice-table-cell-padding,var(--snice-spacing-md,.75rem));min-height:2.5rem;height:2.5rem;min-width:6.25rem;flex:1;font-size:.875rem;line-height:1.25rem;color:var(--snice-color-text,rgb(23 23 23))}.cell-content{width:100%;min-width:6.25rem;min-height:1.25rem;word-wrap:break-word}:host([align=left]){text-align:left}:host([align=center]){text-align:center}:host([align=right]){text-align:right}:host([type=accounting]),:host([type=currency]),:host([type=fraction]),:host([type=number]),:host([type=percent]),:host([type=scientific]){font-variant-numeric:tabular-nums;text-align:right}:host([type=date]){font-variant-numeric:tabular-nums}:host([type=boolean]){text-align:center;font-size:1rem}:host([type=rating]){text-align:center}:host([type=sparkline]){text-align:center}.cell-content--text{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.cell-content--text[data-multiline=true]{white-space:pre-wrap;word-wrap:break-word;overflow-wrap:break-word}.cell-content--date,.cell-content--number{font-feature-settings:'tnum'}:host([type=boolean]) .cell-content{display:inline-flex;align-items:center;justify-content:center}:host([type=rating]) .cell-content{display:inline-flex;align-items:center;justify-content:center;gap:.125rem}.cell-content--progress{width:100%;min-width:4rem}.cell-content--sparkline{display:flex;align-items:center;justify-content:center;min-width:3rem}:host(.positive){color:var(--snice-color-success,rgb(22 163 74))}:host(.negative){color:var(--snice-color-danger,rgb(220 38 38))}:host(.warning){color:var(--snice-color-warning,rgb(234 179 8));background-color:rgb(254 249 195 / .3)}:host(.danger){color:var(--snice-color-danger,rgb(220 38 38));background-color:rgb(254 226 226 / .3)}:host(.success){color:var(--snice-color-success,rgb(22 163 74));background-color:rgb(220 252 231 / .3)}:host(.info){color:var(--snice-color-primary,rgb(37 99 235));background-color:rgb(219 234 254 / .3)}:host(.date--today){font-weight:var(--snice-font-weight-semibold,600);color:var(--snice-color-primary,rgb(37 99 235))}:host(.date--past){color:var(--snice-color-text-secondary,rgb(82 82 82))}:host(.date--future){color:var(--snice-color-success,rgb(22 163 74))}:host(.number--negative.number--negative-red){color:var(--snice-color-danger,rgb(220 38 38))}:host(.number--positive.number--highlighted){color:var(--snice-color-success,rgb(22 163 74));font-weight:var(--snice-font-weight-semibold,600)}:host(.number--zero){color:var(--snice-color-text-secondary,rgb(82 82 82))}:host([truncate]) .cell-content{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}:host([wrap]) .cell-content{white-space:pre-wrap;word-wrap:break-word;overflow-wrap:break-word}:host(:not([value])) .cell-content,:host([value=\"\"]) .cell-content{color:var(--snice-color-text-secondary,rgb(82 82 82))}:host(.loading){position:relative;overflow:hidden}:host(.loading) .cell-content{opacity:.6}:host(.loading)::after{content:'';position:absolute;top:0;left:0;right:0;bottom:0;background:linear-gradient(90deg,transparent,var(--snice-color-background,rgb(255 255 255 / .6)),transparent);animation:1.5s infinite cell-shimmer}@keyframes cell-shimmer{0%{transform:translateX(-100%)}100%{transform:translateX(100%)}}:host(:focus-within){outline:2px solid var(--snice-color-primary,rgb(37 99 235));outline-offset:-2px}.cell-content button,.cell-content input,.cell-content select{font-size:inherit;line-height:inherit}.cell-content a{color:var(--snice-color-primary,rgb(37 99 235));text-decoration:none}.cell-content a:hover{text-decoration:underline}@media (max-width:768px){:host{font-size:.75rem;line-height:1rem}:host([type=boolean]){font-size:.875rem}}@media (prefers-reduced-motion:reduce){:host(.loading)::after{animation:none}}@media (prefers-contrast:high){:host(.positive){background-color:rgb(220 252 231 / .3)}:host(.negative){background-color:rgb(254 226 226 / .3)}.cell-content a{text-decoration:underline}}@media print{:host{font-size:.75rem}:host(.loading)::after{display:none}.cell-content a{text-decoration:underline}}";(()=>{let e,n,l,r,o,c,h,d,u,p,m,g,b,y=[t.element("snice-cell")],v=[],f=HTMLElement,w=[],k=[],x=[],S=[],C=[],E=[],D=[],$=[],z=[],A=[],T=[],F=[],L=[];(class extends f{static{n=this}static{const s="function"==typeof Symbol&&Symbol.metadata?Object.create(f[Symbol.metadata]??null):void 0;l=[t.property({})],r=[t.property({})],o=[t.property()],c=[t.property({type:Object,attribute:!1})],h=[t.property({type:Object,attribute:!1})],d=[t.query(".cell-content")],u=[t.render()],p=[t.styles()],m=[t.ready()],g=[t.watch("align")],b=[t.watch("value","column")],a(this,null,u,{kind:"method",name:"render",static:!1,private:!1,access:{has:e=>"render"in e,get:e=>e.render},metadata:s},null,w),a(this,null,p,{kind:"method",name:"styles",static:!1,private:!1,access:{has:e=>"styles"in e,get:e=>e.styles},metadata:s},null,w),a(this,null,m,{kind:"method",name:"init",static:!1,private:!1,access:{has:e=>"init"in e,get:e=>e.init},metadata:s},null,w),a(this,null,g,{kind:"method",name:"updateAlignment",static:!1,private:!1,access:{has:e=>"updateAlignment"in e,get:e=>e.updateAlignment},metadata:s},null,w),a(this,null,b,{kind:"method",name:"updateContent",static:!1,private:!1,access:{has:e=>"updateContent"in e,get:e=>e.updateContent},metadata:s},null,w),a(null,null,l,{kind:"field",name:"align",static:!1,private:!1,access:{has:e=>"align"in e,get:e=>e.align,set:(e,t)=>{e.align=t}},metadata:s},k,x),a(null,null,r,{kind:"field",name:"type",static:!1,private:!1,access:{has:e=>"type"in e,get:e=>e.type,set:(e,t)=>{e.type=t}},metadata:s},S,C),a(null,null,o,{kind:"field",name:"value",static:!1,private:!1,access:{has:e=>"value"in e,get:e=>e.value,set:(e,t)=>{e.value=t}},metadata:s},E,D),a(null,null,c,{kind:"field",name:"column",static:!1,private:!1,access:{has:e=>"column"in e,get:e=>e.column,set:(e,t)=>{e.column=t}},metadata:s},$,z),a(null,null,h,{kind:"field",name:"rowData",static:!1,private:!1,access:{has:e=>"rowData"in e,get:e=>e.rowData,set:(e,t)=>{e.rowData=t}},metadata:s},A,T),a(null,null,d,{kind:"field",name:"contentElement",static:!1,private:!1,access:{has:e=>"contentElement"in e,get:e=>e.contentElement,set:(e,t)=>{e.contentElement=t}},metadata:s},F,L),a(null,e={value:n},y,{kind:"class",name:n.name,metadata:s},null,v),n=e.value,s&&Object.defineProperty(n,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:s}),i(n,v)}render(){return t.html`
    ...
    `}constructor(){super(...arguments),this.value=(i(this,g),i(this,b,0)),this.max=(i(this,y),i(this,v,5)),this.symbol=(i(this,f),i(this,w,"★")),this.emptySymbol=(i(this,k),i(this,x,"☆")),this.color=(i(this,S),i(this,C,"#facc15")),i(this,E)}})})(),(()=>{let e,n,l,r,o,c,h,d,u,p,m,g,b,y=[t.element("snice-cell-rating")],v=[],f=HTMLElement,w=[],k=[],x=[],S=[],C=[],E=[],D=[],$=[],z=[],A=[],T=[],F=[],L=[];(class extends f{static{n=this}static{const s="function"==typeof Symbol&&Symbol.metadata?Object.create(f[Symbol.metadata]??null):void 0;l=[t.property({})],r=[t.property({})],o=[t.property({})],c=[t.property({type:Object,attribute:!1})],h=[t.property({type:Object,attribute:!1})],d=[t.query(".cell-content")],u=[t.render()],p=[t.styles()],m=[t.ready()],g=[t.watch("align")],b=[t.watch("value","column")],a(this,null,u,{kind:"method",name:"render",static:!1,private:!1,access:{has:e=>"render"in e,get:e=>e.render},metadata:s},null,w),a(this,null,p,{kind:"method",name:"styles",static:!1,private:!1,access:{has:e=>"styles"in e,get:e=>e.styles},metadata:s},null,w),a(this,null,m,{kind:"method",name:"init",static:!1,private:!1,access:{has:e=>"init"in e,get:e=>e.init},metadata:s},null,w),a(this,null,g,{kind:"method",name:"updateAlignment",static:!1,private:!1,access:{has:e=>"updateAlignment"in e,get:e=>e.updateAlignment},metadata:s},null,w),a(this,null,b,{kind:"method",name:"updateContent",static:!1,private:!1,access:{has:e=>"updateContent"in e,get:e=>e.updateContent},metadata:s},null,w),a(null,null,l,{kind:"field",name:"align",static:!1,private:!1,access:{has:e=>"align"in e,get:e=>e.align,set:(e,t)=>{e.align=t}},metadata:s},k,x),a(null,null,r,{kind:"field",name:"type",static:!1,private:!1,access:{has:e=>"type"in e,get:e=>e.type,set:(e,t)=>{e.type=t}},metadata:s},S,C),a(null,null,o,{kind:"field",name:"value",static:!1,private:!1,access:{has:e=>"value"in e,get:e=>e.value,set:(e,t)=>{e.value=t}},metadata:s},E,D),a(null,null,c,{kind:"field",name:"column",static:!1,private:!1,access:{has:e=>"column"in e,get:e=>e.column,set:(e,t)=>{e.column=t}},metadata:s},$,z),a(null,null,h,{kind:"field",name:"rowData",static:!1,private:!1,access:{has:e=>"rowData"in e,get:e=>e.rowData,set:(e,t)=>{e.rowData=t}},metadata:s},A,T),a(null,null,d,{kind:"field",name:"contentElement",static:!1,private:!1,access:{has:e=>"contentElement"in e,get:e=>e.contentElement,set:(e,t)=>{e.contentElement=t}},metadata:s},F,L),a(null,e={value:n},y,{kind:"class",name:n.name,metadata:s},null,v),n=e.value,s&&Object.defineProperty(n,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:s}),i(n,v)}render(){return t.html`
      <div class="cell-content cell-content--rating" part="content">
        <!-- Rating component will be created here -->
      </div>
    `}styles(){return t.css`${s}`}init(){this.applyAlignment(),this.createRatingElement()}applyAlignment(){this.style.textAlign=this.align}updateAlignment(){this.applyAlignment()}updateContent(){this.createRatingElement()}createRatingElement(){if(!this.contentElement)return;this.contentElement.innerHTML="";const e=document.createElement("snice-rating");e.value=Number(this.value)||0;const t=this.column.ratingFormat||{};e.max=t.max??5,e.symbol=t.symbol??"★",e.emptySymbol=t.emptySymbol??"☆",e.color=t.color??getComputedStyle(this).getPropertyValue("--snice-color-warning").trim(),this.contentElement.appendChild(e)}constructor(){super(...arguments),this.align=(i(this,w),i(this,k,"center")),this.type=(i(this,x),i(this,S,"rating")),this.value=(i(this,C),i(this,E,0)),this.column=(i(this,D),i(this,$,{key:"",label:"",type:"rating",align:"center"})),this.rowData=(i(this,z),i(this,A,null)),this.contentElement=(i(this,T),i(this,F,void 0)),i(this,L)}})})(),(()=>{let e,s,n,l,r,o,c,h,d,u,p=[t.element("snice-progress")],m=[],g=HTMLElement,b=[],y=[],v=[],f=[],w=[],k=[],x=[],S=[],C=[],E=[],D=[],$=[],z=[];(class extends g{static{s=this}static{const A="function"==typeof Symbol&&Symbol.metadata?Object.create(g[Symbol.metadata]??null):void 0;n=[t.property({type:Number})],l=[t.property({type:Number})],r=[t.property()],o=[t.property()],c=[t.property()],h=[t.property({type:Boolean})],d=[t.render()],u=[t.styles()],a(this,null,d,{kind:"method",name:"render",static:!1,private:!1,access:{has:e=>"render"in e,get:e=>e.render},metadata:A},null,b),a(this,null,u,{kind:"method",name:"styles",static:!1,private:!1,access:{has:e=>"styles"in e,get:e=>e.styles},metadata:A},null,b),a(null,null,n,{kind:"field",name:"value",static:!1,private:!1,access:{has:e=>"value"in e,get:e=>e.value,set:(e,t)=>{e.value=t}},metadata:A},y,v),a(null,null,l,{kind:"field",name:"max",static:!1,private:!1,access:{has:e=>"max"in e,get:e=>e.max,set:(e,t)=>{e.max=t}},metadata:A},f,w),a(null,null,r,{kind:"field",name:"color",static:!1,private:!1,access:{has:e=>"color"in e,get:e=>e.color,set:(e,t)=>{e.color=t}},metadata:A},k,x),a(null,null,o,{kind:"field",name:"backgroundColor",static:!1,private:!1,access:{has:e=>"backgroundColor"in e,get:e=>e.backgroundColor,set:(e,t)=>{e.backgroundColor=t}},metadata:A},S,C),a(null,null,c,{kind:"field",name:"height",static:!1,private:!1,access:{has:e=>"height"in e,get:e=>e.height,set:(e,t)=>{e.height=t}},metadata:A},E,D),a(null,null,h,{kind:"field",name:"showPercentage",static:!1,private:!1,access:{has:e=>"showPercentage"in e,get:e=>e.showPercentage,set:(e,t)=>{e.showPercentage=t}},metadata:A},$,z),a(null,e={value:s},p,{kind:"class",name:s.name,metadata:A},null,m),s=e.value,A&&Object.defineProperty(s,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:A}),i(s,m)}render(){const e=Math.min(100,this.value/this.max*100);return t.html`
    ...
    `}styles(){return t.css`${":host{color:var(--snice-color-text,rgb(23 23 23));display:flex;align-items:center;min-height:2.5rem;height:2.5rem;min-width:6.25rem;flex:1;font-size:.875rem;line-height:1.25rem}.cell-content{width:100%;min-width:6.25rem;min-height:1.25rem}.actions-container{display:inline-flex;gap:.5rem;align-items:center}.action-button{display:inline-flex;align-items:center;gap:.25rem;padding:.25rem .5rem;border:1px solid transparent;border-radius:.25rem;background:0 0;cursor:pointer;transition:.2s;font-size:.875rem;line-height:1}.action-button:hover{background:var(--snice-color-text,rgb(23 23 23 / .05))}.action-button:focus{outline:2px solid var(--snice-color-primary,rgb(37 99 235));outline-offset:2px}.action-button:active{transform:scale(.95)}.action-button:disabled{opacity:.5;cursor:not-allowed}.action-button:disabled:hover{background:0 0}.action-button--primary{color:var(--snice-color-primary,rgb(37 99 235))}.action-button--primary:hover:not(:disabled){background:rgb(37 99 235 / .1)}.action-button--secondary{color:var(--snice-color-text,rgb(23 23 23))}.action-button--danger{color:var(--snice-color-danger,rgb(220 38 38))}.action-button--danger:hover:not(:disabled){background:rgb(220 38 38 / .1)}.action-button--success{color:var(--snice-color-success,rgb(22 163 74))}.action-button--success:hover:not(:disabled){background:rgb(22 163 74 / .1)}.action-icon{display:inline-flex;align-items:center;font-size:1rem}.action-icon--image{width:1rem;height:1rem}.action-icon--image img{width:100%;height:100%;object-fit:contain}.action-label{font-weight:500}:host([align=left]){justify-content:flex-start}:host([align=center]){justify-content:center}:host([align=right]){justify-content:flex-end}@media (max-width:768px){.action-button{padding:.25rem}.action-label{display:none}}@media print{.actions-container{display:none}}"}`}init(){this.extractActionsFromColumn()}extractActionsFromColumn(){this.column?.actionsFormat?.actions&&(this.actions=this.column.actionsFormat.actions)}renderActionButton(e){const a=e.icon||"",i=e.label||"",s=e.variant||"secondary",n=e.disabled||!1,l=a&&(a.startsWith("http://")||a.startsWith("https://")||a.startsWith("/")||a.startsWith("./"));let r="";return a&&(r=l?`<span class="action-icon action-icon--image"><img src="${a}" alt="" /></span>`:`<span class="action-icon">${a}</span>`),t.html`
      ...
      >
        ${t.unsafeHTML(r)}
        ${i?t.html`<span class="action-label">${i}</span>`:""}
      </button>
    `}handleActionClick(e,t){e.stopPropagation(),this.dispatchAction(t)}dispatchAction(e){return{action:e,rowData:this.rowData,column:this.column}}constructor(){super(...arguments),this.actions=(i(this,f),i(this,w,[])),this.column=(i(this,k),i(this,x,null)),this.rowData=(i(this,S),i(this,C,null)),this.value=(i(this,E),i(this,D,"")),this.align=(i(this,$),i(this,z,"left")),this.type=(i(this,A),i(this,T,"actions")),i(this,F)}})})();(()=>{let e,s,n,l,r,o,c,h,d,u,p,m,g,b=[t.element("snice-cell-tag")],y=[],v=HTMLElement,f=[],w=[],k=[],x=[],S=[],C=[],E=[],D=[],$=[],z=[],A=[],T=[],F=[],L=[],R=[];(class extends v{static{s=this}static{const M="function"==typeof Symbol&&Symbol.metadata?Object.create(v[Symbol.metadata]??null):void 0;n=[t.property({type:Array,attribute:!1})],l=[t.property({type:String})],r=[t.property({type:String})],o=[t.property({type:Object,attribute:!1})],c=[t.property({type:Object,attribute:!1})],h=[t.property({type:String})],d=[t.property({type:String})],u=[t.render()],p=[t.styles()],m=[t.ready()],g=[t.watch("value","column")],a(this,null,u,{kind:"method",name:"render",static:!1,private:!1,access:{has:e=>"render"in e,get:e=>e.render},metadata:M},null,f),a(this,null,p,{kind:"method",name:"styles",static:!1,private:!1,access:{has:e=>"styles"in e,get:e=>e.styles},metadata:M},null,f),a(this,null,m,{kind:"method",name:"init",static:!1,private:!1,access:{has:e=>"init"in e,get:e=>e.init},metadata:M},null,f),a(this,null,g,{kind:"method",name:"extractTagsFromColumn",static:!1,private:!1,access:{has:e=>"extractTagsFromColumn"in e,get:e=>e.extractTagsFromColumn},metadata:M},null,f),a(null,null,n,{kind:"field",name:"tags",static:!1,private:!1,access:{has:e=>"tags"in e,get:e=>e.tags,set:(e,t)=>{e.tags=t}},metadata:M},w,k),a(null,null,l,{kind:"field",name:"value",static:!1,private:!1,access:{has:e=>"value"in e,get:e=>e.value,set:(e,t)=>{e.value=t}},metadata:M},x,S),a(null,null,r,{kind:"field",name:"variant",static:!1,private:!1,access:{has:e=>"variant"in e,get:e=>e.variant,set:(e,t)=>{e.variant=t}},metadata:M},C,E),a(null,null,o,{kind:"field",name:"column",static:!1,private:!1,access:{has:e=>"column"in e,get:e=>e.column,set:(e,t)=>{e.column=t}},metadata:M},D,$),a(null,null,c,{kind:"field",name:"rowData",static:!1,private:!1,access:{has:e=>"rowData"in e,get:e=>e.rowData,set:(e,t)=>{e.rowData=t}},metadata:M},z,A),a(null,null,h,{kind:"field",name:"align",static:!1,private:!1,access:{has:e=>"align"in e,get:e=>e.align,set:(e,t)=>{e.align=t}},metadata:M},T,F),a(null,null,d,{kind:"field",name:"type",static:!1,private:!1,access:{has:e=>"type"in e,get:e=>e.type,set:(e,t)=>{e.type=t}},metadata:M},L,R),a(null,e={value:s},b,{kind:"class",name:s.name,metadata:M},null,y),s=e.value,M&&Object.defineProperty(s,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:M}),i(s,y)}render(){const e=this.tags.length>0?this.tags:this.parseValue();return t.html`
      <div class="cell-content cell-content--tag" part="content">
        <div class="tags-container">
          ${e.map(e=>this.renderTag(e))}
        </div>
      </div>
    `}styles(){return t.css`${":host{color:var(--snice-color-text,rgb(23 23 23));display:flex;align-items:center;min-height:2.5rem;height:2.5rem;min-width:6.25rem;flex:1;font-size:.875rem;line-height:1.25rem}.cell-content{width:100%;min-width:6.25rem;min-height:1.25rem}.tags-container{display:inline-flex;flex-wrap:wrap;gap:.25rem;align-items:center}.tag{display:inline-flex;align-items:center;padding:.125rem .5rem;border-radius:.75rem;font-size:.75rem;font-weight:500;line-height:1.25;white-space:nowrap}.tag--default{background:var(--snice-color-text,rgb(23 23 23 / .08));color:var(--snice-color-text,rgb(23 23 23))}.tag--primary{background:rgb(37 99 235 / .1);color:var(--snice-color-primary,rgb(37 99 235))}.tag--success{background:rgb(22 163 74 / .1);color:var(--snice-color-success,rgb(22 163 74))}.tag--danger{background:rgb(220 38 38 / .1);color:var(--snice-color-danger,rgb(220 38 38))}.tag--warning{background:rgb(234 179 8 / .1);color:var(--snice-color-warning,rgb(234 179 8))}.tag--info{background:rgb(96 165 250 / .1);color:var(--snice-color-primary,rgb(37 99 235))}:host([align=left]){justify-content:flex-start}:host([align=center]){justify-content:center}:host([align=right]){justify-content:flex-end}@media (max-width:768px){.tag{font-size:.6875rem;padding:.0625rem .375rem}}@media print{.tag{border:1px solid currentColor}}"}`}init(){this.extractTagsFromColumn()}extractTagsFromColumn(){this.column?.tagFormat&&(this.variant=this.column.tagFormat.variant||"default")}parseValue(){if(!this.value)return[];if(Array.isArray(this.value))return this.value;if("string"==typeof this.value){try{const e=JSON.parse(this.value);if(Array.isArray(e))return e}catch{}return this.value.split(",").map(e=>e.trim()).filter(e=>e)}return[String(this.value)]}renderTag(e){return t.html`
      <span class="tag tag--${this.variant}" part="tag">
        ${e}
      </span>
    `}constructor(){super(...arguments),this.tags=(i(this,f),i(this,w,[])),this.value=(i(this,k),i(this,x,"")),this.variant=(i(this,S),i(this,C,"default")),this.column=(i(this,E),i(this,D,null)),this.rowData=(i(this,$),i(this,z,null)),this.align=(i(this,A),i(this,T,"left")),this.type=(i(this,F),i(this,L,"tag")),i(this,R)}})})();(()=>{let e,s,n,l,r,o,c,h,d,u,p,m,g,b,y,v,f,w,k=[t.element("snice-cell-image")],x=[],S=HTMLElement,C=[],E=[],D=[],$=[],z=[],A=[],T=[],F=[],L=[],R=[],M=[],I=[],j=[],B=[],O=[],P=[],V=[],H=[],N=[],q=[],_=[],W=[],K=[],U=[],Y=[];(class extends S{static{s=this}static{const G="function"==typeof Symbol&&Symbol.metadata?Object.create(S[Symbol.metadata]??null):void 0;n=[t.property({type:String})],l=[t.property({type:String})],r=[t.property({type:String})],o=[t.property({type:String})],c=[t.property({type:String})],h=[t.property({type:String})],d=[t.property({type:Boolean})],u=[t.property({type:Object,attribute:!1})],p=[t.property({type:Object,attribute:!1})],m=[t.property({type:String})],g=[t.property({type:String})],b=[t.property({type:Boolean})],y=[t.render()],v=[t.styles()],f=[t.ready()],w=[t.watch("column")],a(this,null,y,{kind:"method",name:"render",static:!1,private:!1,access:{has:e=>"render"in e,get:e=>e.render},metadata:G},null,C),a(this,null,v,{kind:"method",name:"styles",static:!1,private:!1,access:{has:e=>"styles"in e,get:e=>e.styles},metadata:G},null,C),a(this,null,f,{kind:"method",name:"init",static:!1,private:!1,access:{has:e=>"init"in e,get:e=>e.init},metadata:G},null,C),a(this,null,w,{kind:"method",name:"updateImageAttributes",static:!1,private:!1,access:{has:e=>"updateImageAttributes"in e,get:e=>e.updateImageAttributes},metadata:G},null,C),a(null,null,n,{kind:"field",name:"value",static:!1,private:!1,access:{has:e=>"value"in e,get:e=>e.value,set:(e,t)=>{e.value=t}},metadata:G},E,D),a(null,null,l,{kind:"field",name:"src",static:!1,private:!1,access:{has:e=>"src"in e,get:e=>e.src,set:(e,t)=>{e.src=t}},metadata:G},$,z),a(null,null,r,{kind:"field",name:"alt",static:!1,private:!1,access:{has:e=>"alt"in e,get:e=>e.alt,set:(e,t)=>{e.alt=t}},metadata:G},A,T),a(null,null,o,{kind:"field",name:"fallback",static:!1,private:!1,access:{has:e=>"fallback"in e,get:e=>e.fallback,set:(e,t)=>{e.fallback=t}},metadata:G},F,L),a(null,null,c,{kind:"field",name:"variant",static:!1,private:!1,access:{has:e=>"variant"in e,get:e=>e.variant,set:(e,t)=>{e.variant=t}},metadata:G},R,M),a(null,null,h,{kind:"field",name:"size",static:!1,private:!1,access:{has:e=>"size"in e,get:e=>e.size,set:(e,t)=>{e.size=t}},metadata:G},I,j),a(null,null,d,{kind:"field",name:"lazy",static:!1,private:!1,access:{has:e=>"lazy"in e,get:e=>e.lazy,set:(e,t)=>{e.lazy=t}},metadata:G},B,O),a(null,null,u,{kind:"field",name:"column",static:!1,private:!1,access:{has:e=>"column"in e,get:e=>e.column,set:(e,t)=>{e.column=t}},metadata:G},P,V),a(null,null,p,{kind:"field",name:"rowData",static:!1,private:!1,access:{has:e=>"rowData"in e,get:e=>e.rowData,set:(e,t)=>{e.rowData=t}},metadata:G},H,N),a(null,null,m,{kind:"field",name:"align",static:!1,private:!1,access:{has:e=>"align"in e,get:e=>e.align,set:(e,t)=>{e.align=t}},metadata:G},q,_),a(null,null,g,{kind:"field",name:"type",static:!1,private:!1,access:{has:e=>"type"in e,get:e=>e.type,set:(e,t)=>{e.type=t}},metadata:G},W,K),a(null,null,b,{kind:"field",name:"imageError",static:!1,private:!1,access:{has:e=>"imageError"in e,get:e=>e.imageError,set:(e,t)=>{e.imageError=t}},metadata:G},U,Y),a(null,e={value:s},k,{kind:"class",name:s.name,metadata:G},null,x),s=e.value,G&&Object.defineProperty(s,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:G}),i(s,x)}render(){const e=this.src||this.value,a=this.alt||"Image",i=this.lazy?"lazy":"eager",s=`cell-image ${`image--${this.variant}`} ${`image--${this.size}`}`;return this.imageError&&this.fallback?t.html`
        <div class="cell-content cell-content--image" part="content">
          <img src="${this.fallback}" alt="${a}" class="${s}" />
        </div>
      `:e?t.html`
        <div class="cell-content cell-content--image" part="content">
          <img src="${e}" alt="${a}" loading="${i}" class="${s}" @error=${this.handleImageError} />
        </div>
      `:t.html`
      <div class="cell-content cell-content--image" part="content">
        <div class="${s} cell-image--placeholder"></div>
      </div>
    `}styles(){return t.css`${":host{color:var(--snice-color-text,rgb(23 23 23));display:flex;align-items:center;min-height:2.5rem;height:2.5rem;min-width:6.25rem;flex:1;font-size:.875rem;line-height:1.25rem}.cell-content{width:100%;min-width:6.25rem;min-height:1.25rem;display:flex;align-items:center}.cell-image{display:block;object-fit:cover;background-color:rgb(243 244 246)}.image--small{width:1.5rem;height:1.5rem}.image--medium{width:2rem;height:2rem}.image--large{width:3rem;height:3rem}.image--rounded{border-radius:.25rem}.image--square{border-radius:0}.image--circle{border-radius:50%}.cell-image--placeholder{background:linear-gradient(135deg,rgb(229 231 235) 0,rgb(209 213 219) 100%);border:1px solid rgb(209 213 219);position:relative}.cell-image--placeholder::after{content:'📷';position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-size:.875rem;opacity:.5}:host([align=left]) .cell-content{justify-content:flex-start}:host([align=center]) .cell-content{justify-content:center}:host([align=right]) .cell-content{justify-content:flex-end}:host(.loading) .cell-image{opacity:.6;animation:1.5s ease-in-out infinite image-pulse}@keyframes image-pulse{0%,100%{opacity:.6}50%{opacity:.3}}@media (max-width:768px){.image--small{width:1.25rem;height:1.25rem}.image--medium{width:1.75rem;height:1.75rem}.image--large{width:2.5rem;height:2.5rem}}@media (prefers-reduced-motion:reduce){:host(.loading) .cell-image{animation:none}}@media print{.cell-image{max-width:2rem;max-height:2rem}}"}`}init(){this.updateImageAttributes()}updateImageAttributes(){if(this.column?.imageFormat){const e=this.column.imageFormat;this.src=e.src||this.value,this.alt=e.alt||"",this.fallback=e.fallback||"",this.variant=e.variant||"rounded",this.size=e.size||"medium",this.lazy=e.lazy??!0}}handleImageError(){this.imageError=!0}constructor(){super(...arguments),this.value=(i(this,C),i(this,E,"")),this.src=(i(this,D),i(this,$,"")),this.alt=(i(this,z),i(this,A,"")),this.fallback=(i(this,T),i(this,F,"")),this.variant=(i(this,L),i(this,R,"rounded")),this.size=(i(this,M),i(this,I,"medium")),this.lazy=(i(this,j),i(this,B,!0)),this.column=(i(this,O),i(this,P,null)),this.rowData=(i(this,V),i(this,H,null)),this.align=(i(this,N),i(this,q,"center")),this.type=(i(this,_),i(this,W,"image")),this.imageError=(i(this,K),i(this,U,!1)),i(this,Y)}})})();(()=>{let e,s,n,l,r,o,c,h,d,u,p,m,g,b,y=[t.element("snice-cell-email")],v=[],f=HTMLElement,w=[],k=[],x=[],S=[],C=[],E=[],D=[],$=[],z=[],A=[],T=[],F=[],L=[],R=[],M=[],I=[],j=[];(class extends f{static{s=this}static{const B="function"==typeof Symbol&&Symbol.metadata?Object.create(f[Symbol.metadata]??null):void 0;n=[t.property({type:String})],l=[t.property({type:String})],r=[t.property({type:String})],o=[t.property({type:Boolean})],c=[t.property({type:Object,attribute:!1})],h=[t.property({type:Object,attribute:!1})],d=[t.property({type:String})],u=[t.property({type:String})],p=[t.render()],m=[t.styles()],g=[t.ready()],b=[t.watch("value","column")],a(this,null,p,{kind:"method",name:"render",static:!1,private:!1,access:{has:e=>"render"in e,get:e=>e.render},metadata:B},null,w),a(this,null,m,{kind:"method",name:"styles",static:!1,private:!1,access:{has:e=>"styles"in e,get:e=>e.styles},metadata:B},null,w),a(this,null,g,{kind:"method",name:"init",static:!1,private:!1,access:{has:e=>"init"in e,get:e=>e.init},metadata:B},null,w),a(this,null,b,{kind:"method",name:"updateEmailAttributes",static:!1,private:!1,access:{has:e=>"updateEmailAttributes"in e,get:e=>e.updateEmailAttributes},metadata:B},null,w),a(null,null,n,{kind:"field",name:"value",static:!1,private:!1,access:{has:e=>"value"in e,get:e=>e.value,set:(e,t)=>{e.value=t}},metadata:B},k,x),a(null,null,l,{kind:"field",name:"email",static:!1,private:!1,access:{has:e=>"email"in e,get:e=>e.email,set:(e,t)=>{e.email=t}},metadata:B},S,C),a(null,null,r,{kind:"field",name:"displayText",static:!1,private:!1,access:{has:e=>"displayText"in e,get:e=>e.displayText,set:(e,t)=>{e.displayText=t}},metadata:B},E,D),a(null,null,o,{kind:"field",name:"showIcon",static:!1,private:!1,access:{has:e=>"showIcon"in e,get:e=>e.showIcon,set:(e,t)=>{e.showIcon=t}},metadata:B},$,z),a(null,null,c,{kind:"field",name:"column",static:!1,private:!1,access:{has:e=>"column"in e,get:e=>e.column,set:(e,t)=>{e.column=t}},metadata:B},A,T),a(null,null,h,{kind:"field",name:"rowData",static:!1,private:!1,access:{has:e=>"rowData"in e,get:e=>e.rowData,set:(e,t)=>{e.rowData=t}},metadata:B},F,L),a(null,null,d,{kind:"field",name:"align",static:!1,private:!1,access:{has:e=>"align"in e,get:e=>e.align,set:(e,t)=>{e.align=t}},metadata:B},R,M),a(null,null,u,{kind:"field",name:"type",static:!1,private:!1,access:{has:e=>"type"in e,get:e=>e.type,set:(e,t)=>{e.type=t}},metadata:B},I,j),a(null,e={value:s},y,{kind:"class",name:s.name,metadata:B},null,v),s=e.value,B&&Object.defineProperty(s,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:B}),i(s,v)}render(){const e=this.email||this.value,a=this.displayText||e,i=this.showIcon?'<span class="email-icon">✉</span>':"";return e?t.html`
    ...
    `}styles(){return t.css`${":host{color:var(--snice-color-text,rgb(23 23 23));display:flex;align-items:center;min-height:2.5rem;height:auto;min-width:6.25rem;flex:1;font-size:.875rem;line-height:1.25rem}.cell-content{width:100%;min-width:6.25rem;min-height:1.25rem;display:flex;align-items:flex-start;gap:.5rem;padding:.25rem 0}.json-toggle{background:0 0;border:none;color:var(--snice-color-text-secondary,rgb(82 82 82));cursor:pointer;padding:.125rem .25rem;font-size:.75rem;line-height:1;border-radius:.25rem;transition:background-color .2s;flex-shrink:0}.json-toggle:hover{background-color:var(--snice-color-background-hover,rgb(245 245 245))}.json-toggle:focus{outline:2px solid var(--snice-color-primary,rgb(37 99 235));outline-offset:2px}.json-viewer{font-family:'Courier New',Consolas,monospace;font-size:.8125rem;overflow:hidden;flex:1}.json-viewer--collapsed{white-space:nowrap;text-overflow:ellipsis}.json-viewer--expanded{white-space:pre-wrap;word-break:break-word}.json-preview{color:var(--snice-color-text-secondary,rgb(82 82 82));font-style:italic}.json-object{padding-left:1rem}.json-line{margin:.125rem 0}.json-key{color:var(--snice-color-primary,rgb(37 99 235));font-weight:500;margin-right:.25rem}.json-string{color:var(--snice-color-success,rgb(22 163 74))}.json-number{color:var(--snice-color-info,rgb(59 130 246))}.json-boolean{color:var(--snice-color-warning,rgb(234 179 8))}.json-empty,.json-null,.json-undefined{color:var(--snice-color-text-secondary,rgb(82 82 82));font-style:italic}:host([align=left]) .cell-content{justify-content:flex-start}:host([align=center]) .cell-content{justify-content:center}:host([align=right]) .cell-content{justify-content:flex-end}@media (max-width:768px){:host{color:var(--snice-color-text,rgb(23 23 23));font-size:.75rem;line-height:1rem}.json-viewer{font-size:.75rem}.json-toggle{font-size:.625rem}}@media print{.json-toggle{display:none}.json-viewer--collapsed{white-space:normal}.json-viewer{font-size:.625rem}}"}`}init(){this.updateJsonAttributes()}updateJsonAttributes(){if(this.column?.jsonFormat){const e=this.column.jsonFormat;this.collapsed=e.collapsed??!0,this.maxDepth=e.maxDepth??3,this.showToggle=e.showToggle??!0}}handleToggle(){this.collapsed=!this.collapsed}tryParseJson(e){try{return JSON.parse(e)}catch{return e}}renderCollapsed(e){if("object"==typeof e&&null!==e){if(Array.isArray(e))return`<span class="json-preview">[${e.length} items]</span>`;return`<span class="json-preview">{${Object.keys(e).length} keys}</span>`}return this.renderValue(e)}renderExpanded(e,t=0){if(t>=this.maxDepth)return this.renderCollapsed(e);if("object"==typeof e&&null!==e){if(Array.isArray(e)){return`<div class="json-object">[${e.map((e,a)=>`<div class="json-line"><span class="json-key">${a}:</span> ${this.renderExpanded(e,t+1)}</div>`).join("")}]</div>`}return`<div class="json-object">{${Object.entries(e).map(([e,a])=>`<div class="json-line"><span class="json-key">${e}:</span> ${this.renderExpanded(a,t+1)}</div>`).join("")}}</div>`}return this.renderValue(e)}renderValue(e){return null===e?'<span class="json-null">null</span>':void 0===e?'<span class="json-undefined">undefined</span>':"boolean"==typeof e?`<span class="json-boolean">${e}</span>`:"number"==typeof e?`<span class="json-number">${e}</span>`:"string"==typeof e?`<span class="json-string">"${e}"</span>`:String(e)}constructor(){super(...arguments),this.value=(i(this,k),i(this,x,null)),this.collapsed=(i(this,S),i(this,C,!0)),this.maxDepth=(i(this,E),i(this,D,3)),this.showToggle=(i(this,$),i(this,z,!0)),this.column=(i(this,A),i(this,T,null)),this.rowData=(i(this,F),i(this,L,null)),this.align=(i(this,R),i(this,M,"left")),this.type=(i(this,I),i(this,j,"json")),i(this,B)}})})(),(()=>{let e,n,l,r,o,c,h,d,u,p,m,g,b,y,v,f,w,k,x,S,C=[t.element("snice-cell-currency")],E=[],D=HTMLElement,$=[],z=[],A=[],T=[],F=[],L=[],R=[],M=[],I=[],j=[],B=[],O=[],P=[],V=[],H=[],N=[],q=[],_=[],W=[],K=[],U=[],Y=[],G=[],J=[],X=[],Q=[],Z=[];(class extends D{static{n=this}static{const s="function"==typeof Symbol&&Symbol.metadata?Object.create(D[Symbol.metadata]??null):void 0;l=[t.property({type:String})],r=[t.property({type:String})],o=[t.property({})],c=[t.property({type:Object,attribute:!1})],h=[t.property({type:Object,attribute:!1})],d=[t.query(".cell-content")],u=[t.property({type:Number})],p=[t.property({type:Boolean,attribute:"thousands-separator"})],m=[t.property({type:String})],g=[t.property({type:String})],b=[t.property({type:String})],y=[t.property({type:String,attribute:"negative-style"})],v=[t.property({type:Boolean})],f=[t.render()],w=[t.styles()],k=[t.ready()],x=[t.watch("align")],S=[t.watch("value","column")],a(this,null,f,{kind:"method",name:"render",static:!1,private:!1,access:{has:e=>"render"in e,get:e=>e.render},metadata:s},null,$),a(this,null,w,{kind:"method",name:"styles",static:!1,private:!1,access:{has:e=>"styles"in e,get:e=>e.styles},metadata:s},null,$),a(this,null,k,{kind:"method",name:"init",static:!1,private:!1,access:{has:e=>"init"in e,get:e=>e.init},metadata:s},null,$),a(this,null,x,{kind:"method",name:"updateAlignment",static:!1,private:!1,access:{has:e=>"updateAlignment"in e,get:e=>e.updateAlignment},metadata:s},null,$),a(this,null,S,{kind:"method",name:"updateContent",static:!1,private:!1,access:{has:e=>"updateContent"in e,get:e=>e.updateContent},metadata:s},null,$),a(null,null,l,{kind:"field",name:"align",static:!1,private:!1,access:{has:e=>"align"in e,get:e=>e.align,set:(e,t)=>{e.align=t}},metadata:s},z,A),a(null,null,r,{kind:"field",name:"type",static:!1,private:!1,access:{has:e=>"type"in e,get:e=>e.type,set:(e,t)=>{e.type=t}},metadata:s},T,F),a(null,null,o,{kind:"field",name:"value",static:!1,private:!1,access:{has:e=>"value"in e,get:e=>e.value,set:(e,t)=>{e.value=t}},metadata:s},L,R),a(null,null,c,{kind:"field",name:"column",static:!1,private:!1,access:{has:e=>"column"in e,get:e=>e.column,set:(e,t)=>{e.column=t}},metadata:s},M,I),a(null,null,h,{kind:"field",name:"rowData",static:!1,private:!1,access:{has:e=>"rowData"in e,get:e=>e.rowData,set:(e,t)=>{e.rowData=t}},metadata:s},j,B),a(null,null,d,{kind:"field",name:"contentElement",static:!1,private:!1,access:{has:e=>"contentElement"in e,get:e=>e.contentElement,set:(e,t)=>{e.contentElement=t}},metadata:s},O,P),a(null,null,u,{kind:"field",name:"decimals",static:!1,private:!1,access:{has:e=>"decimals"in e,get:e=>e.decimals,set:(e,t)=>{e.decimals=t}},metadata:s},V,H),a(null,null,p,{kind:"field",name:"thousandsSeparator",static:!1,private:!1,access:{has:e=>"thousandsSeparator"in e,get:e=>e.thousandsSeparator,set:(e,t)=>{e.thousandsSeparator=t}},metadata:s},N,q),a(null,null,m,{kind:"field",name:"currency",static:!1,private:!1,access:{has:e=>"currency"in e,get:e=>e.currency,set:(e,t)=>{e.currency=t}},metadata:s},_,W),a(null,null,g,{kind:"field",name:"currencyDisplay",static:!1,private:!1,access:{has:e=>"currencyDisplay"in e,get:e=>e.currencyDisplay,set:(e,t)=>{e.currencyDisplay=t}},metadata:s},K,U),a(null,null,b,{kind:"field",name:"locale",static:!1,private:!1,access:{has:e=>"locale"in e,get:e=>e.locale,set:(e,t)=>{e.locale=t}},metadata:s},Y,G),a(null,null,y,{kind:"field",name:"negativeStyle",static:!1,private:!1,access:{has:e=>"negativeStyle"in e,get:e=>e.negativeStyle,set:(e,t)=>{e.negativeStyle=t}},metadata:s},J,X),a(null,null,v,{kind:"field",name:"highlight",static:!1,private:!1,access:{has:e=>"highlight"in e,get:e=>e.highlight,set:(e,t)=>{e.highlight=t}},metadata:s},Q,Z),a(null,e={value:n},C,{kind:"class",name:n.name,metadata:s},null,E),n=e.value,s&&Object.defineProperty(n,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:s}),i(n,E)}render(){const e=this.formatCurrencyValue(),a=this.getCurrencyStyles();return t.html`
      <div class="cell-content cell-content--number" part="content" style="${a}">
        ${e}
      </div>
    `}styles(){return t.css`${s}`}init(){this.applyAlignment()}applyAlignment(){this.style.textAlign=this.align}updateAlignment(){this.applyAlignment()}updateContent(){if(this.contentElement){const e=this.formatCurrencyValue(),t=this.getCurrencyStyles();this.contentElement.innerHTML=e,this.contentElement.setAttribute("style",t)}}formatCurrencyValue(){if(null===this.value||void 0===this.value||""===this.value)return"";if(this.column.formatter)return this.column.formatter(this.value,this.rowData);const e=this.column.currencyFormat||{decimals:this.decimals,currency:this.currency,currencyDisplay:this.currencyDisplay,locale:this.locale,negativeStyle:this.negativeStyle},t=Number(this.value);if(isNaN(t))return String(this.value);try{let a=new Intl.NumberFormat(e.locale||this.locale,{style:"currency",currency:e.currency||this.currency,currencyDisplay:e.currencyDisplay||this.currencyDisplay,minimumFractionDigits:e.decimals??this.decimals,maximumFractionDigits:e.decimals??this.decimals}).format(Math.abs(t));if(t<0){const t=e.negativeStyle??this.negativeStyle;a="parentheses"===t?`(${a})`:`-${a}`}return a}catch(a){let i=t.toFixed(e.decimals??this.decimals);if(this.thousandsSeparator){const e=i.split(".");e[0]=e[0].replace(/\B(?=(\d{3})+(?!\d))/g,","),i=e.join(".")}return`$${i}`}}getCurrencyStyles(){const e=Number(this.value);if(this.classList.remove("number--negative","number--positive","number--zero","number--highlighted"),e<0){this.classList.add("number--negative");"red"===(this.column.currencyFormat?.negativeStyle??this.negativeStyle)&&this.classList.add("number--negative-red")}else e>0?(this.classList.add("number--positive"),this.highlight&&this.classList.add("number--highlighted")):0===e&&this.classList.add("number--zero");return"text-align: right"}constructor(){super(...arguments),this.align=(i(this,$),i(this,z,"right")),this.type=(i(this,A),i(this,T,"currency")),this.value=(i(this,F),i(this,L,"")),this.column=(i(this,R),i(this,M,{key:"",label:"",type:"currency",align:"right"})),this.rowData=(i(this,I),i(this,j,null)),this.contentElement=(i(this,B),i(this,O,void 0)),this.decimals=(i(this,P),i(this,V,2)),this.thousandsSeparator=(i(this,H),i(this,N,!0)),this.currency=(i(this,q),i(this,_,"USD")),this.currencyDisplay=(i(this,W),i(this,K,"symbol")),this.locale=(i(this,U),i(this,Y,"en-US")),this.negativeStyle=(i(this,G),i(this,J,"red")),this.highlight=(i(this,X),i(this,Q,!1)),i(this,Z)}})})();(()=>{let e,s,n,l,r,o,c,h,d,u,p,m,g,b,y,v,f,w=[t.element("snice-cell-percentage")],k=[],x=HTMLElement,S=[],C=[],E=[],D=[],$=[],z=[],A=[],T=[],F=[],L=[],R=[],M=[],I=[],j=[],B=[],O=[],P=[],V=[],H=[],N=[],q=[];(class extends x{static{s=this}static{const _="function"==typeof Symbol&&Symbol.metadata?Object.create(x[Symbol.metadata]??null):void 0;n=[t.property({type:String})],l=[t.property({type:String})],r=[t.property({})],o=[t.property({type:Object,attribute:!1})],c=[t.property({type:Object,attribute:!1})],h=[t.query(".cell-content")],d=[t.property({type:Number})],u=[t.property({type:Boolean})],p=[t.property({type:Number})],m=[t.property({type:Boolean})],g=[t.render()],b=[t.styles()],y=[t.ready()],v=[t.watch("align")],f=[t.watch("value","column")],a(this,null,g,{kind:"method",name:"render",static:!1,private:!1,access:{has:e=>"render"in e,get:e=>e.render},metadata:_},null,S),a(this,null,b,{kind:"method",name:"styles",static:!1,private:!1,access:{has:e=>"styles"in e,get:e=>e.styles},metadata:_},null,S),a(this,null,y,{kind:"method",name:"init",static:!1,private:!1,access:{has:e=>"init"in e,get:e=>e.init},metadata:_},null,S),a(this,null,v,{kind:"method",name:"updateAlignment",static:!1,private:!1,access:{has:e=>"updateAlignment"in e,get:e=>e.updateAlignment},metadata:_},null,S),a(this,null,f,{kind:"method",name:"updateContent",static:!1,private:!1,access:{has:e=>"updateContent"in e,get:e=>e.updateContent},metadata:_},null,S),a(null,null,n,{kind:"field",name:"align",static:!1,private:!1,access:{has:e=>"align"in e,get:e=>e.align,set:(e,t)=>{e.align=t}},metadata:_},C,E),a(null,null,l,{kind:"field",name:"type",static:!1,private:!1,access:{has:e=>"type"in e,get:e=>e.type,set:(e,t)=>{e.type=t}},metadata:_},D,$),a(null,null,r,{kind:"field",name:"value",static:!1,private:!1,access:{has:e=>"value"in e,get:e=>e.value,set:(e,t)=>{e.value=t}},metadata:_},z,A),a(null,null,o,{kind:"field",name:"column",static:!1,private:!1,access:{has:e=>"column"in e,get:e=>e.column,set:(e,t)=>{e.column=t}},metadata:_},T,F),a(null,null,c,{kind:"field",name:"rowData",static:!1,private:!1,access:{has:e=>"rowData"in e,get:e=>e.rowData,set:(e,t)=>{e.rowData=t}},metadata:_},L,R),a(null,null,h,{kind:"field",name:"contentElement",static:!1,private:!1,access:{has:e=>"contentElement"in e,get:e=>e.contentElement,set:(e,t)=>{e.contentElement=t}},metadata:_},M,I),a(null,null,d,{kind:"field",name:"decimals",static:!1,private:!1,access:{has:e=>"decimals"in e,get:e=>e.decimals,set:(e,t)=>{e.decimals=t}},metadata:_},j,B),a(null,null,u,{kind:"field",name:"showTrend",static:!1,private:!1,access:{has:e=>"showTrend"in e,get:e=>e.showTrend,set:(e,t)=>{e.showTrend=t}},metadata:_},O,P),a(null,null,p,{kind:"field",name:"trendValue",static:!1,private:!1,access:{has:e=>"trendValue"in e,get:e=>e.trendValue,set:(e,t)=>{e.trendValue=t}},metadata:_},V,H),a(null,null,m,{kind:"field",name:"colorize",static:!1,private:!1,access:{has:e=>"colorize"in e,get:e=>e.colorize,set:(e,t)=>{e.colorize=t}},metadata:_},N,q),a(null,e={value:s},w,{kind:"class",name:s.name,metadata:_},null,k),s=e.value,_&&Object.defineProperty(s,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:_}),i(s,k)}render(){const e=this.formatPercentageValue(),a=this.getTrendArrow(),i=this.getPercentageStyles();return t.html`
      <div class="cell-content cell-content--percentage" part="content" style="${i}">
        ${e}
        ${this.showTrend&&a?t.unsafeHTML(`<span class="percentage-trend">${a}</span>`):""}
      </div>
    `}styles(){return t.css`${":host{color:var(--snice-color-text,rgb(23 23 23));display:flex;align-items:center;min-height:2.5rem;height:2.5rem;min-width:6.25rem;flex:1;font-size:.875rem;line-height:1.25rem;font-variant-numeric:tabular-nums}.cell-content{width:100%;min-width:6.25rem;min-height:1.25rem;word-wrap:break-word;display:flex;align-items:center;justify-content:flex-end;gap:.375rem}.cell-content--percentage{font-feature-settings:'tnum'}.percentage-trend{display:inline-flex;align-items:center;font-size:1rem;margin-left:.25rem}:host(.percentage--positive){color:var(--snice-color-success,rgb(22 163 74))}:host(.percentage--negative){color:var(--snice-color-danger,rgb(220 38 38))}:host(.percentage--zero){color:var(--snice-color-text-secondary,rgb(82 82 82))}:host(.percentage--trend-up) .percentage-trend{color:var(--snice-color-success,rgb(22 163 74))}:host(.percentage--trend-down) .percentage-trend{color:var(--snice-color-danger,rgb(220 38 38))}:host(.percentage--trend-neutral) .percentage-trend{color:var(--snice-color-text-secondary,rgb(82 82 82))}:host([align=left]) .cell-content{justify-content:flex-start}:host([align=center]) .cell-content{justify-content:center}:host([align=right]) .cell-content{justify-content:flex-end}@media (max-width:768px){:host{color:var(--snice-color-text,rgb(23 23 23));font-size:.75rem;line-height:1rem}.percentage-trend{font-size:.875rem}}@media print{:host{color:var(--snice-color-text,rgb(23 23 23));font-size:.75rem}.percentage-trend{font-size:.875rem}}"}`}init(){this.applyAlignment()}applyAlignment(){this.style.textAlign=this.align}updateAlignment(){this.applyAlignment()}updateContent(){if(this.contentElement){const e=this.formatPercentageValue(),t=this.getTrendArrow(),a=this.getPercentageStyles(),i=this.showTrend&&t?`<span class="percentage-trend">${t}</span>`:"";this.contentElement.innerHTML=e+i,this.contentElement.setAttribute("style",a)}}formatPercentageValue(){if(null===this.value||void 0===this.value||""===this.value)return"";if(this.column?.formatter)return this.column.formatter(this.value,this.rowData);const e=this.column?.percentageFormat||{decimals:this.decimals,showTrend:this.showTrend,trendValue:this.trendValue,colorize:this.colorize},t=Number(this.value);if(isNaN(t))return String(this.value);return`${t.toFixed(e.decimals??this.decimals)}%`}getTrendArrow(){const e=this.column?.percentageFormat?.trendValue??this.trendValue;return null==e?"":e>0?"↑":e<0?"↓":"→"}getPercentageStyles(){const e=Number(this.value),t=this.column?.percentageFormat?.colorize??this.colorize;this.classList.remove("percentage--positive","percentage--negative","percentage--zero"),t&&(e>0?this.classList.add("percentage--positive"):e<0?this.classList.add("percentage--negative"):0===e&&this.classList.add("percentage--zero"));const a=this.column?.percentageFormat?.trendValue??this.trendValue;return this.classList.remove("percentage--trend-up","percentage--trend-down","percentage--trend-neutral"),null!=a&&(a>0?this.classList.add("percentage--trend-up"):a<0?this.classList.add("percentage--trend-down"):this.classList.add("percentage--trend-neutral")),"text-align: right"}constructor(){super(...arguments),this.align=(i(this,S),i(this,C,"right")),this.type=(i(this,E),i(this,D,"percentage")),this.value=(i(this,$),i(this,z,"")),this.column=(i(this,A),i(this,T,null)),this.rowData=(i(this,F),i(this,L,null)),this.contentElement=(i(this,R),i(this,M,void 0)),this.decimals=(i(this,I),i(this,j,2)),this.showTrend=(i(this,B),i(this,O,!1)),this.trendValue=(i(this,P),i(this,V,null)),this.colorize=(i(this,H),i(this,N,!0)),i(this,q)}})})();(()=>{let e,s,n,l,r,o,c,h,d,u,p,m,g,b,y,v,f,w=[t.element("snice-cell-location")],k=[],x=HTMLElement,S=[],C=[],E=[],D=[],$=[],z=[],A=[],T=[],F=[],L=[],R=[],M=[],I=[],j=[],B=[],O=[],P=[],V=[],H=[],N=[],q=[],_=[],W=[];(class extends x{static{s=this}static{const K="function"==typeof Symbol&&Symbol.metadata?Object.create(x[Symbol.metadata]??null):void 0;n=[t.property({type:String})],l=[t.property({type:String})],r=[t.property({type:String})],o=[t.property({type:String})],c=[t.property({type:Boolean})],h=[t.property({type:String})],d=[t.property({type:Boolean})],u=[t.property({type:Object,attribute:!1})],p=[t.property({type:Object,attribute:!1})],m=[t.property({type:String})],g=[t.property({type:String})],b=[t.render()],y=[t.styles()],v=[t.ready()],f=[t.watch("value","column")],a(this,null,b,{kind:"method",name:"render",static:!1,private:!1,access:{has:e=>"render"in e,get:e=>e.render},metadata:K},null,S),a(this,null,y,{kind:"method",name:"styles",static:!1,private:!1,access:{has:e=>"styles"in e,get:e=>e.styles},metadata:K},null,S),a(this,null,v,{kind:"method",name:"init",static:!1,private:!1,access:{has:e=>"init"in e,get:e=>e.init},metadata:K},null,S),a(this,null,f,{kind:"method",name:"updateLocationAttributes",static:!1,private:!1,access:{has:e=>"updateLocationAttributes"in e,get:e=>e.updateLocationAttributes},metadata:K},null,S),a(null,null,n,{kind:"field",name:"value",static:!1,private:!1,access:{has:e=>"value"in e,get:e=>e.value,set:(e,t)=>{e.value=t}},metadata:K},C,E),a(null,null,l,{kind:"field",name:"address",static:!1,private:!1,access:{has:e=>"address"in e,get:e=>e.address,set:(e,t)=>{e.address=t}},metadata:K},D,$),a(null,null,r,{kind:"field",name:"latitude",static:!1,private:!1,access:{has:e=>"latitude"in e,get:e=>e.latitude,set:(e,t)=>{e.latitude=t}},metadata:K},z,A),a(null,null,o,{kind:"field",name:"longitude",static:!1,private:!1,access:{has:e=>"longitude"in e,get:e=>e.longitude,set:(e,t)=>{e.longitude=t}},metadata:K},T,F),a(null,null,c,{kind:"field",name:"showMapLink",static:!1,private:!1,access:{has:e=>"showMapLink"in e,get:e=>e.showMapLink,set:(e,t)=>{e.showMapLink=t}},metadata:K},L,R),a(null,null,h,{kind:"field",name:"mapProvider",static:!1,private:!1,access:{has:e=>"mapProvider"in e,get:e=>e.mapProvider,set:(e,t)=>{e.mapProvider=t}},metadata:K},M,I),a(null,null,d,{kind:"field",name:"showIcon",static:!1,private:!1,access:{has:e=>"showIcon"in e,get:e=>e.showIcon,set:(e,t)=>{e.showIcon=t}},metadata:K},j,B),a(null,null,u,{kind:"field",name:"column",static:!1,private:!1,access:{has:e=>"column"in e,get:e=>e.column,set:(e,t)=>{e.column=t}},metadata:K},O,P),a(null,null,p,{kind:"field",name:"rowData",static:!1,private:!1,access:{has:e=>"rowData"in e,get:e=>e.rowData,set:(e,t)=>{e.rowData=t}},metadata:K},V,H),a(null,null,m,{kind:"field",name:"align",static:!1,private:!1,access:{has:e=>"align"in e,get:e=>e.align,set:(e,t)=>{e.align=t}},metadata:K},N,q),a(null,null,g,{kind:"field",name:"type",static:!1,private:!1,access:{has:e=>"type"in e,get:e=>e.type,set:(e,t)=>{e.type=t}},metadata:K},_,W),a(null,e={value:s},w,{kind:"class",name:s.name,metadata:K},null,k),s=e.value,K&&Object.defineProperty(s,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:K}),i(s,k)}render(){const e=this.address||this.value,a=this.showIcon?'<span class="location-icon">📍</span>':"",i=this.getMapLink();if(!e&&!this.latitude&&!this.longitude)return t.html`
        ...
        <div class="input-container" part="container">
          <span class="icon-slot icon-slot--prefix" part="prefix-icon">
            <slot name="prefix-icon">
              <if ${this.prefixIcon}>
                ${k(this.prefixIcon,"icon icon--prefix")}
              </if>
            </slot>
          </span>
          ...
          <if ${!("password"===this.type&&this.password)}>
            <span class="icon-slot icon-slot--suffix" part="suffix-icon">
              <slot name="suffix-icon">
                <if ${this.suffixIcon}>
                  ${k(this.suffixIcon,"icon icon--suffix")}
                </if>
              </slot>
            </span>
          </if>
    ...
    `}handleInternalClick(e){if(this.disabled||this.loading)return e.preventDefault(),void e.stopPropagation();if(this.href)if(this.download){const e=document.createElement("a");e.href=this.href,e.download=this.download,e.click()}else this.target?window.open(this.href,this.target):window.location.href=this.href;const t=this.internals?.form||this.closest("form");if(t)switch(this.type){case"submit":t.requestSubmit();break;case"reset":t.reset()}this.dispatchEvent(new CustomEvent("button-click",{bubbles:!0,composed:!0,detail:{originalEvent:e}}))}styles(){return t.css`${":host{display:inline-block;position:relative;width:auto;cursor:pointer}:host([disabled]){cursor:not-allowed}.button{display:inline-flex;align-items:center;justify-content:center;width:100%;border:1px solid;font-family:var(--snice-font-family, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif);font-weight:var(--snice-font-weight-medium,500);text-decoration:none;user-select:none;white-space:nowrap;vertical-align:middle;padding:0;box-shadow:var(--snice-shadow-xs,0 1px 2px 0 rgb(0 0 0 / .03));transition:color var(--snice-transition-fast, 150ms) ease,background-color var(--snice-transition-fast, 150ms) ease,border-color var(--snice-transition-fast, 150ms) ease,box-shadow var(--snice-transition-fast, 150ms) ease,transform var(--snice-transition-fast, 150ms) cubic-bezier(.3, 0, .2, 1);cursor:inherit;position:relative}.button::before{content:'';position:absolute;inset:0;border-radius:inherit;background:var(--snice-gradient-button,none);pointer-events:none}.button:active{transition:color 50ms,background-color 50ms,border-color 50ms,box-shadow 50ms}.button:focus-visible{outline:0;box-shadow:0 0 0 var(--snice-focus-ring-width,2px) var(--snice-focus-ring-color,rgb(59 130 246 / .5))}.button--disabled{opacity:.5;cursor:not-allowed;box-shadow:none}.button--small{font-size:var(--snice-font-size-sm, .875rem);height:1.875rem;padding:0 var(--snice-spacing-sm,.75rem);border-radius:var(--snice-border-radius-md,.25rem)}.button--medium{font-size:var(--snice-font-size-md, 1rem);height:2.5rem;padding:0 var(--snice-spacing-md,1rem);border-radius:var(--snice-border-radius-md,.25rem)}.button--large{font-size:var(--snice-font-size-lg, 1.125rem);height:3.125rem;padding:0 var(--snice-spacing-lg,1.5rem);border-radius:var(--snice-border-radius-md,.25rem)}.button--default{background-color:var(--snice-color-background,rgb(255 255 255));color:var(--snice-color-text,rgb(23 23 23));border-color:var(--snice-color-border,rgb(226 226 226))}.button--default:hover:not(.button--disabled){background-color:var(--snice-color-background-secondary,rgb(250 250 250));border-color:var(--snice-color-border-hover,rgb(204 204 204));box-shadow:var(--snice-shadow-sm,0 1px 2px 0 rgb(0 0 0 / .05));transform:translateY(-1px)}.button--default:active:not(.button--disabled){background-color:var(--snice-color-background-tertiary,rgb(248 248 248));border-color:var(--snice-color-border-hover,rgb(204 204 204));box-shadow:var(--snice-shadow-inset-sm,inset 0 1px 2px rgb(0 0 0 / .05));transform:translateY(0)}.button--primary{background-color:var(--snice-color-primary,rgb(37 99 235));color:var(--snice-color-text-inverse,rgb(250 250 250));border-color:var(--snice-color-primary,rgb(37 99 235))}.button--primary:hover:not(.button--disabled){background-color:var(--snice-color-primary-hover,rgb(29 78 216));border-color:var(--snice-color-primary-hover,rgb(29 78 216));box-shadow:var(--snice-shadow-sm,0 1px 2px 0 rgb(0 0 0 / .05));transform:translateY(-1px)}.button--primary:active:not(.button--disabled){background-color:color-mix(in srgb,var(--snice-color-primary,rgb(37 99 235)) 85%,#fff);border-color:color-mix(in srgb,var(--snice-color-primary,rgb(37 99 235)) 85%,#fff);box-shadow:var(--snice-shadow-inset-sm,inset 0 1px 2px rgb(0 0 0 / .05));transform:translateY(0)}.button--success{background-color:var(--snice-color-success,rgb(22 163 74));color:var(--snice-color-text-inverse,rgb(250 250 250));border-color:var(--snice-color-success,rgb(22 163 74))}.button--success:hover:not(.button--disabled){background-color:var(--snice-color-success-hover,rgb(21 128 61));border-color:var(--snice-color-success-hover,rgb(21 128 61));box-shadow:var(--snice-shadow-sm,0 1px 2px 0 rgb(0 0 0 / .05));transform:translateY(-1px)}.button--success:active:not(.button--disabled){background-color:color-mix(in srgb,var(--snice-color-success,rgb(22 163 74)) 85%,#fff);border-color:color-mix(in srgb,var(--snice-color-success,rgb(22 163 74)) 85%,#fff);box-shadow:var(--snice-shadow-inset-sm,inset 0 1px 2px rgb(0 0 0 / .05));transform:translateY(0)}.button--warning{background-color:var(--snice-color-warning,rgb(202 138 4));color:var(--snice-color-text-inverse,rgb(250 250 250));border-color:var(--snice-color-warning,rgb(202 138 4))}.button--warning:hover:not(.button--disabled){background-color:var(--snice-color-warning-hover,rgb(161 98 7));border-color:var(--snice-color-warning-hover,rgb(161 98 7));box-shadow:var(--snice-shadow-sm,0 1px 2px 0 rgb(0 0 0 / .05));transform:translateY(-1px)}.button--warning:active:not(.button--disabled){background-color:color-mix(in srgb,var(--snice-color-warning,rgb(202 138 4)) 85%,#fff);border-color:color-mix(in srgb,var(--snice-color-warning,rgb(202 138 4)) 85%,#fff);box-shadow:var(--snice-shadow-inset-sm,inset 0 1px 2px rgb(0 0 0 / .05));transform:translateY(0)}.button--danger{background-color:var(--snice-color-danger,rgb(220 38 38));color:var(--snice-color-text-inverse,rgb(250 250 250));border-color:var(--snice-color-danger,rgb(220 38 38))}.button--danger:hover:not(.button--disabled){background-color:var(--snice-color-danger-hover,rgb(185 28 28));border-color:var(--snice-color-danger-hover,rgb(185 28 28));box-shadow:var(--snice-shadow-sm,0 1px 2px 0 rgb(0 0 0 / .05));transform:translateY(-1px)}.button--danger:active:not(.button--disabled){background-color:color-mix(in srgb,var(--snice-color-danger,rgb(220 38 38)) 85%,#fff);border-color:color-mix(in srgb,var(--snice-color-danger,rgb(220 38 38)) 85%,#fff);box-shadow:var(--snice-shadow-inset-sm,inset 0 1px 2px rgb(0 0 0 / .05));transform:translateY(0)}.button--text{background-color:transparent;color:var(--snice-color-primary,rgb(37 99 235));border-color:transparent;box-shadow:none}.button--text::before{display:none}.button--text:hover:not(.button--disabled){background-color:var(--snice-color-primary-alpha,rgb(37 99 235 / .1));color:var(--snice-color-primary-hover,rgb(29 78 216));box-shadow:none;transform:none}.button--text:active:not(.button--disabled){background-color:var(--snice-color-primary-alpha-strong,rgb(37 99 235 / .15));box-shadow:none;transform:none}.button--outline{box-shadow:none}.button--outline::before{display:none}.button--outline.button--default{background-color:transparent;color:var(--snice-color-text,rgb(23 23 23))}.button--outline.button--primary{background-color:transparent;color:var(--snice-color-primary,rgb(37 99 235))}.button--outline.button--success{background-color:transparent;color:var(--snice-color-success,rgb(22 163 74))}.button--outline.button--warning{background-color:transparent;color:var(--snice-color-warning,rgb(202 138 4))}.button--outline.button--danger{background-color:transparent;color:var(--snice-color-danger,rgb(220 38 38))}.button--outline:hover:not(.button--disabled){background-color:var(--snice-color-border-alpha,rgb(82 82 82 / .1));box-shadow:none;transform:none}.button--outline:active:not(.button--disabled){background-color:var(--snice-color-border-alpha-strong,rgb(82 82 82 / .15));box-shadow:none;transform:none}.button--pill{border-radius:var(--snice-border-radius-pill,9999px)}.button--circle{border-radius:var(--snice-border-radius-circle,50%);width:var(--size);padding:0}.button--small.button--circle{--size:1.875rem}.button--medium.button--circle{--size:2.5rem}.button--large.button--circle{--size:3.125rem}.button--loading{position:relative;cursor:wait}.button--loading .label{visibility:hidden}.spinner{display:none;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:1em;height:1em}.button--loading .spinner{display:block}.spinner::after{content:'';display:block;width:100%;height:100%;box-sizing:border-box;border:2px solid currentColor;border-right-color:transparent;border-radius:50%;animation:.6s linear infinite spin}@keyframes spin{to{transform:rotate(360deg)}}.icon-slot{display:inline-flex;align-items:center;justify-content:center;flex-shrink:0;width:1.25em;height:1.25em;line-height:1}.icon-slot:empty{display:none}.icon{display:inline-flex;align-items:center;justify-content:center;flex-shrink:0;width:1.25em;height:1.25em;line-height:1}.icon img{width:100%;height:100%;object-fit:contain}.icon svg{width:100%;height:100%}.icon-slot ::slotted(*){display:flex;align-items:center;justify-content:center;width:1.25em;height:1.25em;font-size:1.25em;line-height:1}.icon-slot ::slotted(svg){width:1.25em;height:1.25em}.icon-slot ::slotted(img){width:1.25em;height:1.25em;object-fit:contain}.button--icon-start .icon,.button--icon-start .icon-slot{margin-right:.5em}.button--icon-end .icon,.button--icon-end .icon-slot{margin-left:.5em}.button--circle .icon,.button--circle .icon-slot{margin:0}"}`}setLoading(e){this.loading=e}setDisabled(e){this.disabled=e}setVariant(e){this.variant=e}focus(e){this.button?.focus(e)}blur(){this.button?.blur()}click(){this.button?.click()}})})();(()=>{let e,s,n,l,r,o,c,h,d,u,p,m,g,b,y,v,f,w,k,x,S,C=[t.element("snice-checkbox")],E=[],D=HTMLElement,$=[],z=[],A=[],T=[],F=[],L=[],R=[],M=[],I=[],j=[],B=[],O=[],P=[],V=[],H=[],N=[],q=[],_=[],W=[],K=[],U=[],Y=[],G=[],J=[],X=[],Q=[],Z=[],ee=[],te=[];(class extends D{static{s=this}static{const ae="function"==typeof Symbol&&Symbol.metadata?Object.create(D[Symbol.metadata]??null):void 0;n=[t.property({type:Boolean})],l=[t.property({type:Boolean})],r=[t.property({type:Boolean})],o=[t.property({type:Boolean})],c=[t.property({type:Boolean})],h=[t.property({type:Boolean})],d=[t.property({})],u=[t.property({})],p=[t.property({})],m=[t.property({})],g=[t.query(".checkbox-input")],b=[t.query(".checkbox")],y=[t.query(".checkbox-label")],v=[t.query(".checkbox-wrapper")],f=[t.on("click")],w=[t.render()],k=[t.watch("checked")],x=[t.watch("indeterminate")],S=[t.styles()],a(this,null,f,{kind:"method",name:"handleCheckboxClick",static:!1,private:!1,access:{has:e=>"handleCheckboxClick"in e,get:e=>e.handleCheckboxClick},metadata:ae},null,$),a(this,null,w,{kind:"method",name:"render",static:!1,private:!1,access:{has:e=>"render"in e,get:e=>e.render},metadata:ae},null,$),a(this,null,k,{kind:"method",name:"handleCheckedChange",static:!1,private:!1,access:{has:e=>"handleCheckedChange"in e,get:e=>e.handleCheckedChange},metadata:ae},null,$),a(this,null,x,{kind:"method",name:"handleIndeterminateChange",static:!1,private:!1,access:{has:e=>"handleIndeterminateChange"in e,get:e=>e.handleIndeterminateChange},metadata:ae},null,$),a(this,null,S,{kind:"method",name:"styles",static:!1,private:!1,access:{has:e=>"styles"in e,get:e=>e.styles},metadata:ae},null,$),a(null,null,n,{kind:"field",name:"checked",static:!1,private:!1,access:{has:e=>"checked"in e,get:e=>e.checked,set:(e,t)=>{e.checked=t}},metadata:ae},z,A),a(null,null,l,{kind:"field",name:"indeterminate",static:!1,private:!1,access:{has:e=>"indeterminate"in e,get:e=>e.indeterminate,set:(e,t)=>{e.indeterminate=t}},metadata:ae},T,F),a(null,null,r,{kind:"field",name:"disabled",static:!1,private:!1,access:{has:e=>"disabled"in e,get:e=>e.disabled,set:(e,t)=>{e.disabled=t}},metadata:ae},L,R),a(null,null,o,{kind:"field",name:"loading",static:!1,private:!1,access:{has:e=>"loading"in e,get:e=>e.loading,set:(e,t)=>{e.loading=t}},metadata:ae},M,I),a(null,null,c,{kind:"field",name:"required",static:!1,private:!1,access:{has:e=>"required"in e,get:e=>e.required,set:(e,t)=>{e.required=t}},metadata:ae},j,B),a(null,null,h,{kind:"field",name:"invalid",static:!1,private:!1,access:{has:e=>"invalid"in e,get:e=>e.invalid,set:(e,t)=>{e.invalid=t}},metadata:ae},O,P),a(null,null,d,{kind:"field",name:"size",static:!1,private:!1,access:{has:e=>"size"in e,get:e=>e.size,set:(e,t)=>{e.size=t}},metadata:ae},V,H),a(null,null,u,{kind:"field",name:"name",static:!1,private:!1,access:{has:e=>"name"in e,get:e=>e.name,set:(e,t)=>{e.name=t}},metadata:ae},N,q),a(null,null,p,{kind:"field",name:"value",static:!1,private:!1,access:{has:e=>"value"in e,get:e=>e.value,set:(e,t)=>{e.value=t}},metadata:ae},_,W),a(null,null,m,{kind:"field",name:"label",static:!1,private:!1,access:{has:e=>"label"in e,get:e=>e.label,set:(e,t)=>{e.label=t}},metadata:ae},K,U),a(null,null,g,{kind:"field",name:"input",static:!1,private:!1,access:{has:e=>"input"in e,get:e=>e.input,set:(e,t)=>{e.input=t}},metadata:ae},Y,G),a(null,null,b,{kind:"field",name:"checkbox",static:!1,private:!1,access:{has:e=>"checkbox"in e,get:e=>e.checkbox,set:(e,t)=>{e.checkbox=t}},metadata:ae},J,X),a(null,null,y,{kind:"field",name:"labelElement",static:!1,private:!1,access:{has:e=>"labelElement"in e,get:e=>e.labelElement,set:(e,t)=>{e.labelElement=t}},metadata:ae},Q,Z),a(null,null,v,{kind:"field",name:"wrapper",static:!1,private:!1,access:{has:e=>"wrapper"in e,get:e=>e.wrapper,set:(e,t)=>{e.wrapper=t}},metadata:ae},ee,te),a(null,e={value:s},C,{kind:"class",name:s.name,metadata:ae},null,E),s=e.value,ae&&Object.defineProperty(s,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:ae}),i(s,E)}handleCheckboxClick(){this.disabled||this.loading||this.toggle()}render(){const e=`checkbox-wrapper${this.disabled?" checkbox-wrapper--disabled":""}${this.loading?" checkbox-wrapper--loading":""}`,a=`checkbox checkbox--${this.size}${this.invalid?" checkbox--invalid":""}${this.indeterminate?" checkbox--indeterminate":""}${this.loading?" checkbox--loading":""}`,i=`checkbox-label checkbox-label--${this.size}${this.required?" checkbox-label--required":""}`;return t.html`
      <label class="${e}" @change="${e=>this.handleInternalChange(e)}">
        ...
        <if ${this.label}>
          <span class="${i}" part="label">
            ${this.label}
          </span>
        </if>
      </label>
    `}handleInternalChange(e){const t=e.target;"checkbox"===t.type&&(this.checked=t.checked,this.indeterminate=!1,this.dispatchEvent(new CustomEvent("checkbox-change",{bubbles:!0,composed:!0,detail:{checked:this.checked,indeterminate:this.indeterminate,checkbox:this}})))}handleCheckedChange(){this.input&&(this.input.checked=this.checked)}handleIndeterminateChange(){this.input&&(this.input.indeterminate=this.indeterminate)}styles(){return t.css`${":host{display:inline-flex;align-items:center;align-self:flex-end;min-height:2.5rem;font-family:var(--snice-font-family, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif)}:host([size=small]){min-height:2rem;align-self:center}:host([compact]){min-height:0;align-self:center}.checkbox-wrapper{display:inline-flex;align-items:center;position:relative;cursor:pointer;user-select:none;min-height:1.25rem}.checkbox-wrapper--disabled{cursor:not-allowed;opacity:.6}.checkbox-input{position:absolute;opacity:0;left:0;top:0;width:100%;height:100%;margin:0;cursor:pointer;z-index:1;pointer-events:all}.checkbox{position:relative;display:inline-flex;align-items:center;justify-content:center;background:var(--snice-color-background-input,rgb(248 247 245));border:2px solid var(--snice-color-border,rgb(226 226 226));border-radius:var(--snice-border-radius-sm,.125rem);transition:all var(--snice-transition-fast, 150ms) ease}.checkbox--small{width:1rem;height:1rem}.checkbox--medium{width:1.25rem;height:1.25rem}.checkbox--large{width:1.5rem;height:1.5rem}.checkbox-input:checked~.checkbox{background:var(--snice-color-primary,rgb(37 99 235));border-color:var(--snice-color-primary,rgb(37 99 235))}.checkbox-input:focus-visible~.checkbox{box-shadow:0 0 0 3px var(--snice-focus-ring-color,rgb(59 130 246 / .5));outline:2px solid var(--snice-color-primary,rgb(37 99 235));outline-offset:2px}.checkbox-input:disabled~.checkbox{background:var(--snice-color-background-secondary,rgb(250 250 250));border-color:var(--snice-color-border,rgb(226 226 226))}.checkbox-input:disabled:checked~.checkbox{background:var(--snice-color-text-secondary,rgb(82 82 82));border-color:var(--snice-color-text-secondary,rgb(82 82 82))}.checkbox--invalid{border-color:var(--snice-color-danger,rgb(220 38 38))}.checkbox-input:checked~.checkbox--invalid{background:var(--snice-color-danger,rgb(220 38 38));border-color:var(--snice-color-danger,rgb(220 38 38))}.checkbox-icon{position:absolute;display:none;color:var(--snice-color-text-inverse,rgb(250 250 250))}.checkbox-input:checked~.checkbox .checkbox-icon--check{display:block}.checkbox--indeterminate .checkbox-icon--check{display:none!important}.checkbox--indeterminate .checkbox-icon--indeterminate{display:block!important}.checkbox--small .checkbox-icon{width:.75rem;height:.75rem}.checkbox--medium .checkbox-icon{width:.875rem;height:.875rem}.checkbox--large .checkbox-icon{width:1.125rem;height:1.125rem}.checkbox-label{margin-left:.5rem;color:var(--snice-color-text,rgb(23 23 23));cursor:pointer}.checkbox-label--small{font-size:var(--snice-font-size-sm, .875rem)}.checkbox-label--medium{font-size:var(--snice-font-size-md, 1rem)}.checkbox-label--large{font-size:var(--snice-font-size-lg, 1.125rem)}.checkbox-wrapper--disabled .checkbox-label{color:var(--snice-color-text-secondary,rgb(82 82 82));cursor:not-allowed}.checkbox-label--required::after{content:' *';color:var(--snice-color-danger,rgb(220 38 38))}.checkbox-wrapper:not(.checkbox-wrapper--disabled):hover .checkbox{border-color:var(--snice-color-primary,rgb(37 99 235))}.checkbox-wrapper:not(.checkbox-wrapper--disabled):hover .checkbox-input:checked~.checkbox{background:var(--snice-color-primary-hover,rgb(29 78 216));border-color:var(--snice-color-primary-hover,rgb(29 78 216))}.checkbox-wrapper--loading{cursor:wait;opacity:.7}.checkbox--loading{cursor:wait}.checkbox-spinner{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;width:100%;height:100%;pointer-events:none}.checkbox-spinner::after{content:'';display:block;width:.75em;height:.75em;border:2px solid currentColor;border-right-color:transparent;border-radius:50%;animation:.6s linear infinite spin}@keyframes spin{to{transform:rotate(360deg)}}"}`}focus(){this.input?.focus()}blur(){this.input?.blur()}click(){this.input?.click()}toggle(){this.checked=!this.checked,this.indeterminate=!1,this.dispatchEvent(new CustomEvent("checkbox-change",{bubbles:!0,composed:!0,detail:{checked:this.checked,indeterminate:this.indeterminate,checkbox:this}}))}setIndeterminate(){this.indeterminate=!0,this.checked=!1,this.dispatchEvent(new CustomEvent("checkbox-change",{bubbles:!0,composed:!0,detail:{checked:this.checked,indeterminate:this.indeterminate,checkbox:this}}))}constructor(){super(...arguments),this.checked=(i(this,$),i(this,z,!1)),this.indeterminate=(i(this,A),i(this,T,!1)),this.disabled=(i(this,F),i(this,L,!1)),this.loading=(i(this,R),i(this,M,!1)),this.required=(i(this,I),i(this,j,!1)),this.invalid=(i(this,B),i(this,O,!1)),this.size=(i(this,P),i(this,V,"medium")),this.name=(i(this,H),i(this,N,"")),this.value=(i(this,q),i(this,_,"on")),this.label=(i(this,W),i(this,K,"")),this.input=(i(this,U),i(this,Y,void 0)),this.checkbox=(i(this,G),i(this,J,void 0)),this.labelElement=(i(this,X),i(this,Q,void 0)),this.wrapper=(i(this,Z),i(this,ee,void 0)),i(this,te)}})})();let x=(()=>{let e,s,r,o,c,h,k,x,S,C,E,D,$,z,A,T,F,L,R,M,I,j,B,O,P,V,H,N,q,_,W,K,U,Y,G,J,X,Q,Z,ee,te,ae,ie,se,ne,le,re,oe,ce,he,de,ue,pe,me,ge,be,ye=[t.element("snice-table")],ve=[],fe=HTMLElement,we=[],ke=[],xe=[],Se=[],Ce=[],Ee=[],De=[],$e=[],ze=[],Ae=[],Te=[],Fe=[],Le=[],Re=[],Me=[],Ie=[],je=[],Be=[],Oe=[],Pe=[],Ve=[],He=[],Ne=[],qe=[],_e=[],We=[],Ke=[],Ue=[],Ye=[],Ge=[],Je=[],Xe=[],Qe=[],Ze=[],et=[],tt=[],at=[],it=[],st=[],nt=[],lt=[],rt=[],ot=[],ct=[],ht=[],dt=[],ut=[],pt=[],mt=[],gt=[],bt=[],yt=[],vt=[],ft=[],wt=[],kt=[],xt=[],St=[],Ct=[],Et=[],Dt=[],$t=[],zt=[],At=[],Tt=[],Ft=[],Lt=[],Rt=[],Mt=[],It=[],jt=[],Bt=[],Ot=[],Pt=[],Vt=[];return class extends fe{static{s=this}constructor(){super(...arguments),this.striped=(i(this,we),i(this,ke,!1)),this.searchable=(i(this,xe),i(this,Se,!1)),this.filterable=(i(this,Ce),i(this,Ee,!1)),this.sortable=(i(this,De),i(this,$e,!1)),this.selectable=(i(this,ze),i(this,Ae,!1)),this.hoverable=(i(this,Te),i(this,Fe,!0)),this.clickable=(i(this,Le),i(this,Re,!1)),this.list=(i(this,Me),i(this,Ie,!1)),this.pagination=(i(this,je),i(this,Be,!1)),this.paginationMode=(i(this,Oe),i(this,Pe,"client")),this.pageSize=(i(this,Ve),i(this,He,10)),this.currentPage=(i(this,Ne),i(this,qe,1)),this.totalItems=(i(this,_e),i(this,We,0)),this.pageSizes=(i(this,Ke),i(this,Ue,[10,25,50,100])),this.searchDebounce=(i(this,Ye),i(this,Ge,500)),this.columns=(i(this,Je),[]),this.data=[],this.currentSort=i(this,Xe,[]),this.searchText=(i(this,Qe),""),this.selector=i(this,Ze,""),this.selectorOptions=(i(this,et),i(this,tt,[])),this.loading=(i(this,at),i(this,it,!1)),this.virtualize=(i(this,st),i(this,nt,!1)),this.rowHeight=(i(this,lt),i(this,rt,48)),this.virtualBuffer=(i(this,ot),i(this,ct,200)),this.columnResize=(i(this,ht),i(this,dt,!1)),this.editable=(i(this,ut),i(this,pt,!1)),this.editMode=(i(this,mt),i(this,gt,"cell")),this.density=(i(this,bt),i(this,yt,"standard")),this.headerFilters=(i(this,vt),i(this,ft,!1)),this.quickFilter=(i(this,wt),i(this,kt,!1)),this.rowReorder=(i(this,xt),i(this,St,!1)),this.columnReorder=(i(this,Ct),i(this,Et,!1)),this.columnMenu=(i(this,Dt),i(this,$t,!1)),this.lazyLoad=(i(this,zt),i(this,At,!1)),this.lazyLoadThreshold=(i(this,Tt),i(this,Ft,200)),this.selectedRows=(i(this,Lt),i(this,Rt,[])),this.virtualizer=(i(this,Mt),new n),this.columnManager=new l,this.filterEngine=new d,this.editor=new u,this.keyboard=new p,this.exporter=new m,this.masterDetail=new g,this.toolbar=new b,this.treeData=new y,this.columnMenuManager=new v,this.rowDnD=new f,this.columnDnD=new w,this.pinnedTopRows=[],this.pinnedBottomRows=[],this.lazyLoadHandler=null,this.rowHeightCallback=null,this.table=i(this,It,void 0),this.thead=(i(this,jt),i(this,Bt,void 0)),this.tbody=(i(this,Ot),i(this,Pt,void 0)),this._hasController=(i(this,Vt),!1),this._unsortedData=[],this.dataRequestTimeout=null,this.handleClick=e=>{const t=e.target,a=t.closest("th.sortable");if(a){const e=a.getAttribute("data-key");return void(e&&this.toggleSort(e,!0))}const i=t.closest("tbody tr");if(i){if(t.matches('input[type="checkbox"], button, a, .interactive'))return;const e=parseInt(i.getAttribute("data-index")||"0"),a=this.data[e];if(this.selectable){const t=this.selectedRows.includes(e);this.selectedRows=t?this.selectedRows.filter(t=>t!==e):[...this.selectedRows,e],this.updateRowSelectionState(),this.updateSelectAllState(),this.dispatchRowSelectionChanged(e,!t)}this.clickable&&this.dispatchEvent(new CustomEvent("row-clicked",{detail:{rowData:a,rowIndex:e}}))}},this.handleChange=e=>{const t=e.target;if(t.matches("snice-checkbox.row-select")){const e=t,a=parseInt(e.getAttribute("data-row-index")||"0");return e.checked?this.selectedRows.includes(a)||(this.selectedRows=[...this.selectedRows,a]):this.selectedRows=this.selectedRows.filter(e=>e!==a),this.updateRowSelectionState(),this.updateSelectAllState(),void this.dispatchRowSelectionChanged(a,e.checked)}if(t.matches("snice-checkbox.select-all")){const e=t;e.checked?this.selectedRows=this.data.map((e,t)=>t):this.selectedRows=[],this.updateRowSelectionState(),this.dispatchSelectAllChanged(e.checked)}},this.onAttached=()=>{this._hasController=!0,this.getTableConfig(),this.getTableData()},this.searchDebounceTimeout=null,this.handleSearchInput=e=>{const t=e.target;this.searchText=t.value,this.searchDebounceTimeout&&clearTimeout(this.searchDebounceTimeout),this.searchDebounceTimeout=setTimeout(()=>{this.debouncedDataRequest()},this.searchDebounce)},this.selectorDebounceTimeout=null,this.handleSelectorChange=e=>{this.selector=Array.isArray(e.detail.value)?e.detail.value.join(","):e.detail.value,this.selectorDebounceTimeout&&clearTimeout(this.selectorDebounceTimeout),this.selectorDebounceTimeout=setTimeout(()=>{this.debouncedDataRequest()},150)},this.selectabilityCheck=null,this.listViewRenderer=null}static{const n="function"==typeof Symbol&&Symbol.metadata?Object.create(fe[Symbol.metadata]??null):void 0;r=[t.property({type:Boolean,attribute:"striped"})],o=[t.property({type:Boolean,attribute:"searchable"})],c=[t.property({type:Boolean,attribute:"filterable"})],h=[t.property({type:Boolean,attribute:"sortable"})],k=[t.property({type:Boolean,attribute:"selectable"})],x=[t.property({type:Boolean,attribute:"hoverable"})],S=[t.property({type:Boolean,attribute:"clickable"})],C=[t.property({type:Boolean,attribute:"list"})],E=[t.property({type:Boolean,attribute:"pagination"})],D=[t.property({attribute:"pagination-mode"})],$=[t.property({type:Number,attribute:"page-size"})],z=[t.property({type:Number,attribute:"current-page"})],A=[t.property({type:Number,attribute:"total-items"})],T=[t.property({type:Array,attribute:!1})],F=[t.property({type:Number,attribute:"search-debounce"})],L=[t.property({type:Array,attribute:!1})],R=[t.property({type:String,attribute:"selector"})],M=[t.property({type:Array,attribute:!1})],I=[t.property({type:Boolean,attribute:"loading"})],j=[t.property({type:Boolean,attribute:"virtualize"})],B=[t.property({type:Number,attribute:"row-height"})],O=[t.property({type:Number,attribute:"virtual-buffer"})],P=[t.property({type:Boolean,attribute:"column-resize"})],V=[t.property({type:Boolean,attribute:"editable"})],H=[t.property({attribute:"edit-mode"})],N=[t.property({attribute:"density"})],q=[t.property({type:Boolean,attribute:"header-filters"})],_=[t.property({type:Boolean,attribute:"quick-filter"})],W=[t.property({type:Boolean,attribute:"row-reorder"})],K=[t.property({type:Boolean,attribute:"column-reorder"})],U=[t.property({type:Boolean,attribute:"column-menu"})],Y=[t.property({type:Boolean,attribute:"lazy-load"})],G=[t.property({type:Number,attribute:"lazy-load-threshold"})],J=[t.property({type:Array,attribute:!1})],X=[t.query("table")],Q=[t.query("thead")],Z=[t.query("tbody")],ee=[t.request("table/config")],te=[t.request("table/data")],ae=[t.styles()],ie=[t.render()],se=[t.ready()],ne=[t.watch("selector-options")],le=[t.watch("sortable")],re=[t.watch("selectable")],oe=[t.watch("columns")],ce=[t.watch("data","loading")],he=[t.watch("selected-rows")],de=[t.watch("current-sort")],ue=[t.watch("searchable","filterable")],pe=[t.dispatch("page-change",{bubbles:!0,composed:!0})],me=[t.dispatch("table-row-selection-changed",{bubbles:!0,composed:!0})],ge=[t.dispatch("table-select-all-changed",{bubbles:!0,composed:!0})],be=[t.dispose()],a(this,null,ee,{kind:"method",name:"getTableConfig",static:!1,private:!1,access:{has:e=>"getTableConfig"in e,get:e=>e.getTableConfig},metadata:n},null,we),a(this,null,te,{kind:"method",name:"getTableData",static:!1,private:!1,access:{has:e=>"getTableData"in e,get:e=>e.getTableData},metadata:n},null,we),a(this,null,ae,{kind:"method",name:"styles",static:!1,private:!1,access:{has:e=>"styles"in e,get:e=>e.styles},metadata:n},null,we),a(this,null,ie,{kind:"method",name:"render",static:!1,private:!1,access:{has:e=>"render"in e,get:e=>e.render},metadata:n},null,we),a(this,null,se,{kind:"method",name:"initialize",static:!1,private:!1,access:{has:e=>"initialize"in e,get:e=>e.initialize},metadata:n},null,we),a(this,null,ne,{kind:"method",name:"handleSelectorOptionsChange",static:!1,private:!1,access:{has:e=>"handleSelectorOptionsChange"in e,get:e=>e.handleSelectorOptionsChange},metadata:n},null,we),a(this,null,le,{kind:"method",name:"handleSortableChange",static:!1,private:!1,access:{has:e=>"handleSortableChange"in e,get:e=>e.handleSortableChange},metadata:n},null,we),a(this,null,re,{kind:"method",name:"handleSelectableChange",static:!1,private:!1,access:{has:e=>"handleSelectableChange"in e,get:e=>e.handleSelectableChange},metadata:n},null,we),a(this,null,oe,{kind:"method",name:"handleColumnsChange",static:!1,private:!1,access:{has:e=>"handleColumnsChange"in e,get:e=>e.handleColumnsChange},metadata:n},null,we),a(this,null,ce,{kind:"method",name:"handleDataChange",static:!1,private:!1,access:{has:e=>"handleDataChange"in e,get:e=>e.handleDataChange},metadata:n},null,we),a(this,null,he,{kind:"method",name:"handleSelectedRowsChange",static:!1,private:!1,access:{has:e=>"handleSelectedRowsChange"in e,get:e=>e.handleSelectedRowsChange},metadata:n},null,we),a(this,null,de,{kind:"method",name:"handleSortChange",static:!1,private:!1,access:{has:e=>"handleSortChange"in e,get:e=>e.handleSortChange},metadata:n},null,we),a(this,null,ue,{kind:"method",name:"handleControlsChange",static:!1,private:!1,access:{has:e=>"handleControlsChange"in e,get:e=>e.handleControlsChange},metadata:n},null,we),a(this,null,pe,{kind:"method",name:"dispatchPageChange",static:!1,private:!1,access:{has:e=>"dispatchPageChange"in e,get:e=>e.dispatchPageChange},metadata:n},null,we),a(this,null,me,{kind:"method",name:"dispatchRowSelectionChanged",static:!1,private:!1,access:{has:e=>"dispatchRowSelectionChanged"in e,get:e=>e.dispatchRowSelectionChanged},metadata:n},null,we),a(this,null,ge,{kind:"method",name:"dispatchSelectAllChanged",static:!1,private:!1,access:{has:e=>"dispatchSelectAllChanged"in e,get:e=>e.dispatchSelectAllChanged},metadata:n},null,we),a(this,null,be,{kind:"method",name:"cleanup",static:!1,private:!1,access:{has:e=>"cleanup"in e,get:e=>e.cleanup},metadata:n},null,we),a(null,null,r,{kind:"field",name:"striped",static:!1,private:!1,access:{has:e=>"striped"in e,get:e=>e.striped,set:(e,t)=>{e.striped=t}},metadata:n},ke,xe),a(null,null,o,{kind:"field",name:"searchable",static:!1,private:!1,access:{has:e=>"searchable"in e,get:e=>e.searchable,set:(e,t)=>{e.searchable=t}},metadata:n},Se,Ce),a(null,null,c,{kind:"field",name:"filterable",static:!1,private:!1,access:{has:e=>"filterable"in e,get:e=>e.filterable,set:(e,t)=>{e.filterable=t}},metadata:n},Ee,De),a(null,null,h,{kind:"field",name:"sortable",static:!1,private:!1,access:{has:e=>"sortable"in e,get:e=>e.sortable,set:(e,t)=>{e.sortable=t}},metadata:n},$e,ze),a(null,null,k,{kind:"field",name:"selectable",static:!1,private:!1,access:{has:e=>"selectable"in e,get:e=>e.selectable,set:(e,t)=>{e.selectable=t}},metadata:n},Ae,Te),a(null,null,x,{kind:"field",name:"hoverable",static:!1,private:!1,access:{has:e=>"hoverable"in e,get:e=>e.hoverable,set:(e,t)=>{e.hoverable=t}},metadata:n},Fe,Le),a(null,null,S,{kind:"field",name:"clickable",static:!1,private:!1,access:{has:e=>"clickable"in e,get:e=>e.clickable,set:(e,t)=>{e.clickable=t}},metadata:n},Re,Me),a(null,null,C,{kind:"field",name:"list",static:!1,private:!1,access:{has:e=>"list"in e,get:e=>e.list,set:(e,t)=>{e.list=t}},metadata:n},Ie,je),a(null,null,E,{kind:"field",name:"pagination",static:!1,private:!1,access:{has:e=>"pagination"in e,get:e=>e.pagination,set:(e,t)=>{e.pagination=t}},metadata:n},Be,Oe),a(null,null,D,{kind:"field",name:"paginationMode",static:!1,private:!1,access:{has:e=>"paginationMode"in e,get:e=>e.paginationMode,set:(e,t)=>{e.paginationMode=t}},metadata:n},Pe,Ve),a(null,null,$,{kind:"field",name:"pageSize",static:!1,private:!1,access:{has:e=>"pageSize"in e,get:e=>e.pageSize,set:(e,t)=>{e.pageSize=t}},metadata:n},He,Ne),a(null,null,z,{kind:"field",name:"currentPage",static:!1,private:!1,access:{has:e=>"currentPage"in e,get:e=>e.currentPage,set:(e,t)=>{e.currentPage=t}},metadata:n},qe,_e),a(null,null,A,{kind:"field",name:"totalItems",static:!1,private:!1,access:{has:e=>"totalItems"in e,get:e=>e.totalItems,set:(e,t)=>{e.totalItems=t}},metadata:n},We,Ke),a(null,null,T,{kind:"field",name:"pageSizes",static:!1,private:!1,access:{has:e=>"pageSizes"in e,get:e=>e.pageSizes,set:(e,t)=>{e.pageSizes=t}},metadata:n},Ue,Ye),a(null,null,F,{kind:"field",name:"searchDebounce",static:!1,private:!1,access:{has:e=>"searchDebounce"in e,get:e=>e.searchDebounce,set:(e,t)=>{e.searchDebounce=t}},metadata:n},Ge,Je),a(null,null,L,{kind:"field",name:"currentSort",static:!1,private:!1,access:{has:e=>"currentSort"in e,get:e=>e.currentSort,set:(e,t)=>{e.currentSort=t}},metadata:n},Xe,Qe),a(null,null,R,{kind:"field",name:"selector",static:!1,private:!1,access:{has:e=>"selector"in e,get:e=>e.selector,set:(e,t)=>{e.selector=t}},metadata:n},Ze,et),a(null,null,M,{kind:"field",name:"selectorOptions",static:!1,private:!1,access:{has:e=>"selectorOptions"in e,get:e=>e.selectorOptions,set:(e,t)=>{e.selectorOptions=t}},metadata:n},tt,at),a(null,null,I,{kind:"field",name:"loading",static:!1,private:!1,access:{has:e=>"loading"in e,get:e=>e.loading,set:(e,t)=>{e.loading=t}},metadata:n},it,st),a(null,null,j,{kind:"field",name:"virtualize",static:!1,private:!1,access:{has:e=>"virtualize"in e,get:e=>e.virtualize,set:(e,t)=>{e.virtualize=t}},metadata:n},nt,lt),a(null,null,B,{kind:"field",name:"rowHeight",static:!1,private:!1,access:{has:e=>"rowHeight"in e,get:e=>e.rowHeight,set:(e,t)=>{e.rowHeight=t}},metadata:n},rt,ot),a(null,null,O,{kind:"field",name:"virtualBuffer",static:!1,private:!1,access:{has:e=>"virtualBuffer"in e,get:e=>e.virtualBuffer,set:(e,t)=>{e.virtualBuffer=t}},metadata:n},ct,ht),a(null,null,P,{kind:"field",name:"columnResize",static:!1,private:!1,access:{has:e=>"columnResize"in e,get:e=>e.columnResize,set:(e,t)=>{e.columnResize=t}},metadata:n},dt,ut),a(null,null,V,{kind:"field",name:"editable",static:!1,private:!1,access:{has:e=>"editable"in e,get:e=>e.editable,set:(e,t)=>{e.editable=t}},metadata:n},pt,mt),a(null,null,H,{kind:"field",name:"editMode",static:!1,private:!1,access:{has:e=>"editMode"in e,get:e=>e.editMode,set:(e,t)=>{e.editMode=t}},metadata:n},gt,bt),a(null,null,N,{kind:"field",name:"density",static:!1,private:!1,access:{has:e=>"density"in e,get:e=>e.density,set:(e,t)=>{e.density=t}},metadata:n},yt,vt),a(null,null,q,{kind:"field",name:"headerFilters",static:!1,private:!1,access:{has:e=>"headerFilters"in e,get:e=>e.headerFilters,set:(e,t)=>{e.headerFilters=t}},metadata:n},ft,wt),a(null,null,_,{kind:"field",name:"quickFilter",static:!1,private:!1,access:{has:e=>"quickFilter"in e,get:e=>e.quickFilter,set:(e,t)=>{e.quickFilter=t}},metadata:n},kt,xt),a(null,null,W,{kind:"field",name:"rowReorder",static:!1,private:!1,access:{has:e=>"rowReorder"in e,get:e=>e.rowReorder,set:(e,t)=>{e.rowReorder=t}},metadata:n},St,Ct),a(null,null,K,{kind:"field",name:"columnReorder",static:!1,private:!1,access:{has:e=>"columnReorder"in e,get:e=>e.columnReorder,set:(e,t)=>{e.columnReorder=t}},metadata:n},Et,Dt),a(null,null,U,{kind:"field",name:"columnMenu",static:!1,private:!1,access:{has:e=>"columnMenu"in e,get:e=>e.columnMenu,set:(e,t)=>{e.columnMenu=t}},metadata:n},$t,zt),a(null,null,Y,{kind:"field",name:"lazyLoad",static:!1,private:!1,access:{has:e=>"lazyLoad"in e,get:e=>e.lazyLoad,set:(e,t)=>{e.lazyLoad=t}},metadata:n},At,Tt),a(null,null,G,{kind:"field",name:"lazyLoadThreshold",static:!1,private:!1,access:{has:e=>"lazyLoadThreshold"in e,get:e=>e.lazyLoadThreshold,set:(e,t)=>{e.lazyLoadThreshold=t}},metadata:n},Ft,Lt),a(null,null,J,{kind:"field",name:"selectedRows",static:!1,private:!1,access:{has:e=>"selectedRows"in e,get:e=>e.selectedRows,set:(e,t)=>{e.selectedRows=t}},metadata:n},Rt,Mt),a(null,null,X,{kind:"field",name:"table",static:!1,private:!1,access:{has:e=>"table"in e,get:e=>e.table,set:(e,t)=>{e.table=t}},metadata:n},It,jt),a(null,null,Q,{kind:"field",name:"thead",static:!1,private:!1,access:{has:e=>"thead"in e,get:e=>e.thead,set:(e,t)=>{e.thead=t}},metadata:n},Bt,Ot),a(null,null,Z,{kind:"field",name:"tbody",static:!1,private:!1,access:{has:e=>"tbody"in e,get:e=>e.tbody,set:(e,t)=>{e.tbody=t}},metadata:n},Pt,Vt),a(null,e={value:s},ye,{kind:"class",name:s.name,metadata:n},null,ve),s=e.value,n&&Object.defineProperty(s,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:n}),i(s,ve)}setData(e){this._unsortedData=[...e],this.data=e,this.render()}setColumns(e){this.columns=e,this.render()}async*getTableConfig(){const e=await(yield{});return this.columns=e.columns||[],this.selectorOptions=e.selectorOptions||[],await new Promise(e=>requestAnimationFrame(e)),this.renderHeader(),this.renderControls(),e}async*getTableData(){this.loading=!0,this.selectedRows=[];try{const e={search:this.searchText,sort:this.currentSort,selector:this.selector};this.pagination&&(e.page=this.currentPage,e.pageSize=this.pageSize);const t=await(yield e);return this.data=t.data||[],void 0!==t.totalItems&&(this.totalItems=t.totalItems),this.loading=!1,await new Promise(e=>requestAnimationFrame(e)),this.renderBody(),t}catch(e){console.error("Error loading table data:",e),this.data=[],this.loading=!1,await new Promise(e=>requestAnimationFrame(e)),this.renderBody()}}debouncedDataRequest(){this.loading||(this.loading=!0),this.dataRequestTimeout&&clearTimeout(this.dataRequestTimeout),this.dataRequestTimeout=setTimeout(()=>{this.getTableData(),this.dataRequestTimeout=null},150)}styles(){return t.css`
      :host {
        display: block;
      }
