        ...
        <if ${!this.editable}>
          <button
            ...
            <span class="select-icons">
              <button type="button" class="select-clear" aria-label="Clear selection" style="display: none;" @click="${e=>this.handleClearClick(e)}">
            ...
            <div class="modal__header" part="header" id="${this.headerId}">
              ...
              <if ${!this.noCloseButton}>
                <button class="modal__close"
                        ...
                        @click=${this.handleCloseClick}>${t.unsafeHTML('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M6 18 18 6M6 6l12 12"/></svg>')}</button>
              </if>
            </div>
          </if>
