            ...
            <div class="modal__header" part="header" id="${this.headerId}">
              ...
              <if ${!this.noCloseButton}>
                <button class="modal__close"
                        ...
                        @click=${this.handleCloseClick}>${t.unsafeHTML(n)}</button>
              </if>
            </div>
          </if>
