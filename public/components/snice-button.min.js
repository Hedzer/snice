 ...
 */
void 0===globalThis.Snice&&console.warn("[snice] snice-runtime.min.js must be loaded before snice-button.min.js");var SniceButton=function(t,e){"use strict";function n(t,e,n,o,r,i){function a(t){if(void 0!==t&&"function"!=typeof t)throw new TypeError("Function expected");return t}for(var s,c=o.kind,l="getter"===c?"get":"setter"===c?"set":"value",d=!e&&t?o.static?t:t.prototype:null,b=e||(d?Object.getOwnPropertyDescriptor(d,o.name):{}),u=!1,h=n.length-1;h>=0;h--){var g={};for(var p in o)g[p]="access"===p?{}:o[p];for(var p in o.access)g.access[p]=o.access[p];g.addInitializer=function(t){if(u)throw new TypeError("Cannot add initializers after decoration has completed");i.push(a(t||null))};var m=(0,n[h])("accessor"===c?{get:b.get,set:b.set}:b[l],g);if("accessor"===c){if(void 0===m)continue;if(null===m||"object"!=typeof m)throw new TypeError("Object expected");(s=a(m.get))&&(b.get=s),(s=a(m.set))&&(b.set=s),(s=a(m.init))&&r.unshift(s)}else(s=a(m))&&("field"===c?r.unshift(s):b[l]=s)}d&&Object.defineProperty(d,o.name,b),u=!0}function o(t,e,n){for(var o=arguments.length>2,r=0;r<e.length;r++)n=o?e[r].call(t,n):e[r].call(t);return o?n:void 0}function r(t,n="icon"){if(!t)return e.html``;if(t.startsWith("img://")){const o=t.slice(6);return e.html`<img class="${n}" src="${o}" alt="" part="icon" />`}if(t.startsWith("text://")){const o=t.slice(7);return e.html`<span class="${n}" part="icon">${o}</span>`}return/^(https?:\/\/|\/|\.\/|\.\.\/|data:)/.test(t)||/^[^:]*\w\.(svg|png|jpe?g|jfif|pjp|gif|webp|avif|jxl|ico|cur|bmp|tiff?|heic|heif|apng)$/i.test(t)?e.html`<img class="${n}" src="${t}" alt="" part="icon" />`:e.html`<span class="${n}" part="icon">${t}</span>`}"function"==typeof SuppressedError&&SuppressedError;let i=(()=>{let t,i,a,s,c,l,d,b,u,h,g,p,m,f,v,y,w,x,k,S,$,z,j=[e.element("snice-button",{formAssociated:!0})],E=[],I=HTMLElement,P=[],Y=[],B=[],C=[],q=[],O=[],T=[],D=[],A=[],F=[],H=[],L=[],M=[],R=[],W=[],N=[],U=[],V=[],G=[],J=[],K=[],Q=[],X=[],Z=[],_=[],tt=[],et=[],nt=[],ot=[],rt=[],it=[],at=[],st=[],ct=[],lt=[];return class extends I{static{i=this}static{const r="function"==typeof Symbol&&Symbol.metadata?Object.create(I[Symbol.metadata]??null):void 0;a=[e.property({})],s=[e.property({})],c=[e.property({})],l=[e.property({type:Boolean})],d=[e.property({type:Boolean})],b=[e.property({type:Boolean})],u=[e.property({type:Boolean})],h=[e.property({type:Boolean})],g=[e.property({type:String})],p=[e.property({type:String})],m=[e.property({type:String})],f=[e.property({type:String})],v=[e.property({attribute:"icon-placement"})],y=[e.query(".button")],w=[e.query(".spinner")],x=[e.query(".label")],k=[e.query(".icon")],S=[e.on("slotchange",{target:'slot[name="icon"]'})],$=[e.render()],z=[e.styles()],n(this,null,S,{kind:"method",name:"handleIconSlotChange",static:!1,private:!1,access:{has:t=>"handleIconSlotChange"in t,get:t=>t.handleIconSlotChange},metadata:r},null,P),n(this,null,$,{kind:"method",name:"render",static:!1,private:!1,access:{has:t=>"render"in t,get:t=>t.render},metadata:r},null,P),n(this,null,z,{kind:"method",name:"styles",static:!1,private:!1,access:{has:t=>"styles"in t,get:t=>t.styles},metadata:r},null,P),n(null,null,a,{kind:"field",name:"variant",static:!1,private:!1,access:{has:t=>"variant"in t,get:t=>t.variant,set:(t,e)=>{t.variant=e}},metadata:r},Y,B),n(null,null,s,{kind:"field",name:"size",static:!1,private:!1,access:{has:t=>"size"in t,get:t=>t.size,set:(t,e)=>{t.size=e}},metadata:r},C,q),n(null,null,c,{kind:"field",name:"type",static:!1,private:!1,access:{has:t=>"type"in t,get:t=>t.type,set:(t,e)=>{t.type=e}},metadata:r},O,T),n(null,null,l,{kind:"field",name:"disabled",static:!1,private:!1,access:{has:t=>"disabled"in t,get:t=>t.disabled,set:(t,e)=>{t.disabled=e}},metadata:r},D,A),n(null,null,d,{kind:"field",name:"loading",static:!1,private:!1,access:{has:t=>"loading"in t,get:t=>t.loading,set:(t,e)=>{t.loading=e}},metadata:r},F,H),n(null,null,b,{kind:"field",name:"outline",static:!1,private:!1,access:{has:t=>"outline"in t,get:t=>t.outline,set:(t,e)=>{t.outline=e}},metadata:r},L,M),n(null,null,u,{kind:"field",name:"pill",static:!1,private:!1,access:{has:t=>"pill"in t,get:t=>t.pill,set:(t,e)=>{t.pill=e}},metadata:r},R,W),n(null,null,h,{kind:"field",name:"circle",static:!1,private:!1,access:{has:t=>"circle"in t,get:t=>t.circle,set:(t,e)=>{t.circle=e}},metadata:r},N,U),n(null,null,g,{kind:"field",name:"href",static:!1,private:!1,access:{has:t=>"href"in t,get:t=>t.href,set:(t,e)=>{t.href=e}},metadata:r},V,G),n(null,null,p,{kind:"field",name:"target",static:!1,private:!1,access:{has:t=>"target"in t,get:t=>t.target,set:(t,e)=>{t.target=e}},metadata:r},J,K),n(null,null,m,{kind:"field",name:"download",static:!1,private:!1,access:{has:t=>"download"in t,get:t=>t.download,set:(t,e)=>{t.download=e}},metadata:r},Q,X),n(null,null,f,{kind:"field",name:"icon",static:!1,private:!1,access:{has:t=>"icon"in t,get:t=>t.icon,set:(t,e)=>{t.icon=e}},metadata:r},Z,_),n(null,null,v,{kind:"field",name:"iconPlacement",static:!1,private:!1,access:{has:t=>"iconPlacement"in t,get:t=>t.iconPlacement,set:(t,e)=>{t.iconPlacement=e}},metadata:r},tt,et),n(null,null,y,{kind:"field",name:"button",static:!1,private:!1,access:{has:t=>"button"in t,get:t=>t.button,set:(t,e)=>{t.button=e}},metadata:r},nt,ot),n(null,null,w,{kind:"field",name:"spinner",static:!1,private:!1,access:{has:t=>"spinner"in t,get:t=>t.spinner,set:(t,e)=>{t.spinner=e}},metadata:r},rt,it),n(null,null,x,{kind:"field",name:"label",static:!1,private:!1,access:{has:t=>"label"in t,get:t=>t.label,set:(t,e)=>{t.label=e}},metadata:r},at,st),n(null,null,k,{kind:"field",name:"iconElement",static:!1,private:!1,access:{has:t=>"iconElement"in t,get:t=>t.iconElement,set:(t,e)=>{t.iconElement=e}},metadata:r},ct,lt),n(null,t={value:i},j,{kind:"class",name:i.name,metadata:r},null,E),i=t.value,r&&Object.defineProperty(i,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:r}),o(i,E)}constructor(){super(),this.internals=o(this,P),this.variant=o(this,Y,"default"),this.size=(o(this,B),o(this,C,"medium")),this.type=(o(this,q),o(this,O,"button")),this.disabled=(o(this,T),o(this,D,!1)),this.loading=(o(this,A),o(this,F,!1)),this.outline=(o(this,H),o(this,L,!1)),this.pill=(o(this,M),o(this,R,!1)),this.circle=(o(this,W),o(this,N,!1)),this.href=(o(this,U),o(this,V,"")),this.target=(o(this,G),o(this,J,"")),this.download=(o(this,K),o(this,Q,"")),this.icon=(o(this,X),o(this,Z,"")),this.iconPlacement=(o(this,_),o(this,tt,"start")),this.hasIconSlot=(o(this,et),!1),this.button=o(this,nt,void 0),this.spinner=(o(this,ot),o(this,rt,void 0)),this.label=(o(this,it),o(this,at,void 0)),this.iconElement=(o(this,st),o(this,ct,void 0)),o(this,lt),"function"==typeof this.attachInternals&&(this.internals=this.attachInternals())}handleIconSlotChange(){const t=this.shadowRoot?.querySelector('slot[name="icon"]');this.hasIconSlot=(t?.assignedNodes().length??0)>0}render(){const t=this.icon||this.hasIconSlot,n=t&&"start"===this.iconPlacement,o=t&&"end"===this.iconPlacement,i=["button",`button--${this.variant||"default"}`,`button--${this.size||"medium"}`,this.outline?"button--outline":"",this.pill?"button--pill":"",this.circle?"button--circle":"",this.loading?"button--loading":"",this.disabled?"button--disabled":"",t?"button--has-icon":"",t?`button--icon-${this.iconPlacement}`:""].filter(Boolean).join(" ");return e.html`
