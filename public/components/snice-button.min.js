 ...
 */
void 0===globalThis.Snice&&console.warn("[snice] snice-runtime.min.js must be loaded before snice-button.min.js");var SniceButton=function(t,e){"use strict";function n(t,e,n,o,r,i){function s(t){if(void 0!==t&&"function"!=typeof t)throw new TypeError("Function expected");return t}for(var a,c=o.kind,l="getter"===c?"get":"setter"===c?"set":"value",d=!e&&t?o.static?t:t.prototype:null,b=e||(d?Object.getOwnPropertyDescriptor(d,o.name):{}),u=!1,h=n.length-1;h>=0;h--){var g={};for(var m in o)g[m]="access"===m?{}:o[m];for(var m in o.access)g.access[m]=o.access[m];g.addInitializer=function(t){if(u)throw new TypeError("Cannot add initializers after decoration has completed");i.push(s(t||null))};var p=(0,n[h])("accessor"===c?{get:b.get,set:b.set}:b[l],g);if("accessor"===c){if(void 0===p)continue;if(null===p||"object"!=typeof p)throw new TypeError("Object expected");(a=s(p.get))&&(b.get=a),(a=s(p.set))&&(b.set=a),(a=s(p.init))&&r.unshift(a)}else(a=s(p))&&("field"===c?r.unshift(a):b[l]=a)}d&&Object.defineProperty(d,o.name,b),u=!0}function o(t,e,n){for(var o=arguments.length>2,r=0;r<e.length;r++)n=o?e[r].call(t,n):e[r].call(t);return o?n:void 0}function r(t,n="icon"){if(!t)return e.html``;if(t.startsWith("img://")){const o=t.slice(6);return e.html`<img class="${n}" src="${o}" alt="" part="icon" />`}if(t.startsWith("text://")){const o=t.slice(7);return e.html`<span class="${n}" part="icon">${o}</span>`}return/^(https?:\/\/|\/|\.\/|\.\.\/|data:)/.test(t)||/^[^:]*\w\.(svg|png|jpe?g|jfif|pjp|gif|webp|avif|jxl|ico|cur|bmp|tiff?|heic|heif|apng)(\?.*)?$/i.test(t)?e.html`<img class="${n}" src="${t}" alt="" part="icon" />`:/^[a-z][a-z0-9_]*$/.test(t)?e.html`<span class="${n} snice-icon-ligature" style="font-family:var(--snice-icon-font,'Material Symbols Outlined'),sans-serif" part="icon">${t}</span>`:e.html`<span class="${n}" part="icon">${t}</span>`}"function"==typeof SuppressedError&&SuppressedError;let i=(()=>{let t,i,s,a,c,l,d,b,u,h,g,m,p,f,v,y,x,w,k,j,z,S,$,E=[e.element("snice-button",{formAssociated:!0})],P=[],C=HTMLElement,Y=[],T=[],B=[],I=[],O=[],q=[],D=[],M=[],A=[],F=[],H=[],L=[],W=[],R=[],U=[],V=[],_=[],G=[],J=[],K=[],N=[],Q=[],X=[],Z=[],tt=[],et=[],nt=[],ot=[],rt=[],it=[],st=[],at=[],ct=[],lt=[],dt=[],bt=[],ut=[],ht=[],gt=[];return class extends C{static{i=this}static{const r="function"==typeof Symbol&&Symbol.metadata?Object.create(C[Symbol.metadata]??null):void 0;s=[e.property({})],a=[e.property({})],c=[e.property({})],l=[e.property({type:Boolean})],d=[e.property({type:Boolean})],b=[e.property({type:Boolean})],u=[e.property({type:Boolean})],h=[e.property({type:Boolean})],g=[e.property({type:String})],m=[e.property({type:String})],p=[e.property({type:String})],f=[e.property({type:String})],v=[e.property({attribute:"icon-placement"})],y=[e.property({attribute:"justify-text"})],x=[e.query('[slot="icon"]',{light:!0})],w=[e.query(".button")],k=[e.query(".spinner")],j=[e.query(".label")],z=[e.query(".icon")],S=[e.render()],$=[e.styles()],n(this,null,S,{kind:"method",name:"render",static:!1,private:!1,access:{has:t=>"render"in t,get:t=>t.render},metadata:r},null,Y),n(this,null,$,{kind:"method",name:"styles",static:!1,private:!1,access:{has:t=>"styles"in t,get:t=>t.styles},metadata:r},null,Y),n(null,null,s,{kind:"field",name:"variant",static:!1,private:!1,access:{has:t=>"variant"in t,get:t=>t.variant,set:(t,e)=>{t.variant=e}},metadata:r},T,B),n(null,null,a,{kind:"field",name:"size",static:!1,private:!1,access:{has:t=>"size"in t,get:t=>t.size,set:(t,e)=>{t.size=e}},metadata:r},I,O),n(null,null,c,{kind:"field",name:"type",static:!1,private:!1,access:{has:t=>"type"in t,get:t=>t.type,set:(t,e)=>{t.type=e}},metadata:r},q,D),n(null,null,l,{kind:"field",name:"disabled",static:!1,private:!1,access:{has:t=>"disabled"in t,get:t=>t.disabled,set:(t,e)=>{t.disabled=e}},metadata:r},M,A),n(null,null,d,{kind:"field",name:"loading",static:!1,private:!1,access:{has:t=>"loading"in t,get:t=>t.loading,set:(t,e)=>{t.loading=e}},metadata:r},F,H),n(null,null,b,{kind:"field",name:"outline",static:!1,private:!1,access:{has:t=>"outline"in t,get:t=>t.outline,set:(t,e)=>{t.outline=e}},metadata:r},L,W),n(null,null,u,{kind:"field",name:"pill",static:!1,private:!1,access:{has:t=>"pill"in t,get:t=>t.pill,set:(t,e)=>{t.pill=e}},metadata:r},R,U),n(null,null,h,{kind:"field",name:"circle",static:!1,private:!1,access:{has:t=>"circle"in t,get:t=>t.circle,set:(t,e)=>{t.circle=e}},metadata:r},V,_),n(null,null,g,{kind:"field",name:"href",static:!1,private:!1,access:{has:t=>"href"in t,get:t=>t.href,set:(t,e)=>{t.href=e}},metadata:r},G,J),n(null,null,m,{kind:"field",name:"target",static:!1,private:!1,access:{has:t=>"target"in t,get:t=>t.target,set:(t,e)=>{t.target=e}},metadata:r},K,N),n(null,null,p,{kind:"field",name:"download",static:!1,private:!1,access:{has:t=>"download"in t,get:t=>t.download,set:(t,e)=>{t.download=e}},metadata:r},Q,X),n(null,null,f,{kind:"field",name:"icon",static:!1,private:!1,access:{has:t=>"icon"in t,get:t=>t.icon,set:(t,e)=>{t.icon=e}},metadata:r},Z,tt),n(null,null,v,{kind:"field",name:"iconPlacement",static:!1,private:!1,access:{has:t=>"iconPlacement"in t,get:t=>t.iconPlacement,set:(t,e)=>{t.iconPlacement=e}},metadata:r},et,nt),n(null,null,y,{kind:"field",name:"justifyText",static:!1,private:!1,access:{has:t=>"justifyText"in t,get:t=>t.justifyText,set:(t,e)=>{t.justifyText=e}},metadata:r},ot,rt),n(null,null,x,{kind:"field",name:"iconSlotChild",static:!1,private:!1,access:{has:t=>"iconSlotChild"in t,get:t=>t.iconSlotChild,set:(t,e)=>{t.iconSlotChild=e}},metadata:r},it,st),n(null,null,w,{kind:"field",name:"button",static:!1,private:!1,access:{has:t=>"button"in t,get:t=>t.button,set:(t,e)=>{t.button=e}},metadata:r},at,ct),n(null,null,k,{kind:"field",name:"spinner",static:!1,private:!1,access:{has:t=>"spinner"in t,get:t=>t.spinner,set:(t,e)=>{t.spinner=e}},metadata:r},lt,dt),n(null,null,j,{kind:"field",name:"label",static:!1,private:!1,access:{has:t=>"label"in t,get:t=>t.label,set:(t,e)=>{t.label=e}},metadata:r},bt,ut),n(null,null,z,{kind:"field",name:"iconElement",static:!1,private:!1,access:{has:t=>"iconElement"in t,get:t=>t.iconElement,set:(t,e)=>{t.iconElement=e}},metadata:r},ht,gt),n(null,t={value:i},E,{kind:"class",name:i.name,metadata:r},null,P),i=t.value,r&&Object.defineProperty(i,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:r}),o(i,P)}constructor(){super(),this.internals=o(this,Y),this.variant=o(this,T,"default"),this.size=(o(this,B),o(this,I,"medium")),this.type=(o(this,O),o(this,q,"button")),this.disabled=(o(this,D),o(this,M,!1)),this.loading=(o(this,A),o(this,F,!1)),this.outline=(o(this,H),o(this,L,!1)),this.pill=(o(this,W),o(this,R,!1)),this.circle=(o(this,U),o(this,V,!1)),this.href=(o(this,_),o(this,G,"")),this.target=(o(this,J),o(this,K,"")),this.download=(o(this,N),o(this,Q,"")),this.icon=(o(this,X),o(this,Z,"")),this.iconPlacement=(o(this,tt),o(this,et,"start")),this.justifyText=(o(this,nt),o(this,ot,"center")),this.iconSlotChild=(o(this,rt),o(this,it,void 0)),this.button=(o(this,st),o(this,at,void 0)),this.spinner=(o(this,ct),o(this,lt,void 0)),this.label=(o(this,dt),o(this,bt,void 0)),this.iconElement=(o(this,ut),o(this,ht,void 0)),o(this,gt),"function"==typeof this.attachInternals&&(this.internals=this.attachInternals())}get hasIconSlot(){return!!this.iconSlotChild}render(){const t=this.icon||this.hasIconSlot,n=t&&"start"===this.iconPlacement,o=t&&"end"===this.iconPlacement,i=["button",`button--${this.variant||"default"}`,`button--${this.size||"medium"}`,this.outline?"button--outline":"",this.pill?"button--pill":"",this.circle?"button--circle":"",this.loading?"button--loading":"",this.disabled?"button--disabled":"",t?"button--has-icon":"",t?`button--icon-${this.iconPlacement}`:""].filter(Boolean).join(" ");return e.html`
