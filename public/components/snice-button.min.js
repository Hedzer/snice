 ...
 */
void 0===globalThis.Snice&&console.warn("[snice] snice-runtime.min.js must be loaded before snice-button.min.js");var SniceButton=function(t,e){"use strict";function n(t,e,n,o,i,r){function s(t){if(void 0!==t&&"function"!=typeof t)throw new TypeError("Function expected");return t}for(var a,l=o.kind,c="getter"===l?"get":"setter"===l?"set":"value",d=!e&&t?o.static?t:t.prototype:null,b=e||(d?Object.getOwnPropertyDescriptor(d,o.name):{}),u=!1,h=n.length-1;h>=0;h--){var g={};for(var p in o)g[p]="access"===p?{}:o[p];for(var p in o.access)g.access[p]=o.access[p];g.addInitializer=function(t){if(u)throw new TypeError("Cannot add initializers after decoration has completed");r.push(s(t||null))};var m=(0,n[h])("accessor"===l?{get:b.get,set:b.set}:b[c],g);if("accessor"===l){if(void 0===m)continue;if(null===m||"object"!=typeof m)throw new TypeError("Object expected");(a=s(m.get))&&(b.get=a),(a=s(m.set))&&(b.set=a),(a=s(m.init))&&i.unshift(a)}else(a=s(m))&&("field"===l?i.unshift(a):b[c]=a)}d&&Object.defineProperty(d,o.name,b),u=!0}function o(t,e,n){for(var o=arguments.length>2,i=0;i<e.length;i++)n=o?e[i].call(t,n):e[i].call(t);return o?n:void 0}function i(t,n="icon"){if(!t)return e.html``;if(t.startsWith("img://")){const o=t.slice(6);return e.html`<img class="${n}" src="${o}" alt="" part="icon" />`}if(t.startsWith("text://")){const o=t.slice(7);return e.html`<span class="${n}" part="icon">${o}</span>`}return/^(https?:\/\/|\/|\.\/|\.\.\/|data:)/.test(t)||/^[^:]*\w\.(svg|png|jpe?g|jfif|pjp|gif|webp|avif|jxl|ico|cur|bmp|tiff?|heic|heif|apng)(\?.*)?$/i.test(t)?e.html`<img class="${n}" src="${t}" alt="" part="icon" />`:/^[a-z][a-z0-9_]*$/.test(t)?e.html`<span class="${n} snice-icon-ligature" style="font-family:var(--snice-icon-font,'Material Symbols Outlined'),sans-serif" part="icon">${t}</span>`:e.html`<span class="${n}" part="icon">${t}</span>`}"function"==typeof SuppressedError&&SuppressedError;let r=(()=>{let t,r,s,a,l,c,d,b,u,h,g,p,m,f,v,y,w,x,k,S,$,z,j=[e.element("snice-button",{formAssociated:!0})],E=[],P=HTMLElement,C=[],Y=[],B=[],I=[],O=[],q=[],T=[],D=[],M=[],A=[],F=[],H=[],L=[],W=[],R=[],U=[],V=[],_=[],G=[],J=[],K=[],N=[],Q=[],X=[],Z=[],tt=[],et=[],nt=[],ot=[],it=[],rt=[],st=[],at=[],lt=[],ct=[],dt=[],bt=[];return class extends P{static{r=this}static{const i="function"==typeof Symbol&&Symbol.metadata?Object.create(P[Symbol.metadata]??null):void 0;s=[e.property({})],a=[e.property({})],l=[e.property({})],c=[e.property({type:Boolean})],d=[e.property({type:Boolean})],b=[e.property({type:Boolean})],u=[e.property({type:Boolean})],h=[e.property({type:Boolean})],g=[e.property({type:String})],p=[e.property({type:String})],m=[e.property({type:String})],f=[e.property({type:String})],v=[e.property({attribute:"icon-placement"})],y=[e.query('[slot="icon"]',{light:!0})],w=[e.query(".button")],x=[e.query(".spinner")],k=[e.query(".label")],S=[e.query(".icon")],$=[e.render()],z=[e.styles()],n(this,null,$,{kind:"method",name:"render",static:!1,private:!1,access:{has:t=>"render"in t,get:t=>t.render},metadata:i},null,C),n(this,null,z,{kind:"method",name:"styles",static:!1,private:!1,access:{has:t=>"styles"in t,get:t=>t.styles},metadata:i},null,C),n(null,null,s,{kind:"field",name:"variant",static:!1,private:!1,access:{has:t=>"variant"in t,get:t=>t.variant,set:(t,e)=>{t.variant=e}},metadata:i},Y,B),n(null,null,a,{kind:"field",name:"size",static:!1,private:!1,access:{has:t=>"size"in t,get:t=>t.size,set:(t,e)=>{t.size=e}},metadata:i},I,O),n(null,null,l,{kind:"field",name:"type",static:!1,private:!1,access:{has:t=>"type"in t,get:t=>t.type,set:(t,e)=>{t.type=e}},metadata:i},q,T),n(null,null,c,{kind:"field",name:"disabled",static:!1,private:!1,access:{has:t=>"disabled"in t,get:t=>t.disabled,set:(t,e)=>{t.disabled=e}},metadata:i},D,M),n(null,null,d,{kind:"field",name:"loading",static:!1,private:!1,access:{has:t=>"loading"in t,get:t=>t.loading,set:(t,e)=>{t.loading=e}},metadata:i},A,F),n(null,null,b,{kind:"field",name:"outline",static:!1,private:!1,access:{has:t=>"outline"in t,get:t=>t.outline,set:(t,e)=>{t.outline=e}},metadata:i},H,L),n(null,null,u,{kind:"field",name:"pill",static:!1,private:!1,access:{has:t=>"pill"in t,get:t=>t.pill,set:(t,e)=>{t.pill=e}},metadata:i},W,R),n(null,null,h,{kind:"field",name:"circle",static:!1,private:!1,access:{has:t=>"circle"in t,get:t=>t.circle,set:(t,e)=>{t.circle=e}},metadata:i},U,V),n(null,null,g,{kind:"field",name:"href",static:!1,private:!1,access:{has:t=>"href"in t,get:t=>t.href,set:(t,e)=>{t.href=e}},metadata:i},_,G),n(null,null,p,{kind:"field",name:"target",static:!1,private:!1,access:{has:t=>"target"in t,get:t=>t.target,set:(t,e)=>{t.target=e}},metadata:i},J,K),n(null,null,m,{kind:"field",name:"download",static:!1,private:!1,access:{has:t=>"download"in t,get:t=>t.download,set:(t,e)=>{t.download=e}},metadata:i},N,Q),n(null,null,f,{kind:"field",name:"icon",static:!1,private:!1,access:{has:t=>"icon"in t,get:t=>t.icon,set:(t,e)=>{t.icon=e}},metadata:i},X,Z),n(null,null,v,{kind:"field",name:"iconPlacement",static:!1,private:!1,access:{has:t=>"iconPlacement"in t,get:t=>t.iconPlacement,set:(t,e)=>{t.iconPlacement=e}},metadata:i},tt,et),n(null,null,y,{kind:"field",name:"iconSlotChild",static:!1,private:!1,access:{has:t=>"iconSlotChild"in t,get:t=>t.iconSlotChild,set:(t,e)=>{t.iconSlotChild=e}},metadata:i},nt,ot),n(null,null,w,{kind:"field",name:"button",static:!1,private:!1,access:{has:t=>"button"in t,get:t=>t.button,set:(t,e)=>{t.button=e}},metadata:i},it,rt),n(null,null,x,{kind:"field",name:"spinner",static:!1,private:!1,access:{has:t=>"spinner"in t,get:t=>t.spinner,set:(t,e)=>{t.spinner=e}},metadata:i},st,at),n(null,null,k,{kind:"field",name:"label",static:!1,private:!1,access:{has:t=>"label"in t,get:t=>t.label,set:(t,e)=>{t.label=e}},metadata:i},lt,ct),n(null,null,S,{kind:"field",name:"iconElement",static:!1,private:!1,access:{has:t=>"iconElement"in t,get:t=>t.iconElement,set:(t,e)=>{t.iconElement=e}},metadata:i},dt,bt),n(null,t={value:r},j,{kind:"class",name:r.name,metadata:i},null,E),r=t.value,i&&Object.defineProperty(r,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:i}),o(r,E)}constructor(){super(),this.internals=o(this,C),this.variant=o(this,Y,"default"),this.size=(o(this,B),o(this,I,"medium")),this.type=(o(this,O),o(this,q,"button")),this.disabled=(o(this,T),o(this,D,!1)),this.loading=(o(this,M),o(this,A,!1)),this.outline=(o(this,F),o(this,H,!1)),this.pill=(o(this,L),o(this,W,!1)),this.circle=(o(this,R),o(this,U,!1)),this.href=(o(this,V),o(this,_,"")),this.target=(o(this,G),o(this,J,"")),this.download=(o(this,K),o(this,N,"")),this.icon=(o(this,Q),o(this,X,"")),this.iconPlacement=(o(this,Z),o(this,tt,"start")),this.iconSlotChild=(o(this,et),o(this,nt,void 0)),this.button=(o(this,ot),o(this,it,void 0)),this.spinner=(o(this,rt),o(this,st,void 0)),this.label=(o(this,at),o(this,lt,void 0)),this.iconElement=(o(this,ct),o(this,dt,void 0)),o(this,bt),"function"==typeof this.attachInternals&&(this.internals=this.attachInternals())}get hasIconSlot(){return!!this.iconSlotChild}render(){const t=this.icon||this.hasIconSlot,n=t&&"start"===this.iconPlacement,o=t&&"end"===this.iconPlacement,r=["button",`button--${this.variant||"default"}`,`button--${this.size||"medium"}`,this.outline?"button--outline":"",this.pill?"button--pill":"",this.circle?"button--circle":"",this.loading?"button--loading":"",this.disabled?"button--disabled":"",t?"button--has-icon":"",t?`button--icon-${this.iconPlacement}`:""].filter(Boolean).join(" ");return e.html`
      <button class="${r}" type="${this.type}" ?disabled="${this.disabled}" part="base" @click="${t=>this.handleInternalClick(t)}">
