 ...
 */
void 0===globalThis.Snice&&console.warn("[snice] snice-runtime.min.js must be loaded before snice-chat.min.js");var SniceChat=function(e,t){"use strict";function i(e,t,i,a,s,r){function n(e){if(void 0!==e&&"function"!=typeof e)throw new TypeError("Function expected");return e}for(var o,c=a.kind,l="getter"===c?"get":"setter"===c?"set":"value",d=!t&&e?a.static?e:e.prototype:null,m=t||(d?Object.getOwnPropertyDescriptor(d,a.name):{}),h=!1,p=i.length-1;p>=0;p--){var g={};for(var u in a)g[u]="access"===u?{}:a[u];for(var u in a.access)g.access[u]=a.access[u];g.addInitializer=function(e){if(h)throw new TypeError("Cannot add initializers after decoration has completed");r.push(n(e||null))};var v=(0,i[p])("accessor"===c?{get:m.get,set:m.set}:m[l],g);if("accessor"===c){if(void 0===v)continue;if(null===v||"object"!=typeof v)throw new TypeError("Object expected");(o=n(v.get))&&(m.get=o),(o=n(v.set))&&(m.set=o),(o=n(v.init))&&s.unshift(o)}else(o=n(v))&&("field"===c?s.unshift(o):m[l]=o)}d&&Object.defineProperty(d,a.name,m),h=!0}function a(e,t,i){for(var a=arguments.length>2,s=0;s<t.length;s++)i=a?t[s].call(e,i):t[s].call(e);return a?i:void 0}var s,r;"function"==typeof SuppressedError&&SuppressedError,function(e){e.Text="text",e.Markdown="markdown"}(s||(s={})),function(e){e.Default="default",e.Bubbles="bubbles"}(r||(r={})),(()=>{let e,r,n,o,c,l,d,m,h,p=[t.element("snice-chat-message")],g=[],u=HTMLElement,v=[],b=[],f=[],y=[],x=[],k=[],w=[],$=[],z=[],S=[],C=[],_=[],M=[];(class extends u{static{r=this}static{const s="function"==typeof Symbol&&Symbol.metadata?Object.create(u[Symbol.metadata]??null):void 0;n=[t.property()],o=[t.property()],c=[t.property()],l=[t.property()],d=[t.property({type:Boolean})],m=[t.property({attribute:"author-color"})],h=[t.render()],i(this,null,h,{kind:"method",name:"render",static:!1,private:!1,access:{has:e=>"render"in e,get:e=>e.render},metadata:s},null,v),i(null,null,n,{kind:"field",name:"author",static:!1,private:!1,access:{has:e=>"author"in e,get:e=>e.author,set:(e,t)=>{e.author=t}},metadata:s},b,f),i(null,null,o,{kind:"field",name:"avatar",static:!1,private:!1,access:{has:e=>"avatar"in e,get:e=>e.avatar,set:(e,t)=>{e.avatar=t}},metadata:s},y,x),i(null,null,c,{kind:"field",name:"type",static:!1,private:!1,access:{has:e=>"type"in e,get:e=>e.type,set:(e,t)=>{e.type=t}},metadata:s},k,w),i(null,null,l,{kind:"field",name:"format",static:!1,private:!1,access:{has:e=>"format"in e,get:e=>e.format,set:(e,t)=>{e.format=t}},metadata:s},$,z),i(null,null,d,{kind:"field",name:"edited",static:!1,private:!1,access:{has:e=>"edited"in e,get:e=>e.edited,set:(e,t)=>{e.edited=t}},metadata:s},S,C),i(null,null,m,{kind:"field",name:"authorColor",static:!1,private:!1,access:{has:e=>"authorColor"in e,get:e=>e.authorColor,set:(e,t)=>{e.authorColor=t}},metadata:s},_,M),i(null,e={value:r},p,{kind:"class",name:r.name,metadata:s},null,g),r=e.value,s&&Object.defineProperty(r,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:s}),a(r,g)}render(){return t.html`<slot></slot>`}getMessageDefinition(){const e=this.getAttribute("timestamp"),t={id:"",type:this.type,content:(this.textContent??"").trim(),author:this.author,timestamp:e?new Date(e):new Date,format:this.format,edited:this.edited};return this.avatar&&(t.avatar=this.avatar),this.authorColor&&(t.authorColor=this.authorColor),t}constructor(){super(...arguments),this.author=(a(this,v),a(this,b,"")),this.avatar=(a(this,f),a(this,y,"")),this.type=(a(this,x),a(this,k,"text")),this.format=(a(this,w),a(this,$,s.Text)),this.edited=(a(this,z),a(this,S,!1)),this.authorColor=(a(this,C),a(this,_,"")),a(this,M)}})})();(()=>{let e,s,r,n,o,c,l,d,m,h,p,g=[t.element("snice-empty-state")],u=[],v=HTMLElement,b=[],f=[],y=[],x=[],k=[],w=[],$=[],z=[],S=[],C=[],_=[],M=[],T=[];(class extends v{static{s=this}static{const A="function"==typeof Symbol&&Symbol.metadata?Object.create(v[Symbol.metadata]??null):void 0;r=[t.property({})],n=[t.property({})],o=[t.property({})],c=[t.property({})],l=[t.property({attribute:"action-text"})],d=[t.property({attribute:"action-href"})],m=[t.render()],h=[t.styles()],p=[t.dispatch("empty-state-action",{bubbles:!0,composed:!0})],i(this,null,m,{kind:"method",name:"render",static:!1,private:!1,access:{has:e=>"render"in e,get:e=>e.render},metadata:A},null,b),i(this,null,h,{kind:"method",name:"styles",static:!1,private:!1,access:{has:e=>"styles"in e,get:e=>e.styles},metadata:A},null,b),i(this,null,p,{kind:"method",name:"dispatchActionEvent",static:!1,private:!1,access:{has:e=>"dispatchActionEvent"in e,get:e=>e.dispatchActionEvent},metadata:A},null,b),i(null,null,r,{kind:"field",name:"size",static:!1,private:!1,access:{has:e=>"size"in e,get:e=>e.size,set:(e,t)=>{e.size=t}},metadata:A},f,y),i(null,null,n,{kind:"field",name:"icon",static:!1,private:!1,access:{has:e=>"icon"in e,get:e=>e.icon,set:(e,t)=>{e.icon=t}},metadata:A},x,k),i(null,null,o,{kind:"field",name:"title",static:!1,private:!1,access:{has:e=>"title"in e,get:e=>e.title,set:(e,t)=>{e.title=t}},metadata:A},w,$),i(null,null,c,{kind:"field",name:"description",static:!1,private:!1,access:{has:e=>"description"in e,get:e=>e.description,set:(e,t)=>{e.description=t}},metadata:A},z,S),i(null,null,l,{kind:"field",name:"actionText",static:!1,private:!1,access:{has:e=>"actionText"in e,get:e=>e.actionText,set:(e,t)=>{e.actionText=t}},metadata:A},C,_),i(null,null,d,{kind:"field",name:"actionHref",static:!1,private:!1,access:{has:e=>"actionHref"in e,get:e=>e.actionHref,set:(e,t)=>{e.actionHref=t}},metadata:A},M,T),i(null,e={value:s},g,{kind:"class",name:s.name,metadata:A},null,u),s=e.value,A&&Object.defineProperty(s,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:A}),a(s,u)}render(){const e=["empty-state",`empty-state--${this.size}`].filter(Boolean).join(" ");return t.html`
    ...
    `}resolveAuthorColor(e){return e.authorColor?e.authorColor:this.authorColors[e.author]?this.authorColors[e.author]:this.colorAuthors?function(e){let t=0;for(let i=0;i<e.length;i++)t=31*t+e.charCodeAt(i)>>>0;const i=t%8+1;return`var(--snice-color-accent-${i}, ${m[i-1]})`}(e.author):""}shouldRenderMarkdown(e){return e.format===s.Markdown||!(!this.markdown||e.format===s.Text)}renderMessageBody(e){return this.shouldRenderMarkdown(e)?t.html`<snice-markdown part="message-text" class="message-text" .content=${e.content}></snice-markdown>`:t.html`<div part="message-text" class="message-text">${e.content}</div>`}renderMessage(e){const i="system"===e.type,a=e.author===this.currentUser;if(i)return t.html`
      ...
      `;const s=a?"own":"other",r=a?"message-own":"message-other",n=this.resolveAuthorColor(e),o=n?`--snice-chat-author-color:${n}`:"",c=this.editingId===e.id,l=this.confirmingDeleteId===e.id,d=!!e.reactions&&e.reactions.length>0;return t.html`
      <div part="message ${r}" class="message ${s}" data-message-id="${e.id}">
    ...
    `}},n})();return e.SniceChat=h,e}({},Snice);
