 ...
 */
void 0===globalThis.Snice&&console.warn("[snice] snice-runtime.min.js must be loaded before snice-chat.min.js");var SniceChat=function(e,t){"use strict";function i(e,t,i,a,s,n){function r(e){if(void 0!==e&&"function"!=typeof e)throw new TypeError("Function expected");return e}for(var o,c=a.kind,l="getter"===c?"get":"setter"===c?"set":"value",d=!t&&e?a.static?e:e.prototype:null,m=t||(d?Object.getOwnPropertyDescriptor(d,a.name):{}),h=!1,p=i.length-1;p>=0;p--){var g={};for(var u in a)g[u]="access"===u?{}:a[u];for(var u in a.access)g.access[u]=a.access[u];g.addInitializer=function(e){if(h)throw new TypeError("Cannot add initializers after decoration has completed");n.push(r(e||null))};var v=(0,i[p])("accessor"===c?{get:m.get,set:m.set}:m[l],g);if("accessor"===c){if(void 0===v)continue;if(null===v||"object"!=typeof v)throw new TypeError("Object expected");(o=r(v.get))&&(m.get=o),(o=r(v.set))&&(m.set=o),(o=r(v.init))&&s.unshift(o)}else(o=r(v))&&("field"===c?s.unshift(o):m[l]=o)}d&&Object.defineProperty(d,a.name,m),h=!0}function a(e,t,i){for(var a=arguments.length>2,s=0;s<t.length;s++)i=a?t[s].call(e,i):t[s].call(e);return a?i:void 0}"function"==typeof SuppressedError&&SuppressedError;const s=["hsl(214 55% 48%)","hsl(27 62% 50%)","hsl(160 40% 40%)","hsl(275 32% 52%)","hsl(42 62% 48%)","hsl(340 42% 55%)","hsl(110 32% 42%)","hsl(195 45% 46%)"];(()=>{let e,s,n,r,o,c,l,d,m,h,p,g=[t.element("snice-empty-state")],u=[],v=HTMLElement,b=[],f=[],y=[],x=[],k=[],w=[],$=[],z=[],S=[],C=[],M=[],_=[],T=[];(class extends v{static{s=this}static{const A="function"==typeof Symbol&&Symbol.metadata?Object.create(v[Symbol.metadata]??null):void 0;n=[t.property({})],r=[t.property({})],o=[t.property({})],c=[t.property({})],l=[t.property({attribute:"action-text"})],d=[t.property({attribute:"action-href"})],m=[t.render()],h=[t.styles()],p=[t.dispatch("empty-state-action",{bubbles:!0,composed:!0})],i(this,null,m,{kind:"method",name:"render",static:!1,private:!1,access:{has:e=>"render"in e,get:e=>e.render},metadata:A},null,b),i(this,null,h,{kind:"method",name:"styles",static:!1,private:!1,access:{has:e=>"styles"in e,get:e=>e.styles},metadata:A},null,b),i(this,null,p,{kind:"method",name:"dispatchActionEvent",static:!1,private:!1,access:{has:e=>"dispatchActionEvent"in e,get:e=>e.dispatchActionEvent},metadata:A},null,b),i(null,null,n,{kind:"field",name:"size",static:!1,private:!1,access:{has:e=>"size"in e,get:e=>e.size,set:(e,t)=>{e.size=t}},metadata:A},f,y),i(null,null,r,{kind:"field",name:"icon",static:!1,private:!1,access:{has:e=>"icon"in e,get:e=>e.icon,set:(e,t)=>{e.icon=t}},metadata:A},x,k),i(null,null,o,{kind:"field",name:"title",static:!1,private:!1,access:{has:e=>"title"in e,get:e=>e.title,set:(e,t)=>{e.title=t}},metadata:A},w,$),i(null,null,c,{kind:"field",name:"description",static:!1,private:!1,access:{has:e=>"description"in e,get:e=>e.description,set:(e,t)=>{e.description=t}},metadata:A},z,S),i(null,null,l,{kind:"field",name:"actionText",static:!1,private:!1,access:{has:e=>"actionText"in e,get:e=>e.actionText,set:(e,t)=>{e.actionText=t}},metadata:A},C,M),i(null,null,d,{kind:"field",name:"actionHref",static:!1,private:!1,access:{has:e=>"actionHref"in e,get:e=>e.actionHref,set:(e,t)=>{e.actionHref=t}},metadata:A},_,T),i(null,e={value:s},g,{kind:"class",name:s.name,metadata:A},null,u),s=e.value,A&&Object.defineProperty(s,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:A}),a(s,u)}render(){const e=["empty-state",`empty-state--${this.size}`].filter(Boolean).join(" ");return t.html`
      <div class="${e}" part="container">
        <div class="empty-state__icon-wrapper" part="icon">
          <slot name="icon">
            ${function(e,i="icon"){if(!e)return t.html``;if(e.startsWith("img://")){const a=e.slice(6);return t.html`<img class="${i}" src="${a}" alt="" part="icon" />`}if(e.startsWith("text://")){const a=e.slice(7);return t.html`<span class="${i}" part="icon">${a}</span>`}return/^(https?:\/\/|\/|\.\/|\.\.\/|data:)/.test(e)||/^[^:]*\w\.(svg|png|jpe?g|jfif|pjp|gif|webp|avif|jxl|ico|cur|bmp|tiff?|heic|heif|apng)(\?.*)?$/i.test(e)?t.html`<img class="${i}" src="${e}" alt="" part="icon" />`:/^[a-z][a-z0-9_]*$/.test(e)?t.html`<span class="${i} snice-icon-ligature" style="font-family:var(--snice-icon-font,'Material Symbols Outlined'),sans-serif" part="icon">${e}</span>`:t.html`<span class="${i}" part="icon">${e}</span>`}(this.icon,"empty-state__icon")}
          </slot>
        </div>
    ...
    `}resolveAuthorColor(e){if(e.authorColor&&h(e.authorColor))return e.authorColor;const t=this.authorColors[e.author];return t&&h(t)?t:this.colorAuthors?function(e){let t=0;for(let i=0;i<e.length;i++)t=31*t+e.charCodeAt(i)>>>0;const i=t%8+1;return`var(--snice-color-accent-${i}, ${s[i-1]})`}(e.author):""}shouldRenderMarkdown(e){return e.format===l.Markdown||!(!this.markdown||e.format===l.Text)}renderMessageBody(e){return this.shouldRenderMarkdown(e)?t.html`<snice-markdown part="message-text" class="message-text" .content=${e.content}></snice-markdown>`:t.html`<div part="message-text" class="message-text">${e.content}</div>`}renderMessage(e){const i="system"===e.type,a=e.author===this.currentUser;if(i)return t.html`
        <div part="message system-message" class="message system" data-message-id="${e.id}">
          <div class="message-content">
            <div part="message-text" class="message-text">${e.content}</div>
          </div>
        </div>
      `;const s=a?"own":"other",n=a?"message-own":"message-other",r=this.resolveAuthorColor(e),o=r?`--snice-chat-author-color:${r}`:"",c=this.editingId===e.id,l=this.confirmingDeleteId===e.id,d=!!e.reactions&&e.reactions.length>0;return t.html`
      <div part="message ${n}" class="message ${s}" data-message-id="${e.id}">
        ${this.showAvatars?t.html`
              <div part="avatar" class="message-avatar">
                ${e.avatar?t.html`<img src="${e.avatar}" alt="${e.author}" />`:(m=e.author,m.split(" ").map(e=>e[0]).join("").toUpperCase().substring(0,2))}
              </div>
            `:""}
        <div class="message-content">
          <div class="message-header">
            <span part="author" class="message-author" style="${o}">${e.author}</span>
            ${this.showTimestamps?t.html`<span part="timestamp" class="message-timestamp">${function(e){const t="string"==typeof e?new Date(e):e;return`${t.getHours().toString().padStart(2,"0")}:${t.getMinutes().toString().padStart(2,"0")}`}(e.timestamp)}</span>`:""}
            ${e.edited?t.html`<span part="edited" class="message-edited">(edited)</span>`:""}
          </div>
          ${c?this.renderEditor(e):e.content?this.renderMessageBody(e):""}
          ${e.attachment?this.renderAttachment(e.attachment):""}
          ${d?this.renderReactions(e.id,e.reactions):""}
          ${l?this.renderDeleteConfirm(e):""}
        </div>
        ${c||l?"":this.renderActions(e.id,a)}
      </div>
    `;var m}renderEditor(e){return t.html`
      <div class="message-edit">
        <textarea
          part="edit-input"
          class="edit-field"
          .value=${e.content}
          @keydown=${t=>this.handleEditKeydown(t,e.id)}
        ></textarea>
        <div class="edit-actions">
          <button part="edit-save" class="edit-button edit-save" @click=${()=>this.commitEdit(e.id)}>Save</button>
          <button part="edit-cancel" class="edit-button" @click=${()=>this.cancelEdit()}>Cancel</button>
        </div>
      </div>
    `}renderDeleteConfirm(e){return t.html`
      <div part="delete-confirm" class="message-confirm">
        <span class="confirm-text">Delete this message?</span>
        <div class="confirm-actions">
          <button part="delete-confirm-yes" class="confirm-button confirm-delete" @click=${()=>this.confirmDelete(e.id)}>Delete</button>
          <button part="delete-confirm-no" class="confirm-button" @click=${()=>this.cancelDelete()}>Cancel</button>
        </div>
      </div>
    `}renderActions(e,i){return t.html`
      <div part="actions" class="message-actions">
        <button class="action-button" @click=${()=>this.handleReaction(e,"👍")} title="React" aria-label="React">
          <span class="action-emoji" aria-hidden="true">🙂</span>
        </button>
        ${i?t.html`
              <button class="action-button" @click=${()=>this.startEdit(e)} title="Edit" aria-label="Edit message">
                ${t.unsafeHTML('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125"/></svg>')}
              </button>
              <button class="action-button" @click=${()=>this.handleDelete(e)} title="Delete" aria-label="Delete message">
    ...
    `}renderAttachment(e){return e?"image"===e.type?t.html`
      ...
      <div part="attachment" class="message-attachment">
        <div class="attachment-file">
          ...
          <div class="attachment-info">
            ...
            ${e.size?t.html`<div class="attachment-size">${i=e.size,i<1024?`${i} B`:i<1048576?`${(i/1024).toFixed(1)} KB`:`${(i/1048576).toFixed(1)} MB`}</div>`:""}
          </div>
        </div>
      </div>
    `:"";var i}renderReactions(e,i){return i&&0!==i.length?t.html`
      <div part="reactions" class="message-reactions">
        ${i.map(i=>{const a=i.users.includes(this.currentUser);return t.html`
            <div
              part="reaction ${a?"reaction-active":""}"
              class="reaction ${a?"active":""}"
              @click="${()=>this.handleReaction(e,i.emoji)}"
            >
              <span class="reaction-emoji">${i.emoji}</span>
              <span class="reaction-count">${i.count}</span>
            </div>
          `})}
      </div>
    `:""}renderTypingIndicators(){const e=Array.from(this.typingIndicators.values());return 0===e.length?"":t.html`
      <div class="typing-indicators">
        <div part="typing-indicator" class="typing-indicator">
          <span>${e.map(e=>e.user).join(", ")} ${1===e.length?"is":"are"} typing</span>
        ...
        <div part="input-container" class="input-container">
          ...
          <div class="input-buttons">
            ...
            <button class="input-button send" @click="${()=>this.sendMessage()}" title="Send">
              ${t.unsafeHTML('<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M3.478 2.404a.75.75 0 0 0-.926.941l2.432 7.905H13.5a.75.75 0 0 1 0 1.5H4.984l-2.432 7.905a.75.75 0 0 0 .926.94 60.519 60.519 0 0 0 18.445-8.986.75.75 0 0 0 0-1.218A60.517 60.517 0 0 0 3.478 2.404Z"/></svg>')}
            </button>
          </div>
        </div>
      </div>
    `}},n})();return e.SniceChat=p,e}({},Snice);
