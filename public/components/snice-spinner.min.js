 ...
 */
void 0===globalThis.Snice&&console.warn("[snice] snice-runtime.min.js must be loaded before snice-spinner.min.js");var SniceSpinner=function(e,s){"use strict";function r(e,s,r,t,n,i){function a(e){if(void 0!==e&&"function"!=typeof e)throw new TypeError("Function expected");return e}for(var o,l=t.kind,c="getter"===l?"get":"setter"===l?"set":"value",p=!s&&e?t.static?e:e.prototype:null,h=s||(p?Object.getOwnPropertyDescriptor(p,t.name):{}),d=!1,m=r.length-1;m>=0;m--){var f={};for(var u in t)f[u]="access"===u?{}:t[u];for(var u in t.access)f.access[u]=t.access[u];f.addInitializer=function(e){if(d)throw new TypeError("Cannot add initializers after decoration has completed");i.push(a(e||null))};var g=(0,r[m])("accessor"===l?{get:h.get,set:h.set}:h[c],f);if("accessor"===l){if(void 0===g)continue;if(null===g||"object"!=typeof g)throw new TypeError("Object expected");(o=a(g.get))&&(h.get=o),(o=a(g.set))&&(h.set=o),(o=a(g.init))&&n.unshift(o)}else(o=a(g))&&("field"===l?n.unshift(o):h[c]=o)}p&&Object.defineProperty(p,t.name,h),d=!0}function t(e,s,r){for(var t=arguments.length>2,n=0;n<s.length;n++)r=t?s[n].call(e,r):s[n].call(e);return t?r:void 0}"function"==typeof SuppressedError&&SuppressedError;let n=(()=>{let e,n,i,a,o,l,c,p,h=[s.element("snice-spinner")],d=[],m=HTMLElement,f=[],u=[],g=[],b=[],v=[],y=[],k=[],z=[],_=[];return class extends m{static{n=this}static{const w="function"==typeof Symbol&&Symbol.metadata?Object.create(m[Symbol.metadata]??null):void 0;i=[s.property({})],a=[s.property({})],o=[s.property({})],l=[s.property({type:Number})],c=[s.render()],p=[s.styles()],r(this,null,c,{kind:"method",name:"render",static:!1,private:!1,access:{has:e=>"render"in e,get:e=>e.render},metadata:w},null,f),r(this,null,p,{kind:"method",name:"styles",static:!1,private:!1,access:{has:e=>"styles"in e,get:e=>e.styles},metadata:w},null,f),r(null,null,i,{kind:"field",name:"size",static:!1,private:!1,access:{has:e=>"size"in e,get:e=>e.size,set:(e,s)=>{e.size=s}},metadata:w},u,g),r(null,null,a,{kind:"field",name:"color",static:!1,private:!1,access:{has:e=>"color"in e,get:e=>e.color,set:(e,s)=>{e.color=s}},metadata:w},b,v),r(null,null,o,{kind:"field",name:"label",static:!1,private:!1,access:{has:e=>"label"in e,get:e=>e.label,set:(e,s)=>{e.label=s}},metadata:w},y,k),r(null,null,l,{kind:"field",name:"thickness",static:!1,private:!1,access:{has:e=>"thickness"in e,get:e=>e.thickness,set:(e,s)=>{e.thickness=s}},metadata:w},z,_),r(null,e={value:n},h,{kind:"class",name:n.name,metadata:w},null,d),n=e.value,w&&Object.defineProperty(n,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:w}),t(n,d)}render(){const e=this.getSizeValue(),r=(e-2*this.thickness)/2,t=2*r*Math.PI,n=e/2,i=e/2,a=`0 0 ${e} ${e}`;return s.html`
