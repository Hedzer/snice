                    ...
                    <if ${r}>
                      <div class="month">
                        <div class="calendar-header">
                          ...
                          <div class="calendar-title">
                            <span class="month-label">${this.monthNames[s.getMonth()]} </span><button class="year-button" type="button" data-nav="show-years">${s.getFullYear()}</button>
                          </div>
                        ...
                        <div class="calendar-weekdays">${this.getDayHeaders()}</div>
                        <div class="calendar-days">${this.getDaysGrid(s.getFullYear(),s.getMonth())}</div>
                      </div>
                    </if>
                  </default>
                </case>
