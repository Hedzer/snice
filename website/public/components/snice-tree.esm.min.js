 ...
 */
import{element as e,property as t,query as i,on as s,render as n,watch as a,styles as o,html as d,css as c,dispatch as l,ready as h,queryAll as r}from"snice";function p(e,t,i,s,n,a){function o(e){if(void 0!==e&&"function"!=typeof e)throw new TypeError("Function expected");return e}for(var d,c=s.kind,l="getter"===c?"get":"setter"===c?"set":"value",h=!t&&e?s.static?e:e.prototype:null,r=t||(h?Object.getOwnPropertyDescriptor(h,s.name):{}),p=!1,m=i.length-1;m>=0;m--){var u={};for(var b in s)u[b]="access"===b?{}:s[b];for(var b in s.access)u.access[b]=s.access[b];u.addInitializer=function(e){if(p)throw new TypeError("Cannot add initializers after decoration has completed");a.push(o(e||null))};var g=(0,i[m])("accessor"===c?{get:r.get,set:r.set}:r[l],u);if("accessor"===c){if(void 0===g)continue;if(null===g||"object"!=typeof g)throw new TypeError("Object expected");(d=o(g.get))&&(r.get=d),(d=o(g.set))&&(r.set=d),(d=o(g.init))&&n.unshift(d)}else(d=o(g))&&("field"===c?n.unshift(d):r[l]=d)}h&&Object.defineProperty(h,s.name,r),p=!0}function m(e,t,i){for(var s=arguments.length>2,n=0;n<t.length;n++)i=s?t[n].call(e,i):t[n].call(e);return s?i:void 0}"function"==typeof SuppressedError&&SuppressedError;(()=>{let l,h,r,u,b,g,k,v,x,f,y,w,_,C,S,E,N,I,z,L,A,R=[e("snice-checkbox")],M=[],q=HTMLElement,T=[],$=[],O=[],F=[],B=[],j=[],D=[],H=[],P=[],K=[],U=[],V=[],X=[],G=[],J=[],Q=[],W=[],Y=[],Z=[],ee=[],te=[],ie=[],se=[],ne=[],ae=[],oe=[],de=[],ce=[],le=[];(class extends q{static{h=this}static{const e="function"==typeof Symbol&&Symbol.metadata?Object.create(q[Symbol.metadata]??null):void 0;r=[t({type:Boolean})],u=[t({type:Boolean})],b=[t({type:Boolean})],g=[t({type:Boolean})],k=[t({type:Boolean})],v=[t({type:Boolean})],x=[t({})],f=[t({})],y=[t({})],w=[t({})],_=[i(".checkbox-input")],C=[i(".checkbox")],S=[i(".checkbox-label")],E=[i(".checkbox-wrapper")],N=[s("click")],I=[n()],z=[a("checked")],L=[a("indeterminate")],A=[o()],p(this,null,N,{kind:"method",name:"handleCheckboxClick",static:!1,private:!1,access:{has:e=>"handleCheckboxClick"in e,get:e=>e.handleCheckboxClick},metadata:e},null,T),p(this,null,I,{kind:"method",name:"render",static:!1,private:!1,access:{has:e=>"render"in e,get:e=>e.render},metadata:e},null,T),p(this,null,z,{kind:"method",name:"handleCheckedChange",static:!1,private:!1,access:{has:e=>"handleCheckedChange"in e,get:e=>e.handleCheckedChange},metadata:e},null,T),p(this,null,L,{kind:"method",name:"handleIndeterminateChange",static:!1,private:!1,access:{has:e=>"handleIndeterminateChange"in e,get:e=>e.handleIndeterminateChange},metadata:e},null,T),p(this,null,A,{kind:"method",name:"styles",static:!1,private:!1,access:{has:e=>"styles"in e,get:e=>e.styles},metadata:e},null,T),p(null,null,r,{kind:"field",name:"checked",static:!1,private:!1,access:{has:e=>"checked"in e,get:e=>e.checked,set:(e,t)=>{e.checked=t}},metadata:e},$,O),p(null,null,u,{kind:"field",name:"indeterminate",static:!1,private:!1,access:{has:e=>"indeterminate"in e,get:e=>e.indeterminate,set:(e,t)=>{e.indeterminate=t}},metadata:e},F,B),p(null,null,b,{kind:"field",name:"disabled",static:!1,private:!1,access:{has:e=>"disabled"in e,get:e=>e.disabled,set:(e,t)=>{e.disabled=t}},metadata:e},j,D),p(null,null,g,{kind:"field",name:"loading",static:!1,private:!1,access:{has:e=>"loading"in e,get:e=>e.loading,set:(e,t)=>{e.loading=t}},metadata:e},H,P),p(null,null,k,{kind:"field",name:"required",static:!1,private:!1,access:{has:e=>"required"in e,get:e=>e.required,set:(e,t)=>{e.required=t}},metadata:e},K,U),p(null,null,v,{kind:"field",name:"invalid",static:!1,private:!1,access:{has:e=>"invalid"in e,get:e=>e.invalid,set:(e,t)=>{e.invalid=t}},metadata:e},V,X),p(null,null,x,{kind:"field",name:"size",static:!1,private:!1,access:{has:e=>"size"in e,get:e=>e.size,set:(e,t)=>{e.size=t}},metadata:e},G,J),p(null,null,f,{kind:"field",name:"name",static:!1,private:!1,access:{has:e=>"name"in e,get:e=>e.name,set:(e,t)=>{e.name=t}},metadata:e},Q,W),p(null,null,y,{kind:"field",name:"value",static:!1,private:!1,access:{has:e=>"value"in e,get:e=>e.value,set:(e,t)=>{e.value=t}},metadata:e},Y,Z),p(null,null,w,{kind:"field",name:"label",static:!1,private:!1,access:{has:e=>"label"in e,get:e=>e.label,set:(e,t)=>{e.label=t}},metadata:e},ee,te),p(null,null,_,{kind:"field",name:"input",static:!1,private:!1,access:{has:e=>"input"in e,get:e=>e.input,set:(e,t)=>{e.input=t}},metadata:e},ie,se),p(null,null,C,{kind:"field",name:"checkbox",static:!1,private:!1,access:{has:e=>"checkbox"in e,get:e=>e.checkbox,set:(e,t)=>{e.checkbox=t}},metadata:e},ne,ae),p(null,null,S,{kind:"field",name:"labelElement",static:!1,private:!1,access:{has:e=>"labelElement"in e,get:e=>e.labelElement,set:(e,t)=>{e.labelElement=t}},metadata:e},oe,de),p(null,null,E,{kind:"field",name:"wrapper",static:!1,private:!1,access:{has:e=>"wrapper"in e,get:e=>e.wrapper,set:(e,t)=>{e.wrapper=t}},metadata:e},ce,le),p(null,l={value:h},R,{kind:"class",name:h.name,metadata:e},null,M),h=l.value,e&&Object.defineProperty(h,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:e}),m(h,M)}handleCheckboxClick(){this.disabled||this.loading||this.toggle()}render(){const e=`checkbox-wrapper${this.disabled?" checkbox-wrapper--disabled":""}${this.loading?" checkbox-wrapper--loading":""}`,t=`checkbox checkbox--${this.size}${this.invalid?" checkbox--invalid":""}${this.indeterminate?" checkbox--indeterminate":""}${this.loading?" checkbox--loading":""}`,i=`checkbox-label checkbox-label--${this.size}${this.required?" checkbox-label--required":""}`;return d`
    ...
    `}handleInternalChange(e){const t=e.target;"checkbox"===t.type&&(this.checked=t.checked,this.indeterminate=!1,this.dispatchEvent(new CustomEvent("checkbox-change",{bubbles:!0,composed:!0,detail:{checked:this.checked,indeterminate:this.indeterminate,checkbox:this}})))}handleCheckedChange(){this.input&&(this.input.checked=this.checked)}handleIndeterminateChange(){this.input&&(this.input.indeterminate=this.indeterminate)}styles(){return c`${":host{display:inline-block;font-family:var(--snice-font-family)}.checkbox-wrapper{display:inline-flex;align-items:center;position:relative;cursor:pointer;user-select:none;min-height:1.25rem}.checkbox-wrapper--disabled{cursor:not-allowed;opacity:.6}.checkbox-input{position:absolute;opacity:0;left:0;top:0;width:100%;height:100%;margin:0;cursor:pointer;z-index:1;pointer-events:all}.checkbox{position:relative;display:inline-flex;align-items:center;justify-content:center;background:var(--snice-color-surface-container-lowest);border:2px solid var(--snice-color-border);border-radius:var(--snice-border-radius-sm);transition:all var(--snice-transition-fast) ease}.checkbox--small{width:1rem;height:1rem}.checkbox--medium{width:1.25rem;height:1.25rem}.checkbox--large{width:1.5rem;height:1.5rem}.checkbox-input:checked~.checkbox{background:var(--snice-color-primary);border-color:var(--snice-color-primary)}.checkbox-input:focus-visible~.checkbox{box-shadow:0 0 0 3px var(--snice-focus-ring-color);outline:2px solid var(--snice-color-primary);outline-offset:2px}.checkbox-input:disabled~.checkbox{background:var(--snice-color-surface-container-low);border-color:var(--snice-color-border)}.checkbox-input:disabled:checked~.checkbox{background:var(--snice-color-text-secondary);border-color:var(--snice-color-text-secondary)}.checkbox--invalid{border-color:var(--snice-color-danger)}.checkbox-input:checked~.checkbox--invalid{background:var(--snice-color-danger);border-color:var(--snice-color-danger)}.checkbox-icon{position:absolute;display:none;color:var(--snice-color-text-inverse)}.checkbox-input:checked~.checkbox .checkbox-icon--check{display:block}.checkbox--indeterminate .checkbox-icon--check{display:none!important}.checkbox--indeterminate .checkbox-icon--indeterminate{display:block!important}.checkbox--small .checkbox-icon{width:.75rem;height:.75rem}.checkbox--medium .checkbox-icon{width:.875rem;height:.875rem}.checkbox--large .checkbox-icon{width:1.125rem;height:1.125rem}.checkbox-label{margin-left:.5rem;color:var(--snice-color-text);cursor:pointer}.checkbox-label--small{font-size:var(--snice-font-size-sm)}.checkbox-label--medium{font-size:var(--snice-font-size-md)}.checkbox-label--large{font-size:var(--snice-font-size-lg)}.checkbox-wrapper--disabled .checkbox-label{color:var(--snice-color-text-secondary);cursor:not-allowed}.checkbox-label--required::after{content:' *';color:var(--snice-color-danger)}.checkbox-wrapper:not(.checkbox-wrapper--disabled):hover .checkbox{border-color:var(--snice-color-primary)}.checkbox-wrapper:not(.checkbox-wrapper--disabled):hover .checkbox-input:checked~.checkbox{background:var(--snice-color-primary-hover);border-color:var(--snice-color-primary-hover)}.checkbox-wrapper--loading{cursor:wait;opacity:.7}.checkbox--loading{cursor:wait}.checkbox-spinner{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;width:100%;height:100%;pointer-events:none}.checkbox-spinner::after{content:'';display:block;width:.75em;height:.75em;border:2px solid currentColor;border-right-color:transparent;border-radius:50%;animation:.6s linear infinite spin}@keyframes spin{to{transform:rotate(360deg)}}"}`}focus(){this.input?.focus()}blur(){this.input?.blur()}click(){this.input?.click()}toggle(){this.checked=!this.checked,this.indeterminate=!1,this.dispatchEvent(new CustomEvent("checkbox-change",{bubbles:!0,composed:!0,detail:{checked:this.checked,indeterminate:this.indeterminate,checkbox:this}}))}setIndeterminate(){this.indeterminate=!0,this.checked=!1,this.dispatchEvent(new CustomEvent("checkbox-change",{bubbles:!0,composed:!0,detail:{checked:this.checked,indeterminate:this.indeterminate,checkbox:this}}))}constructor(){super(...arguments),this.checked=(m(this,T),m(this,$,!1)),this.indeterminate=(m(this,O),m(this,F,!1)),this.disabled=(m(this,B),m(this,j,!1)),this.loading=(m(this,D),m(this,H,!1)),this.required=(m(this,P),m(this,K,!1)),this.invalid=(m(this,U),m(this,V,!1)),this.size=(m(this,X),m(this,G,"medium")),this.name=(m(this,J),m(this,Q,"")),this.value=(m(this,W),m(this,Y,"on")),this.label=(m(this,Z),m(this,ee,"")),this.input=(m(this,te),m(this,ie,void 0)),this.checkbox=(m(this,se),m(this,ne,void 0)),this.labelElement=(m(this,ae),m(this,oe,void 0)),this.wrapper=(m(this,de),m(this,ce,void 0)),m(this,le)}})})();(()=>{let i,s,a,l,h,r,u,b,g=[e("snice-spinner")],k=[],v=HTMLElement,x=[],f=[],y=[],w=[],_=[],C=[],S=[],E=[],N=[];(class extends v{static{s=this}static{const e="function"==typeof Symbol&&Symbol.metadata?Object.create(v[Symbol.metadata]??null):void 0;a=[t({})],l=[t({})],h=[t({})],r=[t({type:Number})],u=[n()],b=[o()],p(this,null,u,{kind:"method",name:"render",static:!1,private:!1,access:{has:e=>"render"in e,get:e=>e.render},metadata:e},null,x),p(this,null,b,{kind:"method",name:"styles",static:!1,private:!1,access:{has:e=>"styles"in e,get:e=>e.styles},metadata:e},null,x),p(null,null,a,{kind:"field",name:"size",static:!1,private:!1,access:{has:e=>"size"in e,get:e=>e.size,set:(e,t)=>{e.size=t}},metadata:e},f,y),p(null,null,l,{kind:"field",name:"color",static:!1,private:!1,access:{has:e=>"color"in e,get:e=>e.color,set:(e,t)=>{e.color=t}},metadata:e},w,_),p(null,null,h,{kind:"field",name:"label",static:!1,private:!1,access:{has:e=>"label"in e,get:e=>e.label,set:(e,t)=>{e.label=t}},metadata:e},C,S),p(null,null,r,{kind:"field",name:"thickness",static:!1,private:!1,access:{has:e=>"thickness"in e,get:e=>e.thickness,set:(e,t)=>{e.thickness=t}},metadata:e},E,N),p(null,i={value:s},g,{kind:"class",name:s.name,metadata:e},null,k),s=i.value,e&&Object.defineProperty(s,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:e}),m(s,k)}render(){const e=this.getSizeValue(),t=(e-2*this.thickness)/2,i=2*t*Math.PI,s=e/2,n=e/2,a=`0 0 ${e} ${e}`;return d`
