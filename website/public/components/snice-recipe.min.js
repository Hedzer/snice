void 0===globalThis.Snice&&console.warn("[snice] snice-runtime.min.js must be loaded before snice-recipe.min.js");var SniceRecipe=function(e,i){"use strict";function t(e,i,t,r,s,n){function a(e){if(void 0!==e&&"function"!=typeof e)throw new TypeError("Function expected");return e}for(var c,o=r.kind,p="getter"===o?"get":"setter"===o?"set":"value",l=!i&&e?r.static?e:e.prototype:null,d=i||(l?Object.getOwnPropertyDescriptor(l,r.name):{}),m=!1,g=t.length-1;g>=0;g--){var v={};for(var h in r)v[h]="access"===h?{}:r[h];for(var h in r.access)v.access[h]=r.access[h];v.addInitializer=function(e){if(m)throw new TypeError("Cannot add initializers after decoration has completed");n.push(a(e||null))};var u=(0,t[g])("accessor"===o?{get:d.get,set:d.set}:d[p],v);if("accessor"===o){if(void 0===u)continue;if(null===u||"object"!=typeof u)throw new TypeError("Object expected");(c=a(u.get))&&(d.get=c),(c=a(u.set))&&(d.set=c),(c=a(u.init))&&s.unshift(c)}else(c=a(u))&&("field"===o?s.unshift(c):d[p]=c)}l&&Object.defineProperty(l,r.name,d),m=!0}function r(e,i,t){for(var r=arguments.length>2,s=0;s<i.length;s++)t=r?i[s].call(e,t):i[s].call(e);return r?t:void 0}"function"==typeof SuppressedError&&SuppressedError;let s=(()=>{let e,s,n,a,c,o,p,l,d,m,g,v,h,u,f,_,b,y,x,k,S,$,w,T,I,z,C,M,A,j,F=[i.element("snice-recipe")],P=[],B=HTMLElement,N=[],V=[],R=[],E=[],H=[],O=[],U=[],D=[],L=[],q=[],G=[],J=[],K=[],Q=[],W=[],X=[],Y=[],Z=[],ee=[],ie=[],te=[],re=[],se=[],ne=[],ae=[],ce=[],oe=[],pe=[],le=[],de=[],me=[],ge=[],ve=[],he=[],ue=[],fe=[],_e=[],be=[],ye=[];return class extends B{static{s=this}constructor(){super(...arguments),this.title=(r(this,N),r(this,V,"")),this.description=(r(this,R),r(this,E,"")),this.image=(r(this,H),r(this,O,"")),this.author=(r(this,U),r(this,D,"")),this.prepTime=(r(this,L),r(this,q,0)),this.cookTime=(r(this,G),r(this,J,0)),this.servings=(r(this,K),r(this,Q,4)),this.difficulty=(r(this,W),r(this,X,"medium")),this.cuisine=(r(this,Y),r(this,Z,"")),this.variant=(r(this,ee),r(this,ie,"full")),this.ingredients=(r(this,te),r(this,re,[])),this.steps=(r(this,se),r(this,ne,[])),this.nutrition=(r(this,ae),r(this,ce,null)),this.tags=(r(this,oe),r(this,pe,[])),this.currentServings=(r(this,le),r(this,de,0)),this.checkedIngredients=(r(this,me),r(this,ge,[])),this.completedSteps=(r(this,ve),r(this,he,[])),this.activeStep=(r(this,ue),r(this,fe,-1)),this.timerVersion=(r(this,_e),r(this,be,0)),this.activeTimers=(r(this,ye),new Map),this.baseServings=0}static{const xe="function"==typeof Symbol&&Symbol.metadata?Object.create(B[Symbol.metadata]??null):void 0;n=[i.property()],a=[i.property()],c=[i.property()],o=[i.property()],p=[i.property({type:Number,attribute:"prep-time"})],l=[i.property({type:Number,attribute:"cook-time"})],d=[i.property({type:Number})],m=[i.property()],g=[i.property()],v=[i.property()],h=[i.property({type:Array,attribute:!1})],u=[i.property({type:Array,attribute:!1})],f=[i.property({type:Object,attribute:!1})],_=[i.property({type:Array,attribute:!1})],b=[i.property({type:Number})],y=[i.property({type:Array})],x=[i.property({type:Array})],k=[i.property({type:Number})],S=[i.property({type:Number})],$=[i.watch("servings")],w=[i.watch("ingredients")],T=[i.watch("steps")],I=[i.dispose()],z=[i.dispatch("recipe-serving-change",{bubbles:!0,composed:!0})],C=[i.dispatch("recipe-step-complete",{bubbles:!0,composed:!0})],M=[i.dispatch("recipe-ingredient-check",{bubbles:!0,composed:!0})],A=[i.styles()],j=[i.render()],t(this,null,$,{kind:"method",name:"onServingsChange",static:!1,private:!1,access:{has:e=>"onServingsChange"in e,get:e=>e.onServingsChange},metadata:xe},null,N),t(this,null,w,{kind:"method",name:"onIngredientsChange",static:!1,private:!1,access:{has:e=>"onIngredientsChange"in e,get:e=>e.onIngredientsChange},metadata:xe},null,N),t(this,null,T,{kind:"method",name:"onStepsChange",static:!1,private:!1,access:{has:e=>"onStepsChange"in e,get:e=>e.onStepsChange},metadata:xe},null,N),t(this,null,I,{kind:"method",name:"cleanup",static:!1,private:!1,access:{has:e=>"cleanup"in e,get:e=>e.cleanup},metadata:xe},null,N),t(this,null,z,{kind:"method",name:"emitServingChange",static:!1,private:!1,access:{has:e=>"emitServingChange"in e,get:e=>e.emitServingChange},metadata:xe},null,N),t(this,null,C,{kind:"method",name:"emitStepComplete",static:!1,private:!1,access:{has:e=>"emitStepComplete"in e,get:e=>e.emitStepComplete},metadata:xe},null,N),t(this,null,M,{kind:"method",name:"emitIngredientCheck",static:!1,private:!1,access:{has:e=>"emitIngredientCheck"in e,get:e=>e.emitIngredientCheck},metadata:xe},null,N),t(this,null,A,{kind:"method",name:"styles",static:!1,private:!1,access:{has:e=>"styles"in e,get:e=>e.styles},metadata:xe},null,N),t(this,null,j,{kind:"method",name:"template",static:!1,private:!1,access:{has:e=>"template"in e,get:e=>e.template},metadata:xe},null,N),t(null,null,n,{kind:"field",name:"title",static:!1,private:!1,access:{has:e=>"title"in e,get:e=>e.title,set:(e,i)=>{e.title=i}},metadata:xe},V,R),t(null,null,a,{kind:"field",name:"description",static:!1,private:!1,access:{has:e=>"description"in e,get:e=>e.description,set:(e,i)=>{e.description=i}},metadata:xe},E,H),t(null,null,c,{kind:"field",name:"image",static:!1,private:!1,access:{has:e=>"image"in e,get:e=>e.image,set:(e,i)=>{e.image=i}},metadata:xe},O,U),t(null,null,o,{kind:"field",name:"author",static:!1,private:!1,access:{has:e=>"author"in e,get:e=>e.author,set:(e,i)=>{e.author=i}},metadata:xe},D,L),t(null,null,p,{kind:"field",name:"prepTime",static:!1,private:!1,access:{has:e=>"prepTime"in e,get:e=>e.prepTime,set:(e,i)=>{e.prepTime=i}},metadata:xe},q,G),t(null,null,l,{kind:"field",name:"cookTime",static:!1,private:!1,access:{has:e=>"cookTime"in e,get:e=>e.cookTime,set:(e,i)=>{e.cookTime=i}},metadata:xe},J,K),t(null,null,d,{kind:"field",name:"servings",static:!1,private:!1,access:{has:e=>"servings"in e,get:e=>e.servings,set:(e,i)=>{e.servings=i}},metadata:xe},Q,W),t(null,null,m,{kind:"field",name:"difficulty",static:!1,private:!1,access:{has:e=>"difficulty"in e,get:e=>e.difficulty,set:(e,i)=>{e.difficulty=i}},metadata:xe},X,Y),t(null,null,g,{kind:"field",name:"cuisine",static:!1,private:!1,access:{has:e=>"cuisine"in e,get:e=>e.cuisine,set:(e,i)=>{e.cuisine=i}},metadata:xe},Z,ee),t(null,null,v,{kind:"field",name:"variant",static:!1,private:!1,access:{has:e=>"variant"in e,get:e=>e.variant,set:(e,i)=>{e.variant=i}},metadata:xe},ie,te),t(null,null,h,{kind:"field",name:"ingredients",static:!1,private:!1,access:{has:e=>"ingredients"in e,get:e=>e.ingredients,set:(e,i)=>{e.ingredients=i}},metadata:xe},re,se),t(null,null,u,{kind:"field",name:"steps",static:!1,private:!1,access:{has:e=>"steps"in e,get:e=>e.steps,set:(e,i)=>{e.steps=i}},metadata:xe},ne,ae),t(null,null,f,{kind:"field",name:"nutrition",static:!1,private:!1,access:{has:e=>"nutrition"in e,get:e=>e.nutrition,set:(e,i)=>{e.nutrition=i}},metadata:xe},ce,oe),t(null,null,_,{kind:"field",name:"tags",static:!1,private:!1,access:{has:e=>"tags"in e,get:e=>e.tags,set:(e,i)=>{e.tags=i}},metadata:xe},pe,le),t(null,null,b,{kind:"field",name:"currentServings",static:!1,private:!1,access:{has:e=>"currentServings"in e,get:e=>e.currentServings,set:(e,i)=>{e.currentServings=i}},metadata:xe},de,me),t(null,null,y,{kind:"field",name:"checkedIngredients",static:!1,private:!1,access:{has:e=>"checkedIngredients"in e,get:e=>e.checkedIngredients,set:(e,i)=>{e.checkedIngredients=i}},metadata:xe},ge,ve),t(null,null,x,{kind:"field",name:"completedSteps",static:!1,private:!1,access:{has:e=>"completedSteps"in e,get:e=>e.completedSteps,set:(e,i)=>{e.completedSteps=i}},metadata:xe},he,ue),t(null,null,k,{kind:"field",name:"activeStep",static:!1,private:!1,access:{has:e=>"activeStep"in e,get:e=>e.activeStep,set:(e,i)=>{e.activeStep=i}},metadata:xe},fe,_e),t(null,null,S,{kind:"field",name:"timerVersion",static:!1,private:!1,access:{has:e=>"timerVersion"in e,get:e=>e.timerVersion,set:(e,i)=>{e.timerVersion=i}},metadata:xe},be,ye),t(null,e={value:s},F,{kind:"class",name:s.name,metadata:xe},null,P),s=e.value,xe&&Object.defineProperty(s,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:xe}),r(s,P)}onServingsChange(){0===this.baseServings&&(this.baseServings=this.servings,this.currentServings=this.servings)}onIngredientsChange(){this.checkedIngredients=new Array(this.ingredients.length).fill(!1)}onStepsChange(){this.completedSteps=new Array(this.steps.length).fill(!1),this.activeStep=-1}setServings(e){if(e<1)return;const i=this.currentServings;this.currentServings=e,this.emitServingChange(i)}print(){window.print()}reset(){this.checkedIngredients=new Array(this.ingredients.length).fill(!1),this.completedSteps=new Array(this.steps.length).fill(!1),this.activeStep=-1,this.currentServings=this.baseServings||this.servings;for(const[,e]of this.activeTimers.entries())clearInterval(e.intervalId);this.activeTimers.clear(),this.timerVersion++}scaleAmount(e){const i=this.baseServings||this.servings;return 0===i?e:Math.round(e*this.currentServings/i*100)/100}formatAmount(e){const i=this.scaleAmount(e);if(i===Math.floor(i))return i.toString();const t=i-Math.floor(i),r=Math.floor(i),s=[[.25,"¼"],[.33,"⅓"],[.5,"½"],[.67,"⅔"],[.75,"¾"]];for(const[e,i]of s)if(Math.abs(t-e)<.05)return r>0?`${r}${i}`:i;return i.toFixed(1)}toggleIngredient(e){const i=[...this.checkedIngredients];i[e]=!i[e],this.checkedIngredients=i,this.emitIngredientCheck(e,i[e])}toggleStepComplete(e){const i=[...this.completedSteps];i[e]=!i[e],this.completedSteps=i,this.emitStepComplete(e,i[e])}decrementServings(){this.currentServings>1&&this.setServings(this.currentServings-1)}incrementServings(){this.setServings(this.currentServings+1)}goToPrevStep(){this.activeStep>0&&(this.activeStep=this.activeStep-1)}goToNextStep(){this.activeStep=this.activeStep<this.steps.length-1?this.activeStep+1:-1}startStepByStep(){this.activeStep=0}startTimer(e,i){if(this.activeTimers.has(e))return;const t=60*i,r=window.setInterval(()=>{const i=this.activeTimers.get(e);if(i){if(i.remaining<=1)return clearInterval(i.intervalId),this.activeTimers.set(e,{...i,remaining:0,done:!0}),void this.timerVersion++;this.activeTimers.set(e,{...i,remaining:i.remaining-1}),this.timerVersion++}},1e3);this.activeTimers.set(e,{remaining:t,intervalId:r,done:!1}),this.timerVersion++}cleanup(){for(const[,e]of this.activeTimers.entries())clearInterval(e.intervalId);this.activeTimers.clear()}cancelTimer(e){const i=this.activeTimers.get(e);i&&(clearInterval(i.intervalId),this.activeTimers.delete(e),this.timerVersion++)}formatTimer(e){return`${Math.floor(e/60)}:${(e%60).toString().padStart(2,"0")}`}formatMinutes(e){if(e<60)return`${e} min`;const i=Math.floor(e/60),t=e%60;return t>0?`${i}h ${t}m`:`${i}h`}emitServingChange(e){return{servings:this.currentServings,previousServings:e}}emitStepComplete(e,i){return{stepIndex:e,completed:i}}emitIngredientCheck(e,i){return{ingredientIndex:e,checked:i,ingredient:this.ingredients[e]}}styles(){return i.css`${":host{display:block;font-family:var(--snice-font-family, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif);color:var(--snice-color-text,rgb(23 23 23));width:100%;--recipe-bg:var(--snice-color-surface-container-high, rgb(252 251 249));--recipe-border:var(--snice-color-border, rgb(226 226 226));--recipe-text:var(--snice-color-text, rgb(23 23 23));--recipe-text-secondary:var(--snice-color-text-secondary, rgb(82 82 82));--recipe-text-tertiary:var(--snice-color-text-tertiary, rgb(115 115 115));--recipe-primary:var(--snice-color-primary, rgb(37 99 235));--recipe-success:var(--snice-color-success, rgb(22 163 74));--recipe-danger:var(--snice-color-danger, rgb(220 38 38));--recipe-radius:var(--snice-border-radius-lg, 0.5rem);--recipe-shadow:var(--snice-shadow-md, 0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1))}.recipe{background:var(--recipe-bg);border-radius:var(--recipe-radius);box-shadow:var(--recipe-shadow);overflow:hidden}.recipe__hero{position:relative;width:100%;overflow:hidden}.recipe__hero img{width:100%;height:auto;display:block;object-fit:cover;max-height:25rem}.recipe__header{font-family:var(--snice-font-family-display, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif);padding:var(--snice-spacing-lg,1.5rem)}.recipe__title{font-family:var(--snice-font-family-display, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif);margin:0 0 var(--snice-spacing-xs,.5rem);font-size:var(--snice-heading-xl, 1.5rem);font-weight:var(--snice-font-weight-bold,700);line-height:var(--snice-line-height-normal, 1.5);color:var(--recipe-text)}.recipe__description{margin:0 0 var(--snice-spacing-sm,.75rem);font-size:var(--snice-font-size-md, 1rem);color:var(--recipe-text-secondary);line-height:var(--snice-line-height-normal, 1.5)}.recipe__author{font-size:var(--snice-font-size-sm, .875rem);color:var(--recipe-text-tertiary)}.recipe__tags{display:flex;flex-wrap:wrap;gap:var(--snice-spacing-2xs,.25rem);margin-top:var(--snice-spacing-sm,.75rem)}.recipe__tag{display:inline-flex;align-items:center;padding:var(--snice-spacing-3xs,.125rem) var(--snice-spacing-xs,.5rem);font-size:var(--snice-font-size-xs, .75rem);border-radius:9999px;background:var(--snice-color-surface,rgb(255 255 255));border:1px solid var(--recipe-border);color:var(--recipe-text-secondary)}.recipe__meta{display:flex;flex-wrap:wrap;gap:var(--snice-spacing-md,1rem);padding:var(--snice-spacing-md,1rem) var(--snice-spacing-lg,1.5rem);border-top:1px solid var(--recipe-border);border-bottom:1px solid var(--recipe-border);background:var(--snice-color-surface,rgb(255 255 255))}.recipe__meta-item{display:flex;flex-direction:column;align-items:center;gap:var(--snice-spacing-3xs,.125rem);min-width:4rem}.recipe__meta-label{font-size:var(--snice-font-size-xs, .75rem);color:var(--recipe-text-tertiary);text-transform:uppercase;letter-spacing:var(--snice-tracking-wide, .03em)}.recipe__meta-value{font-size:var(--snice-font-size-md, 1rem);font-weight:var(--snice-font-weight-semibold,600);color:var(--recipe-text)}.recipe__difficulty--easy{color:var(--recipe-success)}.recipe__difficulty--medium{color:var(--snice-color-warning,rgb(234 179 8))}.recipe__difficulty--hard{color:var(--recipe-danger)}.recipe__content{display:grid;grid-template-columns:1fr 2fr;gap:var(--snice-spacing-lg,1.5rem);padding:var(--snice-spacing-lg,1.5rem)}@media (max-width:768px){.recipe__content{grid-template-columns:1fr}}.recipe__servings-adjuster{display:flex;align-items:center;gap:var(--snice-spacing-xs,.5rem);margin-bottom:var(--snice-spacing-md,1rem)}.recipe__servings-adjuster span{font-size:var(--snice-font-size-md, 1rem);font-weight:var(--snice-font-weight-semibold,600);color:var(--recipe-text)}.recipe__servings-btn{display:inline-flex;align-items:center;justify-content:center;width:2rem;height:2rem;border:1px solid var(--recipe-border);border-radius:50%;background:var(--snice-color-surface,rgb(255 255 255));color:var(--recipe-text);font-size:var(--snice-font-size-lg, 1.125rem);cursor:pointer;transition:background var(--snice-transition-fast, 150ms),border-color var(--snice-transition-fast, 150ms);padding:0;line-height:1}.recipe__servings-btn:hover{border-color:var(--recipe-primary);background:var(--snice-color-primary-subtle,rgb(239 246 255))}.recipe__servings-btn:focus-visible{outline:var(--snice-focus-ring-width,2px) solid var(--snice-focus-ring-color,rgb(59 130 246 / .5));outline-offset:var(--snice-focus-ring-offset,2px)}.recipe__servings-count{min-width:2rem;text-align:center;font-weight:var(--snice-font-weight-bold,700);font-size:var(--snice-font-size-lg, 1.125rem)}.recipe__ingredients-section{position:relative}.recipe__section-title{font-family:var(--snice-font-family-display, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif);font-size:var(--snice-heading-md, 1.125rem);font-weight:var(--snice-font-weight-semibold,600);margin:0 0 var(--snice-spacing-sm,.75rem);color:var(--recipe-text)}.recipe__ingredient-group-title{font-family:var(--snice-font-family-display, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif);font-size:var(--snice-heading-sm, 1rem);font-weight:var(--snice-font-weight-medium,500);color:var(--recipe-text-secondary);margin:var(--snice-spacing-sm,.75rem) 0 var(--snice-spacing-2xs,.25rem)}.recipe__ingredients-list{list-style:none;padding:0;margin:0}.recipe__ingredient{display:flex;align-items:center;gap:var(--snice-spacing-xs,.5rem);padding:var(--snice-spacing-xs,.5rem) 0;border-bottom:1px solid var(--recipe-border);cursor:pointer;transition:opacity var(--snice-transition-fast, 150ms)}.recipe__ingredient:last-child{border-bottom:none}.recipe__ingredient--checked{opacity:.5}.recipe__ingredient--checked .recipe__ingredient-text{text-decoration:line-through}.recipe__ingredient-checkbox{appearance:none;width:1.125rem;height:1.125rem;border:2px solid var(--recipe-border);border-radius:3px;cursor:pointer;flex-shrink:0;position:relative;transition:background var(--snice-transition-fast, 150ms),border-color var(--snice-transition-fast, 150ms)}.recipe__ingredient-checkbox:checked{background:var(--recipe-primary);border-color:var(--recipe-primary)}.recipe__ingredient-checkbox:checked::after{content:'';position:absolute;left:3px;top:0;width:.375rem;height:.625rem;border:solid #fff;border-width:0 2px 2px 0;transform:rotate(45deg)}.recipe__ingredient-checkbox:focus-visible{outline:var(--snice-focus-ring-width,2px) solid var(--snice-focus-ring-color,rgb(59 130 246 / .5));outline-offset:var(--snice-focus-ring-offset,2px)}.recipe__ingredient-amount{font-weight:var(--snice-font-weight-semibold,600);white-space:nowrap;color:var(--recipe-text)}.recipe__ingredient-text{color:var(--recipe-text-secondary)}.recipe__steps-section{position:relative}.recipe__steps-list{list-style:none;padding:0;margin:0;counter-reset:step-counter}.recipe__step{display:flex;gap:var(--snice-spacing-md,1rem);padding:var(--snice-spacing-md,1rem) 0;border-bottom:1px solid var(--recipe-border);counter-increment:step-counter;transition:opacity var(--snice-transition-fast, 150ms)}.recipe__step:last-child{border-bottom:none}.recipe__step--completed{opacity:.5}.recipe__step--active{background:var(--snice-color-primary-subtle,rgb(239 246 255));margin:0 calc(-1 * var(--snice-spacing-sm,.75rem));padding-left:var(--snice-spacing-sm,.75rem);padding-right:var(--snice-spacing-sm,.75rem);border-radius:var(--snice-border-radius-md,.25rem)}.recipe__step-number{flex-shrink:0;display:flex;align-items:center;justify-content:center;width:2rem;height:2rem;border-radius:50%;background:var(--recipe-primary);color:var(--snice-color-text-inverse,rgb(250 250 250));font-size:var(--snice-font-size-sm, .875rem);font-weight:var(--snice-font-weight-bold,700);cursor:pointer;transition:background var(--snice-transition-fast, 150ms)}.recipe__step--completed .recipe__step-number{background:var(--recipe-success)}.recipe__step-number:hover{opacity:.8}.recipe__step-body{flex:1;min-width:0}.recipe__step-text{font-size:var(--snice-font-size-md, 1rem);line-height:var(--snice-line-height-normal, 1.5);color:var(--recipe-text)}.recipe__step-tip{margin-top:var(--snice-spacing-xs,.5rem);padding:var(--snice-spacing-xs,.5rem) var(--snice-spacing-sm,.75rem);background:var(--snice-color-primary-subtle,rgb(239 246 255));border-left:3px solid var(--recipe-primary);border-radius:0 var(--snice-border-radius-md,.25rem) var(--snice-border-radius-md,.25rem) 0;font-size:var(--snice-font-size-sm, .875rem);color:var(--recipe-text-secondary)}.recipe__step-image{margin-top:var(--snice-spacing-xs,.5rem);width:100%;max-width:20rem;border-radius:var(--snice-border-radius-md,.25rem)}.recipe__step-timer-btn{display:inline-flex;align-items:center;gap:var(--snice-spacing-3xs,.125rem);margin-top:var(--snice-spacing-xs,.5rem);padding:var(--snice-spacing-3xs,.125rem) var(--snice-spacing-xs,.5rem);border:1px solid var(--recipe-primary);border-radius:var(--snice-border-radius-md,.25rem);background:0 0;color:var(--recipe-primary);font-size:var(--snice-font-size-sm, .875rem);cursor:pointer;transition:background var(--snice-transition-fast, 150ms)}.recipe__step-timer-btn:hover{background:var(--snice-color-primary-subtle,rgb(239 246 255))}.recipe__step-timer-btn:focus-visible{outline:var(--snice-focus-ring-width,2px) solid var(--snice-focus-ring-color,rgb(59 130 246 / .5));outline-offset:var(--snice-focus-ring-offset,2px)}.recipe__step-timer-btn svg{width:.875rem;height:.875rem}.recipe__active-timer{display:inline-flex;align-items:center;gap:var(--snice-spacing-2xs,.25rem);margin-top:var(--snice-spacing-xs,.5rem);padding:var(--snice-spacing-2xs,.25rem) var(--snice-spacing-xs,.5rem);background:var(--snice-color-primary-subtle,rgb(239 246 255));border-radius:var(--snice-border-radius-md,.25rem);font-size:var(--snice-font-size-sm, .875rem);font-weight:var(--snice-font-weight-semibold,600);color:var(--recipe-primary)}.recipe__active-timer--done{background:var(--snice-color-success-subtle,rgb(220 252 231));color:var(--recipe-success)}.recipe__timer-cancel{display:inline-flex;align-items:center;justify-content:center;width:1.25rem;height:1.25rem;border:none;border-radius:50%;background:0 0;color:inherit;cursor:pointer;padding:0;font-size:.75rem}.recipe__timer-cancel:hover{background:rgb(0 0 0 / .1)}.recipe__nutrition{padding:var(--snice-spacing-lg,1.5rem);border-top:1px solid var(--recipe-border)}.recipe__nutrition-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(6rem,1fr));gap:var(--snice-spacing-md,1rem);margin-top:var(--snice-spacing-sm,.75rem)}.recipe__nutrition-item{text-align:center;padding:var(--snice-spacing-sm,.75rem);background:var(--snice-color-surface,rgb(255 255 255));border-radius:var(--snice-border-radius-md,.25rem);border:1px solid var(--recipe-border)}.recipe__nutrition-value{font-size:var(--snice-font-size-lg, 1.125rem);font-weight:var(--snice-font-weight-bold,700);color:var(--recipe-text)}.recipe__nutrition-label{font-size:var(--snice-font-size-xs, .75rem);color:var(--recipe-text-tertiary);margin-top:var(--snice-spacing-3xs,.125rem)}.recipe__step-controls{display:flex;gap:var(--snice-spacing-xs,.5rem);padding:var(--snice-spacing-sm,.75rem) var(--snice-spacing-lg,1.5rem);border-top:1px solid var(--recipe-border)}.recipe__step-controls button{padding:var(--snice-spacing-xs,.5rem) var(--snice-spacing-md,1rem);border:1px solid var(--recipe-border);border-radius:var(--snice-border-radius-md,.25rem);background:var(--snice-color-surface,rgb(255 255 255));color:var(--recipe-text);font-size:var(--snice-font-size-sm, .875rem);cursor:pointer;transition:background var(--snice-transition-fast, 150ms),border-color var(--snice-transition-fast, 150ms)}.recipe__step-controls button:hover{border-color:var(--recipe-primary);background:var(--snice-color-primary-subtle,rgb(239 246 255))}.recipe__step-controls button:disabled{opacity:.4;cursor:not-allowed}.recipe__step-controls button:focus-visible{outline:var(--snice-focus-ring-width,2px) solid var(--snice-focus-ring-color,rgb(59 130 246 / .5));outline-offset:var(--snice-focus-ring-offset,2px)}.recipe__print-btn{margin-left:auto}:host([variant=card]) .recipe__content{grid-template-columns:1fr;padding:var(--snice-spacing-md,1rem)}:host([variant=card]) .recipe__hero img{max-height:15rem}:host([variant=card]) .recipe__header{font-family:var(--snice-font-family-display, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif);padding:var(--snice-spacing-md,1rem)}@media print{.recipe{box-shadow:none;border:1px solid #ccc}.recipe__active-timer,.recipe__servings-btn,.recipe__step-controls,.recipe__step-timer-btn,.recipe__timer-cancel{display:none!important}.recipe__ingredient--checked,.recipe__step--completed{opacity:1}.recipe__ingredient--checked .recipe__ingredient-text{text-decoration:none}}[hidden]{display:none!important}@media (prefers-reduced-motion:reduce){*{transition-duration:0s!important;animation-duration:0s!important}}"}`}template(){0===this.baseServings&&this.servings>0&&(this.baseServings=this.servings,this.currentServings=this.servings);const e=this.prepTime+this.cookTime,t=new Map;this.ingredients.forEach((e,i)=>{const r=e.group||"";t.has(r)||t.set(r,[]),t.get(r).push({ingredient:e,index:i})});const r=this.activeStep>=0,s=this.tags.length>0||this.cuisine.length>0,n=this.cuisine.length>0,a=this.ingredients.length>0,c=this.steps.length>0,o=a||c,p=this.prepTime>0||this.cookTime>0||this.servings>0||this.difficulty.length>0,l=null!==this.nutrition,d=l?this.nutrition.calories:0,m=l?this.nutrition.protein:0,g=l?this.nutrition.carbs:0,v=l?this.nutrition.fat:0,h=l?this.nutrition.fiber:0,u=l?this.nutrition.sodium:0,f=l&&void 0!==this.nutrition.fiber,_=l&&void 0!==this.nutrition.sodium,b=[];for(const[e,r]of t.entries()){e&&b.push(i.html`<li class="recipe__ingredient-group-title">${e}</li>`);for(const{ingredient:e,index:t}of r){const r=this.checkedIngredients[t]||!1;b.push(i.html`
          <li class="recipe__ingredient ${r?"recipe__ingredient--checked":""}" @click=${()=>this.toggleIngredient(t)}>
            <input type="checkbox" class="recipe__ingredient-checkbox" aria-label="${e.name}" ?checked=${r} @click=${e=>e.stopPropagation()} @change=${()=>this.toggleIngredient(t)} />
            ...
            <if ${c}>
              <div class="recipe__steps-section" part="steps">
                ...
                <ol class="recipe__steps-list">
                  ${this.steps.map((e,t)=>{const r=this.completedSteps[t]||!1,s=this.activeStep===t,n=this.activeTimers.get(t),a=void 0!==n,c=a&&n.done?"recipe__active-timer--done":"",o=a?n.done?"Done!":this.formatTimer(n.remaining):"";return i.html`
