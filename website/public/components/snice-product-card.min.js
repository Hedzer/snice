void 0===globalThis.Snice&&console.warn("[snice] snice-runtime.min.js must be loaded before snice-product-card.min.js");var SniceProductCard=function(r,t){"use strict";function a(r,t,a,e,i,c){function o(r){if(void 0!==r&&"function"!=typeof r)throw new TypeError("Function expected");return r}for(var n,s=e.kind,d="getter"===s?"get":"setter"===s?"set":"value",l=!t&&r?e.static?r:r.prototype:null,p=t||(l?Object.getOwnPropertyDescriptor(l,e.name):{}),u=!1,m=a.length-1;m>=0;m--){var g={};for(var v in e)g[v]="access"===v?{}:e[v];for(var v in e.access)g.access[v]=e.access[v];g.addInitializer=function(r){if(u)throw new TypeError("Cannot add initializers after decoration has completed");c.push(o(r||null))};var h=(0,a[m])("accessor"===s?{get:p.get,set:p.set}:p[d],g);if("accessor"===s){if(void 0===h)continue;if(null===h||"object"!=typeof h)throw new TypeError("Object expected");(n=o(h.get))&&(p.get=n),(n=o(h.set))&&(p.set=n),(n=o(h.init))&&i.unshift(n)}else(n=o(h))&&("field"===s?i.unshift(n):p[d]=n)}l&&Object.defineProperty(l,e.name,p),u=!0}function e(r,t,a){for(var e=arguments.length>2,i=0;i<t.length;i++)a=e?t[i].call(r,a):t[i].call(r);return e?a:void 0}"function"==typeof SuppressedError&&SuppressedError;let i=(()=>{let r,i,c,o,n,s,d,l,p,u,m,g,v,h,f,_,b,y,k,x,w,$,z,S,C,I,V,P,A,B=[t.element("snice-product-card")],j=[],M=HTMLElement,F=[],T=[],q=[],O=[],Q=[],R=[],H=[],N=[],D=[],L=[],U=[],E=[],Y=[],G=[],X=[],J=[],K=[],W=[],Z=[],rr=[],tr=[],ar=[],er=[],ir=[],cr=[],or=[],nr=[],sr=[],dr=[],lr=[],pr=[],ur=[],mr=[],gr=[],vr=[],hr=[],fr=[];return class extends M{static{i=this}static{const _r="function"==typeof Symbol&&Symbol.metadata?Object.create(M[Symbol.metadata]??null):void 0;c=[t.property()],o=[t.property({type:Number})],n=[t.property({type:Number,attribute:"sale-price"})],s=[t.property()],d=[t.property({type:Array,attribute:!1})],l=[t.property({type:Number})],p=[t.property({type:Number,attribute:"review-count"})],u=[t.property({type:Array,attribute:!1})],m=[t.property({type:Boolean,attribute:"in-stock"})],g=[t.property()],v=[t.property()],h=[t.property({attribute:"badge-variant"})],f=[t.property({type:Boolean})],_=[t.property({type:Boolean})],b=[t.property({type:Number,attribute:"stock-count"})],y=[t.property({type:Number,attribute:!1})],k=[t.property({type:Object,attribute:!1})],x=[t.property({type:Boolean,attribute:!1})],w=[t.ready()],$=[t.watch("variants")],z=[t.dispatch("add-to-cart",{bubbles:!0,composed:!0})],S=[t.dispatch("variant-select",{bubbles:!0,composed:!0})],C=[t.dispatch("image-click",{bubbles:!0,composed:!0})],I=[t.dispatch("favorite",{bubbles:!0,composed:!0})],V=[t.dispatch("quick-view",{bubbles:!0,composed:!0})],P=[t.render()],A=[t.styles()],a(this,null,w,{kind:"method",name:"init",static:!1,private:!1,access:{has:r=>"init"in r,get:r=>r.init},metadata:_r},null,F),a(this,null,$,{kind:"method",name:"handleVariantsChange",static:!1,private:!1,access:{has:r=>"handleVariantsChange"in r,get:r=>r.handleVariantsChange},metadata:_r},null,F),a(this,null,z,{kind:"method",name:"emitAddToCart",static:!1,private:!1,access:{has:r=>"emitAddToCart"in r,get:r=>r.emitAddToCart},metadata:_r},null,F),a(this,null,S,{kind:"method",name:"emitVariantSelect",static:!1,private:!1,access:{has:r=>"emitVariantSelect"in r,get:r=>r.emitVariantSelect},metadata:_r},null,F),a(this,null,C,{kind:"method",name:"emitImageClick",static:!1,private:!1,access:{has:r=>"emitImageClick"in r,get:r=>r.emitImageClick},metadata:_r},null,F),a(this,null,I,{kind:"method",name:"emitFavorite",static:!1,private:!1,access:{has:r=>"emitFavorite"in r,get:r=>r.emitFavorite},metadata:_r},null,F),a(this,null,V,{kind:"method",name:"emitQuickView",static:!1,private:!1,access:{has:r=>"emitQuickView"in r,get:r=>r.emitQuickView},metadata:_r},null,F),a(this,null,P,{kind:"method",name:"renderContent",static:!1,private:!1,access:{has:r=>"renderContent"in r,get:r=>r.renderContent},metadata:_r},null,F),a(this,null,A,{kind:"method",name:"componentStyles",static:!1,private:!1,access:{has:r=>"componentStyles"in r,get:r=>r.componentStyles},metadata:_r},null,F),a(null,null,c,{kind:"field",name:"name",static:!1,private:!1,access:{has:r=>"name"in r,get:r=>r.name,set:(r,t)=>{r.name=t}},metadata:_r},T,q),a(null,null,o,{kind:"field",name:"price",static:!1,private:!1,access:{has:r=>"price"in r,get:r=>r.price,set:(r,t)=>{r.price=t}},metadata:_r},O,Q),a(null,null,n,{kind:"field",name:"salePrice",static:!1,private:!1,access:{has:r=>"salePrice"in r,get:r=>r.salePrice,set:(r,t)=>{r.salePrice=t}},metadata:_r},R,H),a(null,null,s,{kind:"field",name:"currency",static:!1,private:!1,access:{has:r=>"currency"in r,get:r=>r.currency,set:(r,t)=>{r.currency=t}},metadata:_r},N,D),a(null,null,d,{kind:"field",name:"images",static:!1,private:!1,access:{has:r=>"images"in r,get:r=>r.images,set:(r,t)=>{r.images=t}},metadata:_r},L,U),a(null,null,l,{kind:"field",name:"rating",static:!1,private:!1,access:{has:r=>"rating"in r,get:r=>r.rating,set:(r,t)=>{r.rating=t}},metadata:_r},E,Y),a(null,null,p,{kind:"field",name:"reviewCount",static:!1,private:!1,access:{has:r=>"reviewCount"in r,get:r=>r.reviewCount,set:(r,t)=>{r.reviewCount=t}},metadata:_r},G,X),a(null,null,u,{kind:"field",name:"variants",static:!1,private:!1,access:{has:r=>"variants"in r,get:r=>r.variants,set:(r,t)=>{r.variants=t}},metadata:_r},J,K),a(null,null,m,{kind:"field",name:"inStock",static:!1,private:!1,access:{has:r=>"inStock"in r,get:r=>r.inStock,set:(r,t)=>{r.inStock=t}},metadata:_r},W,Z),a(null,null,g,{kind:"field",name:"variant",static:!1,private:!1,access:{has:r=>"variant"in r,get:r=>r.variant,set:(r,t)=>{r.variant=t}},metadata:_r},rr,tr),a(null,null,v,{kind:"field",name:"badge",static:!1,private:!1,access:{has:r=>"badge"in r,get:r=>r.badge,set:(r,t)=>{r.badge=t}},metadata:_r},ar,er),a(null,null,h,{kind:"field",name:"badgeVariant",static:!1,private:!1,access:{has:r=>"badgeVariant"in r,get:r=>r.badgeVariant,set:(r,t)=>{r.badgeVariant=t}},metadata:_r},ir,cr),a(null,null,f,{kind:"field",name:"loading",static:!1,private:!1,access:{has:r=>"loading"in r,get:r=>r.loading,set:(r,t)=>{r.loading=t}},metadata:_r},or,nr),a(null,null,_,{kind:"field",name:"favorite",static:!1,private:!1,access:{has:r=>"favorite"in r,get:r=>r.favorite,set:(r,t)=>{r.favorite=t}},metadata:_r},sr,dr),a(null,null,b,{kind:"field",name:"stockCount",static:!1,private:!1,access:{has:r=>"stockCount"in r,get:r=>r.stockCount,set:(r,t)=>{r.stockCount=t}},metadata:_r},lr,pr),a(null,null,y,{kind:"field",name:"currentImageIndex",static:!1,private:!1,access:{has:r=>"currentImageIndex"in r,get:r=>r.currentImageIndex,set:(r,t)=>{r.currentImageIndex=t}},metadata:_r},ur,mr),a(null,null,k,{kind:"field",name:"selectedVariants",static:!1,private:!1,access:{has:r=>"selectedVariants"in r,get:r=>r.selectedVariants,set:(r,t)=>{r.selectedVariants=t}},metadata:_r},gr,vr),a(null,null,x,{kind:"field",name:"heartAnimating",static:!1,private:!1,access:{has:r=>"heartAnimating"in r,get:r=>r.heartAnimating,set:(r,t)=>{r.heartAnimating=t}},metadata:_r},hr,fr),a(null,r={value:i},B,{kind:"class",name:i.name,metadata:_r},null,j),i=r.value,_r&&Object.defineProperty(i,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:_r}),e(i,j)}init(){this.initializeVariantSelections()}handleVariantsChange(){this.initializeVariantSelections()}initializeVariantSelections(){const r={};for(const t of this.variants)t.options?.length>0&&(r[t.type]=t.options[0]);this.selectedVariants=r}handlePrevImage(){this.images.length<=1||(this.currentImageIndex=0===this.currentImageIndex?this.images.length-1:this.currentImageIndex-1)}handleNextImage(){this.images.length<=1||(this.currentImageIndex=this.currentImageIndex===this.images.length-1?0:this.currentImageIndex+1)}handleDotClick(r){this.currentImageIndex=r}handleImageClick(){0!==this.images.length&&this.emitImageClick({index:this.currentImageIndex,src:this.images[this.currentImageIndex]})}handleVariantSelect(r,t){this.selectedVariants={...this.selectedVariants,[r]:t},this.emitVariantSelect({type:r,value:t})}handleAddToCart(){this.inStock&&!this.loading&&this.emitAddToCart({name:this.name,price:this.salePrice??this.price,salePrice:this.salePrice,selectedVariants:{...this.selectedVariants}})}handleFavoriteClick(r){r.stopPropagation(),this.favorite=!this.favorite,this.heartAnimating=!0,setTimeout(()=>{this.heartAnimating=!1},300),this.emitFavorite({favorited:this.favorite})}handleQuickView(r){r.stopPropagation(),this.emitQuickView()}emitAddToCart(r){return r}emitVariantSelect(r){return r}emitImageClick(r){return r}emitFavorite(r){return r}emitQuickView(){}formatPrice(r){return r.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}getDiscountPercent(){return!this.salePrice||this.salePrice>=this.price?0:Math.round((this.price-this.salePrice)/this.price*100)}renderStarIcon(r){return"filled"===r?t.html`
    ...
    `}renderHeartIcon(){const r=["product-card__favorite-icon",this.favorite?"product-card__favorite-icon--active":"",this.heartAnimating?"product-card__favorite-icon--animate":""].filter(Boolean).join(" ");return this.favorite?t.html`
        <svg class="${r}" viewBox="0 0 24 24" fill="currentColor">
          <path d="M11.645 20.91l-.007-.003-.022-.012a15.247 15.247 0 01-.383-.218 25.18 25.18 0 01-4.244-3.17C4.688 15.36 2.25 12.174 2.25 8.25 2.25 5.322 4.714 3 7.688 3A5.5 5.5 0 0112 5.052 5.5 5.5 0 0116.313 3c2.973 0 5.437 2.322 5.437 5.25 0 3.925-2.438 7.111-4.739 9.256a25.175 25.175 0 01-4.244 3.17 15.247 15.247 0 01-.383.219l-.022.012-.007.004-.003.001a.752.752 0 01-.704 0l-.003-.001z"/>
        </svg>
      `:t.html`
      <svg class="${r}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        <path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z"/>
      </svg>
    `}renderRating(){if(this.rating<=0)return t.html``;const r=[];for(let t=1;t<=5;t++)t<=Math.floor(this.rating)?r.push(this.renderStarIcon("filled")):r.push(this.renderStarIcon(t-.5<=this.rating?"half":"empty"));return t.html`
      <div class="product-card__rating" part="rating">
        <div class="product-card__stars" part="stars" aria-label="Rating: ${this.rating} out of 5">${r}</div>
        <if ${this.reviewCount>0}>
          <span class="product-card__review-count">(${this.reviewCount})</span>
        </if>
      </div>
    `}renderBadge(){return this.badge?t.html`
      <span class="product-card__badge product-card__badge--${this.badgeVariant}" part="badge">
        ${this.badge}
      </span>
    `:t.html``}renderFavoriteButton(){return t.html`
      <button class="product-card__favorite-btn"
              part="favorite-btn"
              aria-label="${this.favorite?"Remove from favorites":"Add to favorites"}"
              @click=${r=>this.handleFavoriteClick(r)}>
        ${this.renderHeartIcon()}
      </button>
    `}renderQuickView(){return t.html`
      <button class="product-card__quick-view"
              @click=${r=>this.handleQuickView(r)}
    ...
    `}renderGallery(){const r="featured"===this.variant;if(0===this.images.length)return t.html`
        ...
        ${this.variants.map(r=>{const a="color"===r.type.toLowerCase();return t.html`
            <div class="product-card__variant-group" part="variant-group">
              ...
              <div class="product-card__variant-options" role="radiogroup" aria-label="${r.type}">
                ${(r.options??[]).map(e=>{const i=this.selectedVariants[r.type]===e,c=["product-card__variant-option",a?"product-card__variant-option--color":"",i?"product-card__variant-option--selected":""].filter(Boolean).join(" ");return t.html`
                    <button class="${c}"
                            part="variant-option"
                            style="${a?`background-color: ${e}`:""}"
                            role="radio"
                            aria-checked="${i}"
                            aria-label="${a?e:""}"
    ...
    `}renderStock(){const r=this.stockCount>0&&this.stockCount<5;return t.html`
    ...
    `}renderCta(){const r=["product-card__cta",this.loading?"product-card__cta--loading":""].filter(Boolean).join(" ");return this.loading?t.html`
        <button class="${r}" part="cta" disabled>
    ...
    `}renderSkeleton(){return t.html`
      <div class="${`product-card product-card--${this.variant} product-card--skeleton`}" part="base">
        <div class="product-card__gallery" part="gallery">
    ...
    `}renderContent(){return this.loading?this.renderSkeleton():t.html`
      <div class="${`product-card product-card--${this.variant}`}" part="base">
        ${this.renderGallery()}
        <div class="product-card__body" part="body">
