...
const BUILDER_GROUPS = [
  {
    ...
    vars: [
      ...
      { name: '--snice-color-brand', label: 'Brand', type: 'color', default: '#2563eb' },
      { name: '--snice-color-brand-hover', label: 'Brand Hover', type: 'color', default: '#1d4ed8' },
      ...
      { name: '--snice-color-accent-1', label: 'Accent 1', type: 'color', default: '#396aab' },
      { name: '--snice-color-accent-2', label: 'Accent 2', type: 'color', default: '#cc7732' },
      { name: '--snice-color-accent-3', label: 'Accent 3', type: 'color', default: '#3d8f7b' },
      { name: '--snice-color-accent-4', label: 'Accent 4', type: 'color', default: '#8670a8' },
      { name: '--snice-color-accent-5', label: 'Accent 5', type: 'color', default: '#c79a32' },
      { name: '--snice-color-accent-6', label: 'Accent 6', type: 'color', default: '#b56c84' },
      { name: '--snice-color-accent-7', label: 'Accent 7', type: 'color', default: '#598c55' },
      { name: '--snice-color-accent-8', label: 'Accent 8', type: 'color', default: '#3e8aab' },
    ],
  },
  {
    title: 'Surfaces',
    id: 'surface-colors',
    vars: [
      { name: '--snice-color-surface', label: 'Surface (page)', type: 'color', default: '#ffffff' },
      { name: '--snice-color-surface-container-lowest', label: 'Container Lowest', type: 'color', default: '#ffffff' },
      { name: '--snice-color-surface-container-low', label: 'Container Low', type: 'color', default: '#fafafa' },
      { name: '--snice-color-surface-container', label: 'Container', type: 'color', default: '#f5f5f5' },
      { name: '--snice-color-surface-container-high', label: 'Container High', type: 'color', default: '#f8f7f5' },
      { name: '--snice-color-surface-container-highest', label: 'Container Highest', type: 'color', default: '#ffffff' },
      { name: '--snice-color-surface-hover', label: 'Surface Hover (solid)', type: 'color', default: '#f5f5f5' },
      { name: '--snice-color-surface-active', label: 'Surface Active (solid)', type: 'color', default: '#e5e5e5' },
      { name: '--snice-color-surface-disabled', label: 'Surface Disabled', type: 'color', default: '#f5f5f5' },
  ...
  },
  {
    ...
    id: 'typography',
    vars: [
      { name: '--snice-font-family', label: 'Body Font', type: 'text', default: '', placeholder: 'e.g. Inter, system-ui, sans-serif' },
      { name: '--snice-font-family-display', label: 'Display Font', type: 'text', default: '', placeholder: 'Headings / titles. Defaults to body.' },
      ...
      { name: '--snice-heading-xs', label: 'Heading XS', type: 'size', default: '0.875rem', min: 0.6, max: 1.4, step: 0.025 },
      { name: '--snice-heading-sm', label: 'Heading SM', type: 'size', default: '1rem', min: 0.7, max: 1.6, step: 0.025 },
      { name: '--snice-heading-md', label: 'Heading MD', type: 'size', default: '1.125rem', min: 0.8, max: 2, step: 0.025 },
      { name: '--snice-heading-lg', label: 'Heading LG', type: 'size', default: '1.25rem', min: 1, max: 2.5, step: 0.025 },
      { name: '--snice-heading-xl', label: 'Heading XL', type: 'size', default: '1.5rem', min: 1, max: 3, step: 0.05 },
      { name: '--snice-heading-2xl', label: 'Heading 2XL', type: 'size', default: '2.25rem', min: 1.5, max: 5, step: 0.05 },
      ...
      { name: '--snice-tracking-tight', label: 'Tracking Tight', type: 'text', default: '-0.02em', placeholder: 'e.g. -0.02em' },
      { name: '--snice-tracking-normal', label: 'Tracking Normal', type: 'text', default: '0', placeholder: 'e.g. 0' },
      { name: '--snice-tracking-wide', label: 'Tracking Wide', type: 'text', default: '0.03em', placeholder: 'e.g. 0.03em' },
      { name: '--snice-tracking-widest', label: 'Tracking Widest', type: 'text', default: '0.1em', placeholder: 'e.g. 0.1em' },
    ],
  },
  {
    title: 'Spacing',
