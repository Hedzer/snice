 ...
 */
export type SniceAdapterRef<FormAssociated extends boolean> = FormAssociated extends true ? SniceFormRef : SniceComponentRef;
/**
 ...
 */
export type ExtractProps<T extends string> = T extends `${infer Prop}-${infer Rest}` ? Prop | ExtractProps<Rest> : T;
/**
