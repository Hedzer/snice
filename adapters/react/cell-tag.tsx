 ...
 * ```
 */
export const CellTag: SniceReactComponent<CellTagProps, SniceComponentRef> = createReactAdapter<CellTagProps, false>({
  tagName: 'snice-cell-tag',
  properties: ["tags","value","variant","column","rowData","align","type"],
  events: {},
