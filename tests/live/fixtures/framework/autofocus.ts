...
@element('autofocus-source-host')
export class AutofocusSourceHost extends HTMLElement {
  @render()
  template() {
...
@element('autofocus-source-closed-host', { shadow: 'closed' })
export class AutofocusSourceClosedHost extends HTMLElement {
  @query('[autofocus]')
