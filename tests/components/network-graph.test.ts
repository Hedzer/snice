...
import type { SniceNetworkGraphElement, NetworkGraphData } from '../../packages/components/src/network-graph/snice-network-graph.types';
...
describe('snice-network-graph', () => {
  ...
  describe('stylesheet contracts', () => {
    const cssPath = resolve(process.cwd(), 'packages/components/src/network-graph/snice-network-graph.css');
