...
describe('query decorators', () => {
  ...
  describe('@query decorator', () => {
    it('should query single element', async () => {
      ...
      class TestQueryBasic extends HTMLElement {
        ...
        @render()
        renderContent() {
          return html`<div class="test">Test Content</div>`;
        }
      }
    ...
    it('should return null if element not found', async () => {
      ...
      class TestQueryNull extends HTMLElement {
        ...
        @render()
        renderContent() {
          return html`<div class="present">Present</div>`;
        }
      }
    ...
    it('should query nested elements', async () => {
    ...
    it('should query by ID', async () => {
      ...
      class TestQueryId extends HTMLElement {
        ...
        @render()
        renderContent() {
          return html`<div id="unique">Unique Element</div>`;
        }
      }
    ...
    it('should query by attribute', async () => {
      ...
      class TestQueryAttr extends HTMLElement {
        ...
        @render()
        renderContent() {
          return html`<div data-test="value">Attribute Query</div>`;
        }
      }
    ...
    it('should be reactive to DOM changes', async () => {
  ...
  describe('@queryAll decorator', () => {
    ...
    it('should return empty NodeList if no elements found', async () => {
  ...
  describe('multiple queries', () => {
    it('should handle multiple query decorators on same class', async () => {
