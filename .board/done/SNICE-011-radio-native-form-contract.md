...
- 2026-07-18: takeover audit caught a duplicate host `click` from external-label forwarding; activation now exposes one host click while retaining group selection and native event ordering across all browser/build combinations.
