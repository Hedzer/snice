...
Type:{ charts?: bool, warnIfFocusStateIsNotSynced?: bool }
...
- params.row The row model of the row that the current cell belongs to.
- params.rowNode The node of the row that the current cell belongs to.
...
Type:{ align?: 'center'| 'left'| 'right', cellClassName?: func| string, display?: 'flex'| 'text', field: string, renderCell?: func }
...
Type:'border-and-shadow'| 'border'| 'shadow'
...
Type:func| { align?: 'center'| 'left'| 'right', cellClassName?: func| string, description?: string, display?: 'flex'| 'text', field?: string, flex?: number, headerAlign?: 'center'| 'left'| 'right', headerClassName?: func| string, headerName?: string, maxWidth?: number, minWidth?: number, resizable?: bool, sortingOrder?: Array<'asc'| 'desc'>, width?: number }
Default:undefined
...
Type:{ columns: Array<object>, rows: Array<{ field: string, hidden?: bool }>, values: Array<{ aggFunc: string, field: string, hidden?: bool }> }
...
When rowSelectionPropagation.descendants is set to true. - Selecting a parent selects all its filtered descendants automatically. - Deselecting a parent row deselects all its filtered descendants automatically.When rowSelectionPropagation.parents is set to true - Selecting all the filtered descendants of a parent selects the parent automatically. - Deselecting a descendant of a selected parent deselects the parent automatically.Works with tree data and row grouping on the client-side only.
...
Class name: .MuiDataGridPremium-aiAssistantPanel
...
Class name: .MuiDataGridPremium-toolbar
...
Class name: .MuiDataGridPremium-rowReorderIcon
...
Class name: .MuiDataGridPremium-collapsibleIcon
Default component: GridExpandMoreIcon
...
Class name: .MuiDataGridPremium-promptIcon
...
Class name: .MuiDataGridPremium-promptChangesToggleIcon
Default component: GridExpandMoreIcon
...
- Demos
- Import
- PropscolumnsactiveChartIdaggregationFunctionsaggregationModelaggregationRowsScopeaiAssistantaiAssistantActiveConversationIndexaiAssistantConversationsaiAssistantSuggestionsallowAiAssistantDataSamplingapiRefaria-labelaria-
- columns
- activeChartId
...
- 
- aiAssistantPanel
- chartsPanel
- emptyPivotOverlay
- headerFilterCell
...
- promptIcon
- promptSendIcon
- promptSpeechRecognitionIcon
- promptSpeechRecognitionOffIcon
- promptRerunIcon
- promptSortAscIcon
- promptSortDescIcon
- promptChartsIcon
