...
function makeBox(height = '200px') {
  ...
  box.style.cssText = `position:relative;border:1px solid var(--snice-color-border,#e2e2e2);border-radius:8px;overflow:hidden;height:${height};background:color-mix(in srgb,var(--snice-color-surface,#fff) 90%,var(--snice-color-text,#000) 10%);`;
  return box;
}
...
export const Features: Story = {
  render: () => {
    ...
    const cancelBtn = document.createElement('button'); cancelBtn.style.cssText = 'padding:.25rem .75rem;border:1px solid var(--snice-color-border);border-radius:4px;background:var(--snice-color-surface);color:var(--snice-color-text);cursor:pointer;font-size:.8rem'; cancelBtn.textContent = 'Cancel';
...
export const PushContent: Story = {
  render: () => {
    ...
    toggleBtn.style.cssText = 'padding:.4rem .85rem;border:1px solid var(--snice-color-border);border-radius:6px;background:var(--snice-color-surface-container-high);color:var(--snice-color-text);cursor:pointer;font-size:.8rem';
